...
export class FluentVisitor extends Visitor {
  ...
  public readonly usedTerms = new Set<FluentBundlePattern>();
...
type NumberLiteral = {
 ...
 // Exported as FluentBundlePattern because there is already a Pattern and FluentPattern in SceneryStack
export type { Message };
export { FluentParser };
export { Visitor };
