...
export class Graph {
  ...
  private eliminateOverlap(): void {
    ...
    const queue: FlatQueue<{ start: boolean; edge: Edge }> = new FlatQueue(); // eslint-disable-line no-undef
  ...
  private collapseVertices(): void {
    ...
    const queue: FlatQueue<{ start: boolean; vertex: Vertex }> = new FlatQueue(); // eslint-disable-line no-undef
