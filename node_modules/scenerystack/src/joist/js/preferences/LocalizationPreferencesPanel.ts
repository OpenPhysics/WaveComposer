  ...
  public constructor( localizationModel: LocalizationModel,
    ...
    if ( localizationModel.supportsDynamicLocale && localizationModel.includeLocalePanel ) {
      ...
      const localeLabel = new VoicingText(
        string_joist_preferences_tabs_localization_languageSelection_title_StringProperty,
      ...
      const localeDescription = new VoicingRichText( string_joist_preferences_tabs_localization_languageSelection_description_StringProperty,
