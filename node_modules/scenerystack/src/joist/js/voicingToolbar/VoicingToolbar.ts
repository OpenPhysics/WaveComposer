...
// constants
const openToolbarStringProperty = string_joist_a11y_voicingToolbar_openToolbar_StringProperty;
const closeToolbarStringProperty = string_joist_a11y_voicingToolbar_closeToolbar_StringProperty;
const hideToolbarStringProperty = string_joist_a11y_voicingToolbar_hideToolbar_StringProperty;
const showToolbarStringProperty = string_joist_a11y_voicingToolbar_showToolbar_StringProperty;
const toolbarShownStringProperty = string_joist_a11y_voicingToolbar_toolbarShown_StringProperty;
const toolbarHiddenStringProperty = string_joist_a11y_voicingToolbar_toolbarHidden_StringProperty;
...
class VoicingToolbar extends Node {
  ...
  // Scale applied to the VoicingToolbar and its contents in response to layout and self resizing.
  ...
  /**
   * Layout for the VoicingToolbar, called whenever position changes or self is resized.
   */
