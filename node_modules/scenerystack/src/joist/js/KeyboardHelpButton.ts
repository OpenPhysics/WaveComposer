...
// constants
const keyboardShortcutsStringProperty = string_joist_a11y_keyboardHelp_keyboardShortcuts_StringProperty;
...
class KeyboardHelpButton extends JoistButton {
  ...
  public constructor( screens: AnyScreen[], screenProperty: Property<AnyScreen>,
    ...
    assert && self.phet?.chipper?.queryParameters?.binder && keyboardHelpDialogCapsule.getElement();
  }
}
