...
export default class TimeControlNode extends Node {
  ...
  public constructor( isPlayingProperty: Property<boolean>, providedOptions?: TimeControlNodeOptions ) {
    ...
    const options = optionize<TimeControlNodeOptions,
      ...
      // pdom
      accessibleHeading: string_scenery_phet_a11y_timeControlNode_label_StringProperty
    }, providedOptions );
    ...
    assert && self.phet?.chipper?.queryParameters?.binder && InstanceRegistry.registerDataURL( 'scenery-phet', 'TimeControlNode', this );
  }
