...
export default class ScreenSummaryNode extends Node {
  ...
  public constructor() {
    ...
    const keyboardShortcutsHint = new Node( {
      tagName: 'p',
      innerContent: string_scenery_phet_a11y_simSection_screenSummary_keyboardShortcutsHint_StringProperty
    } );
  ...
  public setIntroString( simName: string, screenDisplayName: string | null, isMultiScreen: boolean ): void {
    ...
    this.openingSummaryNode.innerContent =
      ...
      StringUtils.fillIn( string_scenery_phet_a11y_simSection_screenSummary_multiScreenIntro_StringProperty, { screen: screenDisplayName } ) :
      StringUtils.fillIn( string_scenery_phet_a11y_simSection_screenSummary_singleScreenIntroPattern_StringProperty, { sim: simName } );
  }
}
