...
class MeasuringTapeNode extends Node {
  ...
  public constructor( unitsProperty: TReadOnlyProperty<MeasuringTapeUnits>, providedOptions?: MeasuringTapeNodeOptions ) {
    ...
    this.baseImage = new Image( measuringTape_png, {
      ...
      innerContent: string_scenery_phet_a11y_measuringTape_StringProperty,
      ariaLabel: string_scenery_phet_a11y_measuringTape_StringProperty
    } );
    ...
    const tip = new InteractiveHighlightingNode( {
      ...
      focusable: true,
      ariaRole: 'application',
      innerContent: string_scenery_phet_a11y_measuringTapeTip_StringProperty,
      ariaLabel: string_scenery_phet_a11y_measuringTapeTip_StringProperty
    } );

    const readoutStringProperty = new DerivedStringProperty(
      [ this.unitsProperty, this.measuredDistanceProperty, string_scenery_phet_measuringTapeReadoutPattern_StringProperty ],
    ...
    if ( options.interactive ) {
      ...
      this.baseDragListener = new SoundDragListener( combineOptions<SoundDragListenerOptions>( {
      ...
      const baseKeyboardDragListener = new SoundKeyboardDragListener( combineOptions<SoundKeyboardDragListenerOptions>( {
        ...
        start: baseStart,
        drag: ( event, listener ) => { handleTipOnBaseDrag( listener.modelDelta ); },
        end: baseEnd
      ...
      const tipDragListener = new SoundDragListener( combineOptions<SoundDragListenerOptions>( {
    ...
    assert && self.phet?.chipper?.queryParameters?.binder && InstanceRegistry.registerDataURL( 'scenery-phet', 'MeasuringTapeNode', this );
  }
