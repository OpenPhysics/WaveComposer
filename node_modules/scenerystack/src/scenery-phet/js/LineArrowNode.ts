...
import { LineCap, LineJoin } from '../../kite/js/util/LineStyles.js';
...
export default class LineArrowNode extends Node {
  ...
  public constructor( tailX: number, tailY: number, tipX: number, tipY: number, providedOptions?: LineArrowNodeOptions ) {
    ...
    assert && self.phet?.chipper?.queryParameters?.binder && InstanceRegistry.registerDataURL( 'scenery-phet', 'LineArrowNode', this );
  }
