...
export default class ResetAllButton extends ResetButton {
  ...
  public constructor( providedOptions?: ResetAllButtonOptions ) {
    ...
    const options = optionize<ResetAllButtonOptions, SelfOptions, ResetButtonOptions>()( {
      ...
      voicingContextResponse: string_scenery_phet_a11y_resetAll_accessibleContextResponse_StringProperty,
    ...
    const resetUtterance = new ActivationUtterance( { alert: string_scenery_phet_a11y_resetAll_accessibleContextResponse_StringProperty } );
  ...
  private getParentScreenViews(): Node[] {
    const ScreenViewClass = self.phet?.joist?.ScreenView;
    if ( !ScreenViewClass ) {
      return [];
    }
  ...
  public static readonly RESET_ALL_HOTKEY_DATA = new HotkeyData( {
    ...
    keyboardHelpDialogLabelStringProperty: string_scenery_phet_keyboardHelpDialog_resetAll_StringProperty,

    // PDOM description for this Hotkey in the Keyboard Help dialog
    keyboardHelpDialogPDOMLabelStringProperty: StringUtils.fillIn( string_scenery_phet_a11y_keyboardHelpDialog_general_resetAllDescriptionPattern_StringProperty, {
