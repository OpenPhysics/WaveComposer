...
import base64js from 'base64-js';const fromByteArray = base64js.fromByteArray;
...
type SelfOptions = {
  ...
  // If true, input event listeners will be attached to the Display's DOM element instead of the self.
