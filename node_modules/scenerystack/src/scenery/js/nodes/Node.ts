...
import { isHeightSizable, isWidthSizable } from '../layout/sizableTypeChecks.js';
...
class Node extends ParallelDOM {
  ...
  public insertChild( index: number, node: Node, isComposite?: boolean ): this {
    ...
    if ( assert && self.phet?.chipper?.queryParameters && isFinite( SceneryQueryParameters.parentLimit ) ) {
    ...
    if ( assert && self.phet?.chipper?.queryParameters && isFinite( SceneryQueryParameters.childLimit ) ) {
