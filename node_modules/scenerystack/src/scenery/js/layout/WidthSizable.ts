...
const WidthSizable = memoize( <SuperType extends Constructor<Node>>( Type: SuperType ): SuperType & Constructor<TWidthSizable> => {
  const WidthSizableTrait = DelayedMutate( 'WidthSizable', WIDTH_SIZABLE_OPTION_KEYS,
    class WidthSizableTrait extends Type implements TWidthSizable {
