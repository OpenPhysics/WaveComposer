...
export default class FocusManager {
  ...
  // References to the self listeners that update when the self has focus. So they can be removed if needed.
  ...
  public static attachToWindow(): void {
    ...
    self.addEventListener( 'focus', FocusManager.attachedWindowFocusListener );
    self.addEventListener( 'blur', FocusManager.attachedWindowBlurListener );

    // value will be updated with self, but we need a proper initial value (this function may be called while
    // the self is not in the foreground).
  ...
  public static detachFromWindow(): void {
    self.removeEventListener( 'focus', FocusManager.attachedWindowFocusListener! );
    self.removeEventListener( 'blur', FocusManager.attachedWindowBlurListener! );
