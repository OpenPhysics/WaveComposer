...
export default class ABSwitch<T> extends HBox {
  ...
  public constructor( property: Property<T>, valueA: T, labelA: Node, valueB: T, labelB: Node, providedOptions?: ABSwitchOptions ) {
    ...
    const valueASelectedAccessibleNameStringProperty = new PatternStringProperty( string_sun_a11y_aBSwitch_accessibleNamePattern_StringProperty, {
      selectedValue: valueAAccessibleName,
      otherValue: valueBAccessibleName
    } );
    const valueBSelectedAccessibleNameStringProperty = new PatternStringProperty( string_sun_a11y_aBSwitch_accessibleNamePattern_StringProperty, {
    ...
    assert && self.phet?.chipper?.queryParameters?.binder && InstanceRegistry.registerDataURL( 'sun', 'ABSwitch', this );
  }
