...
export default class Dialog extends Popupable( Panel, 1 ) {
  ...
  public constructor( content: Node, providedOptions?: DialogOptions ) {
    ...
    const closeButton = new CloseButton( {
      ...
      // voicing
      voicingContextResponse: string_sun_a11y_closed_StringProperty
    } );
    ...
    if ( options.closeButtonVoicingDialogTitle ) {
      ...
      closeButtonVoicingNameResponseProperty = closeButton.voicingNameResponse = new PatternStringProperty( string_sun_a11y_titleClosePattern_StringProperty, { title: titleProperty }, { tandem: Tandem.OPT_OUT } );
    }
