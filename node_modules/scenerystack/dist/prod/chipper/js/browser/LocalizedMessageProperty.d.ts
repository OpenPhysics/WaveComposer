...
export default class LocalizedMessageProperty extends DerivedProperty1<FluentBundlePattern, FluentBundle> {
    readonly bundleProperty: TReadOnlyProperty<FluentBundle>;
    constructor(bundleProperty: TReadOnlyProperty<FluentBundle>, derivation: (bundle: FluentBundle) => FluentBundlePattern);
}
//# sourceMappingURL=LocalizedMessageProperty.d.ts.map