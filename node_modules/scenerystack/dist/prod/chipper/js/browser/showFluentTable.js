 ...
 */
import { splashScreen } from '../../../joist/js/splash.js';
import '../../../globals.js';
...
export default function showFluentTable(simFluent, translationLocale) {
    splashScreen && splashScreen.dispose();
  ...
  `;
    ...
    const userSelectedLocaleProperty = new Property(translationLocale);
  ...
  `;
    ...
    const fluentEntries = [];
    const collectEntries = (obj, prefix = '', seen = new WeakSet()) => {
    ...
    const rowParameterProperties = new Map();
    const rowEnglishProperties = new Map();
    const rowTranslationProperties = new Map();
    // Create table rows
    ...
    `;
        if (entry.isConstant && entry.fluentConstant) {
          ...
          `;
                    ...
                    const paramName = argDef.name || `param${index}`;
                    const variants = argDef.variants;
    ...
    function updateColumnVisibility() {
        const showKey = document.getElementById('showKey').checked;
...
//# sourceMappingURL=showFluentTable.js.map