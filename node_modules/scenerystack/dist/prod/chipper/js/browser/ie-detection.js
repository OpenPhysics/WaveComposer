...
else if (self.navigator.appName === 'Netscape') {
...
if (releaseVersion !== -1 || self.location.search.indexOf('showInternetExplorerError') >= 0) {
    ...
    const localeQueryParameterMatches = self.location.search.match(localeRegEx) || [];
    ...
    // in that locale.
    const locale = localeQueryParameterValue && self.phet.chipper.strings[localeQueryParameterValue] ?
        localeQueryParameterValue : self.phet.chipper.locale;
    const strings = self.phet.chipper.strings[locale];
...
//# sourceMappingURL=ie-detection.js.map