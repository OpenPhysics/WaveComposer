...
export default function createFluentMessageProperty(bundleProperty, messageKey, values = {}) {
    const dependencies = [bundleProperty];
    ...
    return new DerivedProperty(dependencies, (bundle, ...unusedValues) => {
...
//# sourceMappingURL=createFluentMessageProperty.js.map