...
type Locale = string;
declare const getFluentModule: (localeToFluentFileMap: Record<Locale, string>) => Record<string, LocalizedMessageProperty>;
export default getFluentModule;
//# sourceMappingURL=getFluentModule.d.ts.map