...
declare class InstanceRegistry {
    static componentMap: ComponentMap;
    static hotkeys: SerializedHotkeyData[];
    /**
     * Adds a screenshot of the given scenery Node
     */
    static registerDataURL(repoName: string, typeName: string, instance: NodeLike): void;
    /**
     ...
     */
    static registerToolbox(instance: NodeLike): void;
    /**
     * Register a Hotkey for binder documentation.
     */
    static registerHotkey(hotkeyData: HotkeyData): void;
}
