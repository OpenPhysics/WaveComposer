 ...
 */
declare function dimensionForEach<T>(dimension: number, array: MultidimensionalArray<T>, forEach: (element: T, ...indices: number[]) => void): void;
export default dimensionForEach;
//# sourceMappingURL=dimensionForEach.d.ts.map