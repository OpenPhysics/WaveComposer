...
type NestedStrictOmit<T, P extends keyof T, K extends keyof Required<T>[P]> = StrictOmit<T, P> & (undefined extends T[P] ? Partial<Omit2<T, P, K>> : Omit2<T, P, K>);
export default NestedStrictOmit;
//# sourceMappingURL=NestedStrictOmit.d.ts.map