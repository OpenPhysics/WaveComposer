 ...
 */
declare function dimensionMap<InputType, ReturnType>(dimension: number, array: MultidimensionalArray<InputType>, map: (element: InputType, ...indices: number[]) => ReturnType): MultidimensionalArray<ReturnType>;
export default dimensionMap;
//# sourceMappingURL=dimensionMap.d.ts.map