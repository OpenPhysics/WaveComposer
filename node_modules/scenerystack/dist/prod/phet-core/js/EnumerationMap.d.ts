...
declare class EnumerationMap<T, U> {
    private readonly _enumeration;
    private _map;
    private _values;
    /**
     * @param enumeration
     ...
     */
    constructor(enumeration: TEnumeration<T>, factory: (t: T) => U);
    /**
...
//# sourceMappingURL=EnumerationMap.d.ts.map