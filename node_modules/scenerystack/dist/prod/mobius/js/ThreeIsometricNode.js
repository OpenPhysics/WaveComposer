...
export default class ThreeIsometricNode extends Node {
    constructor(layoutBounds, providedOptions) {
        ...
        this.viewOffsetListener = () => {
            ...
            if (screenWidth && screenHeight) {
                this.stage.adjustViewOffset(this.parentToGlobalBounds(new Bounds2(offsetX, offsetY, this.layoutBounds.width + offsetX, this.layoutBounds.height + offsetY)));
            }
        };
    ...
    layout(width, height) {
        // We need to lay out things for self dimensions so we don't overly resize, see
        // https://github.com/phetsims/density/issues/50. For this we'll actually take up the full self, and adjust things
...
//# sourceMappingURL=ThreeIsometricNode.js.map