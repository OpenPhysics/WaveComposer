 ...
 */
import '../../globals.js';
declare const MobiusQueryParameters: import("../../query-string-machine/js/QueryStringMachineModule.js").QSMParsedParameters<{
     ...
     */
    threeRendererPreserveDrawingBuffer: {
        type: "flag";
    };
    /**
     * Sets device pixel ratio. This is usually used for HiDPI device to prevent blurring output canvas. When setting the
     * renderer pixel ratio to self.devicePixelRatio, it will have the highest resolution for that device. Setting
     * anything lower will be more blurry, but will save vRAM. Note that we observed self.devicePixelRatio to be 2
...
//# sourceMappingURL=MobiusQueryParameters.d.ts.map