 ...
 */
import { string_scenery_phet_webglWarning_body_StringProperty } from '../../scenery-phet/js/strings/webglWarning/body.js';
import '../../globals.js';
...
export default class MobiusScreenView extends ScreenView {
    ...
    modelToViewDelta(point1, point2) {
     ...
     */
    viewToModelPoint(point, modelZ = 0) {
     ...
     * negative values.
     */
    viewToModelDelta(viewPoint1, modelZ1, viewPoint2, modelZ2) {
    ...
    layout(viewBounds) {
        ...
        const sceneWidth = dimension.width || self.innerWidth; // eslint-disable-line phet/bad-sim-text
        const sceneHeight = dimension.height || self.innerHeight; // eslint-disable-line phet/bad-sim-text
     ...
     */
    static showWebGLWarning(screenView) {
        const warningNode = new HBox({
            children: [
                ...
                new Text(string_scenery_phet_webglWarning_body_StringProperty, {
        ...
        warningNode.addInputListener({
            up: function () {
                const joistGlobal = _.get(self, 'phet.joist', null); // returns null if global isn't found
...
//# sourceMappingURL=MobiusScreenView.js.map