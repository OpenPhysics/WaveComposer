...
Intensity.HIGH = new Intensity();
Intensity.LOW = new Intensity();
// Gets a list of keys, values and mapping between them.  For use in EnumerationProperty and PhET-iO
Intensity.enumeration = new Enumeration(Intensity);
...
class VibrationManager {
    constructor() {
        ...
        this.intensityProperty = new EnumerationProperty(Intensity.HIGH);
...
//# sourceMappingURL=vibrationManager.js.map