...
declare class VibrationTestEventRecorder {
    /**
     * @param {VibrationManageriOS} vibrationManager - sends messages to the containing iOS app
     */
    constructor(vibrationManager: VibrationManageriOS);
    events: any[];
    /**
     ...
     */
    public addTestEvent(testEvent: VibrationTestEvent): void;
    /**
...
//# sourceMappingURL=VibrationTestEventRecorder.d.ts.map