 ...
 */
declare class VibrationManageriOS {
    private readonly vibrationMessageHandlers;
    constructor();
    /**
     ...
     */
    vibrateContinuous(providedOptions?: VibrateOptions): void;
    /**
     ...
     */
    vibrateTransient(providedOptions?: VibrateOptions): void;
    /**
     * Start a vibration for the provided duration, with a provided frequency.
     */
    vibrateAtFrequency(seconds: number, frequency: number): void;
    /**
     * Vibrate at the desired frequency.
     * @param frequency
     * @param [intensity] - from 0 to 1
     */
    vibrateAtFrequencyForever(frequency: number, intensity?: number): void;
    /**
     ...
     */
    vibrateWithCustomPattern(vibrationPattern: number[], seconds: number, loopForever: boolean): void;
    /**
     ...
     * @param seconds
     */
    vibrateWithCustomPatternDuration(vibrationPattern: number[], seconds: number): void;
    /**
     ...
     */
    vibrateWithCustomPatternForever(vibrationPattern: number[]): void;
    /**
     ...
     */
    setVibrationSharpness(sharpness: number): void;
    /**
...
//# sourceMappingURL=VibrationManageriOS.d.ts.map