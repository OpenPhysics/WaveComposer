...
import { type BooleanPropertyOptions } from './BooleanProperty.js';
...
export default class GatedBooleanProperty extends DerivedProperty2<boolean, boolean, boolean> {
    readonly selfBooleanProperty: TProperty<boolean>;
    constructor(providedBooleanProperty: TReadOnlyProperty<boolean>, parentTandem: Tandem, providedOptions?: GatedBooleanPropertyOptions);
    dispose(): void;
}
export {};
//# sourceMappingURL=GatedBooleanProperty.d.ts.map