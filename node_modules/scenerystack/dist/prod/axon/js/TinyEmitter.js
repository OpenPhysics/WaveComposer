...
// constants
const listenerOrder = _.hasIn(self, 'phet.chipper.queryParameters') && phet.chipper.queryParameters.listenerOrder;
const listenerLimit = _.hasIn(self, 'phet.chipper.queryParameters') && phet.chipper.queryParameters.listenerLimit;
...
export default class TinyEmitter {
    ...
    constructor(onBeforeNotify, hasListenerOrderDependencies, reentrantNotificationStrategy, disableListenerLimit) {
...
//# sourceMappingURL=TinyEmitter.js.map