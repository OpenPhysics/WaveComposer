...
export default class VarianceNumberProperty extends NumberProperty {
    readonly computeVariance: VarianceComputer | null;
    constructor(value: number, computeVariance: VarianceComputer, options?: VarianceNumberPropertyOptions);
    getRandomizedValue(): number;
}
export {};
//# sourceMappingURL=VarianceNumberProperty.d.ts.map