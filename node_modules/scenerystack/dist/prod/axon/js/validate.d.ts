...
import { type IsValidValueOptions, type Validator } from './Validation.js';
/**
 ...
 */
declare const validate: <T>(value: IntentionalAny, validator: Validator<T>, providedOptions?: IsValidValueOptions) => void;
