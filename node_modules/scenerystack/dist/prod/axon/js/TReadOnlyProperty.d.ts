...
import { type LinkOptions } from './ReadOnlyProperty.js';
...
export declare function isTReadOnlyProperty<T = unknown>(something: IntentionalAny): something is TReadOnlyProperty<T>;
//# sourceMappingURL=TReadOnlyProperty.d.ts.map