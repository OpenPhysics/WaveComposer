...
export declare function isAffirmEnabled(): boolean;
 ...
 */
export declare function affirmCallback(predicate: () => unknown, ...messages: IntentionalPerennialAny[]): void;
export declare function addAffirmationHook(hook: () => void): void;
export declare function setAffirmationDebuggerMode(isDebuggerMode: boolean): void;
//# sourceMappingURL=affirm.d.ts.map