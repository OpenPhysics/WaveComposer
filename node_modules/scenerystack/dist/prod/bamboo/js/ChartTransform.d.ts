...
declare class ChartTransform {
     ...
     * @param callback
     */
    forEachSpacing(axisOrientation: Orientation, spacing: number, origin: number, clippingType: ClippingType, callback: (modelPosition: number, viewPosition: number) => void): void;
...
//# sourceMappingURL=ChartTransform.d.ts.map