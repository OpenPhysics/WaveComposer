...
declare class TickLabelSet extends Path {
    private chartTransform;
    private readonly axisOrientation;
    private spacing;
    private readonly origin;
    private readonly skipCoordinates;
    private readonly extent;
    private readonly value;
    private readonly clippingType;
    private readonly edge;
    private createLabel;
    private readonly positionLabel;
    private labelMap;
    private readonly disposeTickLabelSet;
    /**
     ...
     */
    private clearCache;
    setCreateLabel(createLabel: (value: number) => Node | null): void;
    dispose(): void;
    getSpacingBorders(): Range;
}
export default TickLabelSet;
//# sourceMappingURL=TickLabelSet.d.ts.map