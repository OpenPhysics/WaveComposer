...
declare class PitchedPopGenerator extends SoundGenerator {
    private readonly pitchRange;
    private readonly soundSources;
    private nextSoundSourceIndex;
     ...
     */
    playPop(relativePitch: number, duration?: number): void;
}
export default PitchedPopGenerator;
//# sourceMappingURL=PitchedPopGenerator.d.ts.map