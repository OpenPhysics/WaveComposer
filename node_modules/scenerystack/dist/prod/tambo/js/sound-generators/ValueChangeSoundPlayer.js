...
const DEFAULT_VALUE_CONSTRAINT = (value) => roundToInterval(value, 0.000000001);
...
class ValueChangeSoundPlayer extends Disposable {
    ...
    getSurroundingThresholds(value) {
        ...
        const segment = Math.floor(roundToInterval((value - this.valueRangeProperty.value.min) / this.interThresholdDistance, roundingInterval));
        const lowerThreshold = roundToInterval(segment * this.interThresholdDistance + this.valueRangeProperty.value.min, roundingInterval);
        ...
        if (lowerThreshold !== value) {
            ...
            const upperThreshold = Math.min(roundToInterval(lowerThreshold + this.interThresholdDistance, roundingInterval), this.valueRangeProperty.value.max);
...
//# sourceMappingURL=ValueChangeSoundPlayer.js.map