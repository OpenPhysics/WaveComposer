...
declare class MultiSelectionSoundPlayerFactory {
    private _basisSoundClip;
    private readonly soundPlayers;
    constructor();
    /**
     ...
     */
    getSelectionSoundPlayer(positionIndex: number): TSoundPlayer;
}
declare const multiSelectionSoundPlayerFactory: MultiSelectionSoundPlayerFactory;
export default multiSelectionSoundPlayerFactory;
//# sourceMappingURL=multiSelectionSoundPlayerFactory.d.ts.map