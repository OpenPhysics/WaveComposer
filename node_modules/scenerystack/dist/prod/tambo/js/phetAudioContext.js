...
if (self.AudioContext) {
    phetAudioContext = new self.AudioContext();
}
else if (self.webkitAudioContext) {
    phetAudioContext = new (self.webkitAudioContext)(); // eslint-disable-line new-cap
}
else {
...
//# sourceMappingURL=phetAudioContext.js.map