...
export type SharedSoundPlayerName = 'accordionBoxClosed' | 'accordionBoxOpened' | 'boundaryReached' | 'checkboxChecked' | 'checkboxUnchecked' | 'erase' | 'generalBoundaryBoop' | 'generalClose' | 'generalOpen' | 'generalSoftClick' | 'goBack' | 'grab' | 'pause' | 'play' | 'pushButton' | 'release' | 'resetAll' | 'softClick' | 'stepBackward' | 'stepForward' | 'switchToLeft' | 'switchToRight' | 'toggleOff' | 'toggleOn';
/**
 * The sharedSoundPlayers object, which implements a `get` method for obtaining shared sound players based on their
 * names.
 */
declare const sharedSoundPlayers: {
    /**
...
//# sourceMappingURL=sharedSoundPlayers.d.ts.map