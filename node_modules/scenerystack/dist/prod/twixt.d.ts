...
export { default as AnimationTarget } from './twixt/js/AnimationTarget.js';
export type { AnimationTargetOptions } from './twixt/js/AnimationTarget.js';
...
export type { PartialTransitionOptions, SlideTransitionOptions, WipeTransitionOptions, DissolveTransitionSelfOptions, DissolveTransitionOptions, TransitionOptions } from './twixt/js/Transition.js';
...
export { default as TwixtStrings } from './twixt/js/TwixtStrings.js';
//# sourceMappingURL=twixt.d.ts.map