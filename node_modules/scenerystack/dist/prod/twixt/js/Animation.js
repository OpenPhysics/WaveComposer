...
class Animation extends Disposable {
    ...
    constructor(providedConfig) {
        ...
        this.endedEmitter = new Emitter({ hasListenerOrderDependencies: true }); // TODO: listener order dependencies in should be dealt with, https://github.com/phetsims/fraction-matcher/issues/110
