...
const scenerySerialize = (value) => {
    if (value instanceof Vector2) {
        ...
        if (DOM && node instanceof DOM) {
            ...
            serialization.element = new self.XMLSerializer().serializeToString(node.element);
            if (node.element instanceof self.HTMLCanvasElement) {
...
export const inspectDisplay = (display) => {
...
//# sourceMappingURL=scenerySerialize.js.map