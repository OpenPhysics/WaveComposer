 ...
 */
declare const DelayedMutate: <SuperType extends Constructor<Node>>(name: string, keys: string[], type: SuperType) => SuperType;
export default DelayedMutate;
//# sourceMappingURL=DelayedMutate.d.ts.map