...
export default class PaintColorProperty extends Property<Color> {
    private _paint;
    private _luminanceFactor;
    private _changeListener;
    private _paintObserver;
    constructor(paint: TPaint, providedOptions?: PaintColorPropertyOptions);
    /**
     * Sets the current paint of the PaintColorProperty.
     */
    setPaint(paint: TPaint): void;
    set paint(value: TPaint);
    get paint(): TPaint;
    /**
    ...
    set luminanceFactor(value: number);
    get luminanceFactor(): number;
    /**
...
export {};
//# sourceMappingURL=PaintColorProperty.d.ts.map