...
declare class DisplayedProperty extends DerivedProperty1<boolean, Trail[]> {
    private readonly displayedTrailsProperty;
    constructor(node: Node, options?: DisplayedPropertyOptions);
    dispose(): void;
}
export default DisplayedProperty;
//# sourceMappingURL=DisplayedProperty.d.ts.map