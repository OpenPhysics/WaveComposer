...
declare class SwipeListener {
    ...
    swipeDistance: any;
    firstUp: boolean;
    timeSinceLastDown: number;
    downPointers: any[];
    holdingTime: number;
    focusedNode: import("../nodes/Node.js").default | null;
    handleEventListener: {
        down: (event: any) => void;
    };
    _attachedPointerListener: {
        up: (event: any) => void;
        move: (event: any) => void;
     ...
     * @param event
     */
    public handleDown(event: any): void;
    previousPoint: any;
    /**
     * @public
     * @param event
     */
    public up(event: any): void;
    /**
     ...
     * @public
     */
    public detachPointerListener(): void;
    /**
...
//# sourceMappingURL=SwipeListener.d.ts.map