...
const ListenerTestUtils = {
    ...
    mouseDown(display, x, y) {
        ...
        domEvent.initMouseEvent('mousedown', true, true, self, 1, // click count
        x, y, x, y, false, false, false, false, 0, // button
        null);
    ...
    mouseUp(display, x, y) {
        const domEvent = document.createEvent('MouseEvent');
        // technically deprecated, but DOM4 event constructors not out yet. people on #whatwg said to use it
        domEvent.initMouseEvent('mouseup', true, true, self, 1, // click count
        x, y, x, y, false, false, false, false, 0, // button
        null);
        display._input.validatePointers();
...
//# sourceMappingURL=ListenerTestUtils.js.map