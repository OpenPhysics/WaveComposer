 ...
 */
declare const SpriteListenable: <SuperType extends Constructor<PressListener>>(k: SuperType) => SuperType & Constructor<TSpriteListenable>;
export default SpriteListenable;
//# sourceMappingURL=SpriteListenable.d.ts.map