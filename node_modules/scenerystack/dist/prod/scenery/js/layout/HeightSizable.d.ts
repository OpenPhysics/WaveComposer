...
export declare const HEIGHT_SIZABLE_OPTION_KEYS: string[];
...
declare const HeightSizable: <SuperType extends Constructor<Node>>(k: SuperType) => SuperType & Constructor<THeightSizable>;
export default HeightSizable;
//# sourceMappingURL=HeightSizable.d.ts.map