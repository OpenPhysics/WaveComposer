...
export default class LayoutProxy {
    ...
    attemptPreferredSize(orientation: Orientation, preferredSize: number | null): void;
    ...
    dispose(): void;
    freeToPool(): void;
    static readonly pool: Pool<typeof LayoutProxy>;
}
//# sourceMappingURL=LayoutProxy.d.ts.map