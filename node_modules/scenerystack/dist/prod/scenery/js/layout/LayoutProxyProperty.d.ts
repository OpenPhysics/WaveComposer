...
export default class LayoutProxyProperty extends DerivedProperty1<LayoutProxy | null, Trail[]> {
    private readonly trailsBetweenProperty;
     ...
     */
    constructor(rootNode: Node, leafNode: Node, providedOptions?: LayoutProxyPropertyOptions);
    dispose(): void;
}
export {};
//# sourceMappingURL=LayoutProxyProperty.d.ts.map