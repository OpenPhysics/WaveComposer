...
declare const GRID_CONFIGURABLE_OPTION_KEYS: string[];
type SelfOptions = {
...
declare const GridConfigurable: <SuperType extends Constructor>(k: SuperType) => {
    new (...args: IntentionalAny[]): {
         ...
         * (scenery-internal)
         */
        setConfigToInherit(ignoreOptions?: GridConfigurableOptions): void;
        /**
         * (scenery-internal)
         */
        xAlign: HorizontalLayoutAlign | null;
...
//# sourceMappingURL=GridConfigurable.d.ts.map