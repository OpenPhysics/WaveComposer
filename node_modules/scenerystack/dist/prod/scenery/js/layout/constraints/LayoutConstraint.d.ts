...
import { HeightSizableNode, WidthSizableNode, SizableNode } from '../../layout/sizableTypeChecks.js';
...
export default abstract class LayoutConstraint {
    ...
    private _layoutLockCount;
    private _layoutAttemptDuringLock;
    private _enabled;
    protected readonly _updateLayoutListener: () => void;
    private readonly _listenedNodes;
    readonly finishedLayoutEmitter: TEmitter;
    /**
     * (scenery-internal)
     */
     ...
     */
    addNode(node: Node, addLock?: boolean): void;
    /**
     * (scenery-internal)
     */
...
//# sourceMappingURL=LayoutConstraint.d.ts.map