...
} & typeof MarginLayoutCell;
export default class GridCell extends GridCell_base {
    position: OrientationPair<number>;
    size: OrientationPair<number>;
    private readonly gridConstraint;
    /**
     * (scenery-internal)
     */
    ...
    protected onLayoutOptionsChange(isInitial?: boolean): void;
    private setOptions;
    /**
