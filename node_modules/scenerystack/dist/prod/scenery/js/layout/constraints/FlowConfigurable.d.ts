...
declare const FLOW_CONFIGURABLE_OPTION_KEYS: string[];
type SelfOptions = {
...
declare const FlowConfigurable: <SuperType extends Constructor>(k: SuperType) => SuperType & Constructor<TFlowConfigurable>;
export default FlowConfigurable;
export { FLOW_CONFIGURABLE_OPTION_KEYS };
//# sourceMappingURL=FlowConfigurable.d.ts.map