...
export const RestrictedHorizontalLayoutAlignValues = ['left', 'right', 'center'];
export const RestrictedVerticalLayoutAlignValues = ['top', 'bottom', 'center'];
class LayoutAlign extends EnumerationValue {
...
//# sourceMappingURL=LayoutAlign.js.map