...
export default class GridBox extends LayoutNode<GridConstraint> {
    ...
    private _autoLockCount;
    private readonly onChildInserted;
    private readonly onChildRemoved;
    private readonly onChildVisibilityToggled;
    ...
    private updateAutoLines;
    private updateAutoRows;
    private updateAutoColumns;
    private updateAllAutoLines;
    setChildren(children: Node[]): this;
    /**
     * Called when a child is inserted.
     */
    private onGridBoxChildInserted;
    /**
...
export {};
//# sourceMappingURL=GridBox.d.ts.map