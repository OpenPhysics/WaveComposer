...
export declare const HorizontalLayoutJustificationValues: readonly ["left", "right", "center", "spaceBetween", "spaceAround", "spaceEvenly"];
export type HorizontalLayoutJustification = typeof HorizontalLayoutJustificationValues[number];
export declare const VerticalLayoutJustificationValues: readonly ["top", "bottom", "center", "spaceBetween", "spaceAround", "spaceEvenly"];
...
export default class LayoutJustification extends EnumerationValue {
    static readonly START: LayoutJustification;
    static readonly END: LayoutJustification;
    static readonly CENTER: LayoutJustification;
    static readonly SPACE_BETWEEN: LayoutJustification;
    static readonly SPACE_AROUND: LayoutJustification;
    static readonly SPACE_EVENLY: LayoutJustification;
    ...
    static readonly enumeration: Enumeration<LayoutJustification>;
...
export {};
//# sourceMappingURL=LayoutJustification.d.ts.map