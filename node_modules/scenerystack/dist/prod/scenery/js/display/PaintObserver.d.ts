...
declare class PaintObserver {
    ...
    notifyChangeCallback: () => void;
    updateSecondaryListener: (newPaint: string | Color, oldPaint: string | Color, property: Property) => void;
    secondaryPropertyCountsMap: {};
    /**
     ...
     */
    public setPrimary(primary: PaintDef): void;
    /**
     ...
     * @param {Property.<*>} property
     */
    private secondaryLazyLinkProperty;
    /**
     ...
     * @param {Property.<*>} property
     */
    private secondaryUnlinkProperty;
}
import Color from '../util/Color.js';
//# sourceMappingURL=PaintObserver.d.ts.map