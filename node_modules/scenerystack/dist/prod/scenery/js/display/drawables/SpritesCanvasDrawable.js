...
import { SpriteInstanceTransformType } from '../../util/SpriteInstance.js';
class SpritesCanvasDrawable extends CanvasSelfDrawable {
    ...
    paintCanvas(wrapper, node, matrix) {
        ;
        const baseMipmapScale = Imageable.getApproximateMatrixScale(matrix) * (self.devicePixelRatio || 1);
...
//# sourceMappingURL=SpritesCanvasDrawable.js.map