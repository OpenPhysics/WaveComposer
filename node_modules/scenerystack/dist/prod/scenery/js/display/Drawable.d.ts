...
declare class Drawable {
     ...
     */
    public static connectDrawables(a: Drawable, b: Drawable, display: Display): void;
    /**
     ...
     * @param {Display} display
     */
    public static disconnectBefore(drawable: Drawable, display: Display): void;
    /**
     ...
     * @param {Display} display
     */
    public static disconnectAfter(drawable: Drawable, display: Display): void;
    /**
     ...
     */
    public static listToArray(firstDrawable: Drawable, lastDrawable: Drawable): Array<Drawable>;
    /**
     ...
     * @returns {Array.<Drawable>}
     */
    public static oldListToArray(firstDrawable: Drawable, lastDrawable: Drawable): Array<Drawable>;
    /**
     * @public
     *
     ...
     */
    public initialize(renderer: number): Drawable;
    id: any;
    renderer: number | undefined;
    dirty: boolean | undefined;
    isDisposed: boolean | undefined;
    linksDirty: boolean | undefined;
    visibleProperty: TinyProperty<boolean> | undefined;
    fittableProperty: TinyProperty<boolean> | undefined;
    /**
    ...
    parentDrawable: any;
    backbone: any;
    pendingParentDrawable: any;
    pendingBackbone: any;
    pendingAddition: boolean | undefined;
    pendingRemoval: boolean | undefined;
    previousDrawable: any;
    nextDrawable: any;
    oldPreviousDrawable: any;
    oldNextDrawable: any;
    /**
     ...
     */
    public setFittable(fittable: boolean): void;
    set fittable(value: boolean);
    get fittable(): boolean;
    /**
     ...
     */
    public setBlockBackbone(backboneInstance: BackboneDrawable): void;
    /**
     ...
     */
    public notePendingAddition(display: Display, block: Block, backbone: BackboneDrawable): void;
    /**
     ...
     * @param {Display} display
     */
    public notePendingRemoval(display: Display): void;
    /**
     ...
     * @param {Block} block
     */
    public notePendingMove(display: Display, block: Block): void;
    /**
     * Updates the block.
     * @public
     *
     ...
     * @param {Display} display
     */
    public markLinksDirty(display: Display): void;
    /**
     ...
     * @param {Display} display
     */
    public markForDisposal(display: Display): void;
    /**
     ...
     * @param {Display} display
     */
    public disposeImmediately(display: Display): void;
    /**
     * Releases references
     * @public
     *
     ...
     */
    public audit(allowPendingBlock: boolean, allowPendingList: boolean, allowDirty: boolean): void;
    /**
