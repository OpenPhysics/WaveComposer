...
export default class Input extends PhetioObject {
    ...
    readonly batchDOMEvents: boolean;
    readonly assumeFullWindow: boolean;
    readonly passiveEvents: boolean | null;
    readonly preventMultitouch: boolean;
    readonly interruptMultitouch: boolean;
    pdomPointer: PDOMPointer | null;
    mouse: Mouse | null;
    pointers: Pointer[];
    pointerAddedEmitter: TEmitter<[Pointer]>;
    currentlyFiringEvents: boolean;
    currentSceneryEvent: SceneryEvent | null;
    private batchedEvents;
    private upTimeStamp;
    private readonly validatePointersAction;
    private readonly mouseUpAction;
    private readonly mouseDownAction;
    private readonly mouseMoveAction;
    private readonly mouseOverAction;
    private readonly mouseOutAction;
    private readonly wheelScrollAction;
    private readonly touchStartAction;
    private readonly touchEndAction;
    private readonly touchMoveAction;
    private readonly touchCancelAction;
    private readonly penStartAction;
    private readonly penEndAction;
    private readonly penMoveAction;
    private readonly penCancelAction;
    private readonly gotPointerCaptureAction;
    private readonly lostPointerCaptureAction;
    private readonly focusinAction;
    private readonly focusoutAction;
    private readonly clickAction;
    private readonly inputAction;
    private readonly changeAction;
    private readonly keydownAction;
    private readonly keyupAction;
    static readonly InputIO: IOType<Input, InputState, InputState>;
    /**
     * @param display
     ...
     */
    constructor(display: Display, attachToWindow: boolean, batchDOMEvents: boolean, assumeFullWindow: boolean, passiveEvents: boolean | null, preventMultitouch: boolean, interruptMultitouch: boolean, providedOptions?: InputOptions);
    /**
     ...
     */
    interruptPointers(excludePointer?: Pointer | null): void;
    /**
     ...
     */
    batchEvent(context: EventContext, batchType: BatchedDOMEventType, callback: BatchedDOMEventCallback, triggerImmediate: boolean): void;
    /**
    ...
    private interruptMultitouchPointers;
    /**
     ...
     */
    private findPointerById;
    private getPDOMEventTrail;
    private ensureMouse;
    private ensurePDOMPointer;
    /**
     ...
     */
    mouseDown(id: number, point: Vector2, context: EventContext<MouseEvent | PointerEvent>): void;
    /**
     ...
     * playback. The event may be "faked" for certain purposes.
     */
    mouseUp(point: Vector2, context: EventContext<MouseEvent | PointerEvent>): void;
    /**
     ...
     * playback. The event may be "faked" for certain purposes.
     */
    mouseMove(point: Vector2, context: EventContext<MouseEvent | PointerEvent>): void;
    /**
     ...
     */
    mouseOver(point: Vector2, context: EventContext<MouseEvent | PointerEvent>): void;
    /**
     ...
     */
    mouseOut(point: Vector2, context: EventContext<MouseEvent | PointerEvent>): void;
    /**
     * Triggers a logical mouse-wheel/scroll event. (scenery-internal)
     */
    wheel(context: EventContext<WheelEvent>): void;
    /**
     ...
     * playback. The event may be "faked" for certain purposes.
     */
    touchStart(id: number, point: Vector2, context: EventContext<TouchEvent | PointerEvent>): void;
    /**
     ...
     * playback. The event may be "faked" for certain purposes.
     */
    touchEnd(id: number, point: Vector2, context: EventContext<TouchEvent | PointerEvent>): void;
    /**
     ...
     * playback. The event may be "faked" for certain purposes.
     */
    touchMove(id: number, point: Vector2, context: EventContext<TouchEvent | PointerEvent>): void;
    /**
     ...
     * playback. The event may be "faked" for certain purposes.
     */
    touchCancel(id: number, point: Vector2, context: EventContext<TouchEvent | PointerEvent>): void;
    /**
     ...
     * playback. The event may be "faked" for certain purposes.
     */
    penStart(id: number, point: Vector2, context: EventContext<PointerEvent>): void;
    /**
     ...
     * playback. The event may be "faked" for certain purposes.
     */
    penEnd(id: number, point: Vector2, context: EventContext<PointerEvent>): void;
    /**
     ...
     * playback. The event may be "faked" for certain purposes.
     */
    penMove(id: number, point: Vector2, context: EventContext<PointerEvent>): void;
    /**
