...
const useDOMAsFastBounds = self.navigator.userAgent.includes('like Gecko) Version/5') &&
...
class Text extends Paintable(Node) {
    ...
    static getStringPropertyPhetioMouseHitTarget(fromLinking, forwardingProperty) {
