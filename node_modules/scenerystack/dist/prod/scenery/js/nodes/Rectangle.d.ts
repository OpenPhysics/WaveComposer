...
declare const SuperType: typeof Path & import("../../../phet-core.js").Constructor<import("../layout/Sizable.js").TSizable>;
export default class Rectangle extends SuperType {
    ...
    set cornerXRadius(value: number);
    get cornerXRadius(): number;
    /**
    ...
    set cornerYRadius(value: number);
    get cornerYRadius(): number;
    /**
    ...
    set rectBounds(value: Bounds2);
    get rectBounds(): Bounds2;
    /**
    ...
    set rectSize(value: Dimension2);
    get rectSize(): Dimension2;
    /**
    ...
    set rectWidthFromRight(value: number);
    get rectWidthFromRight(): number;
    /**
    ...
    set rectHeightFromBottom(value: number);
    get rectHeightFromBottom(): number;
    /**
