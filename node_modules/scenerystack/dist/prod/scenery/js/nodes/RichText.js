...
import '../../../globals.js';
import { parse as himalayaParse } from 'himalaya';
...
import RichTextUtils, { isHimalayaElementNode, isHimalayaTextNode } from '../util/rich-text/RichTextUtils.js';
...
class RichText extends WidthSizable(Node) {
    ...
    set stringProperty(property) { this.setStringProperty(property); }
    get stringProperty() { return this.getStringProperty(); }
    /**
    ...
    rebuildRichText() {
        ...
        try {
            rootElements = himalayaParse(mappedText);
        }
        catch (e) {
            ...
            // build process).
            rootElements = himalayaParse('INVALID TRANSLATION');
        }
    ...
    set string(value) { this.setString(value); }
    ...
    set nodes(value) { this.setNodes(value); }
    get nodes() { return this.getNodes(); }
    setTags(tags) {
        ;
        if (this._tags !== tags) {
            this._tags = tags;
    ...
    set replaceNewlines(value) { this.setReplaceNewlines(value); }
    get replaceNewlines() { return this.getReplaceNewlines(); }
    getReplaceNewlines() {
    ...
    static getAccessibleStringProperty(stringProperty) {
        return new DerivedStringProperty([stringProperty], string => {
            const rootElements = himalayaParse(string);
