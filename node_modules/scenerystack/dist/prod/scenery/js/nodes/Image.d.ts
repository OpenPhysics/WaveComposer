...
declare const Image_base: typeof Node & import("../../../phet-core.js").Constructor<import("../nodes/Imageable.js").TImageable>;
export default class Image extends Image_base {
    private _imageBounds;
    constructor(image: ImageableImage | TReadOnlyProperty<ImageableImage>, providedOptions?: ImageOptions);
    /**
    ...
    set imageBounds(value: Bounds2 | null);
    get imageBounds(): Bounds2 | null;
    /**
    ...
    static ImageIO: AnyIOType;
    static readonly DEFAULT_IMAGE_OPTIONS: ImageOptions;
}
export {};
