...
export default abstract class WebGLNode extends Node {
    ...
    set canvasBounds(value: Bounds2);
    get canvasBounds(): Bounds2;
    /**
    ...
    static readonly PAINTED_NOTHING = 0;
    static readonly PAINTED_SOMETHING = 1;
}
export {};
//# sourceMappingURL=WebGLNode.d.ts.map