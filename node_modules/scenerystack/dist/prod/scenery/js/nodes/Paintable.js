...
import LineStyles, { LINE_STYLE_DEFAULT_OPTIONS } from '../../../kite/js/util/LineStyles.js';
...
const Paintable = memoize((Type) => {
    return class PaintableMixin extends Type {
        ...
        getFillRendererBitmask() {
            ...
            else if (this._fill && this._fill.isPattern) {
                // no pattern support for DOM or WebGL (for now!)
            }
            else if (this._fill && this._fill.isGradient) {
