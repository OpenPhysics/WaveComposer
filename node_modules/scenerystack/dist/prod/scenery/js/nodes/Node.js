// Copyright 2012-2025, University of Colorado Boulder
import '../../../globals.js';
...
import ParallelDOM, { ACCESSIBILITY_OPTION_KEYS } from '../accessibility/pdom/ParallelDOM.js';
...
class Node extends ParallelDOM {
    ...
    constructor(options) {
        ...
        this.rendererSummaryRefreshEmitter = new TinyEmitter(null, null, null, true);
        ...
        this._drawables = [];
        this._visibleProperty = new TinyForwardingProperty(DEFAULT_OPTIONS.visible, DEFAULT_OPTIONS.phetioVisiblePropertyInstrumented, this.onVisiblePropertyChange.bind(this), true);
        ...
        this.clipAreaProperty = new TinyProperty(DEFAULT_OPTIONS.clipArea, null, null, null, true);
        this.voicingVisibleProperty = new TinyProperty(true, null, null, null, true);
    ...
    get widthSizable() { return false; }
    get heightSizable() { return false; }
    get extendsWidthSizable() { return false; }
    get extendsHeightSizable() { return false; }
    get extendsSizable() { return false; }
    /**
