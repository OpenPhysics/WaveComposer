...
export default class DOM extends Node {
    ...
    isInputAllowed() { return this._allowInput; }
    ...
    set allowInput(value) { this.setAllowInput(value); }
    get allowInput() { return this.isInputAllowed(); }
    mutate(options) {
