...
declare class GroupHighlightFromNode extends HighlightFromNode {
    constructor(node: Node | null, providedOptions?: GroupHighlightFromNodeOptions);
}
export default GroupHighlightFromNode;
//# sourceMappingURL=GroupHighlightFromNode.d.ts.map