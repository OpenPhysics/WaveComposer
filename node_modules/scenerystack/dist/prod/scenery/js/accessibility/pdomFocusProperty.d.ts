...
export declare const pdomFocusProperty: Property<Focus | null>;
/**
 * Get the Node that currently has DOM focus, the leaf-most Node of the Focus Trail. Null if no
 * Node has focus.
 */
export declare const getPDOMFocusedNode: () => Node | null;
//# sourceMappingURL=pdomFocusProperty.d.ts.map