 ...
 */
declare const KeyboardUtils: {
    KEY_SPACE: string;
    KEY_ENTER: string;
    KEY_TAB: string;
    KEY_RIGHT_ARROW: string;
    KEY_LEFT_ARROW: string;
    KEY_UP_ARROW: string;
    KEY_DOWN_ARROW: string;
    KEY_SHIFT_LEFT: string;
    KEY_SHIFT_RIGHT: string;
    KEY_ALT_LEFT: string;
    KEY_ALT_RIGHT: string;
    KEY_CONTROL_LEFT: string;
    KEY_CONTROL_RIGHT: string;
    KEY_META_LEFT: string;
    KEY_META_RIGHT: string;
    KEY_META_LEFT_FIREFOX: string;
    KEY_META_RIGHT_FIREFOX: string;
    KEY_SHIFT: string;
    KEY_ALT: string;
    KEY_CONTROL: string;
    KEY_ESCAPE: string;
    ...
    KEY_NUMPAD_8: string;
    KEY_NUMPAD_9: string;
    KEY_NUMPAD_DECIMAL: string;
    KEY_NUMPAD_PLUS: string;
    KEY_NUMPAD_MINUS: string;
    KEY_A: string;
    KEY_B: string;
    KEY_C: string;
    KEY_D: string;
    ...
    ALT_KEYS: string[];
    META_KEYS: string[];
    MODIFIER_KEY_CODES: string[];
    MODIFIER_KEY_TO_CODE_MAP: Map<string, string[]>;
    /**
