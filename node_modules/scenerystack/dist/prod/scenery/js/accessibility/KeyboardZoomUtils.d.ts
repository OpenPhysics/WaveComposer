...
declare const KeyboardZoomUtils: {
    /**
    ...
    ZOOM_IN_HOTKEY_DATA: HotkeyData;
    ZOOM_OUT_HOTKEY_DATA: HotkeyData;
    RESET_ZOOM_HOTKEY_DATA: HotkeyData;
};
export default KeyboardZoomUtils;
//# sourceMappingURL=KeyboardZoomUtils.d.ts.map