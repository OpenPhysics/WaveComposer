...
declare class VoicingManager extends SpeechSynthesisAnnouncer {
     ...
     */
    initialize(userGestureEmitter: TReadOnlyEmitter, options?: SpeechSynthesisInitializeOptions): void;
    /**
     * Returns true if voicing is supported for the provided locale. Currently, only English is supported.
     * @param locale - the locale string
     */
    voicingSupportedForLocale(locale: string): boolean;
}
declare const voicingManager: VoicingManager;
export default voicingManager;
//# sourceMappingURL=voicingManager.d.ts.map