...
declare const VoicingRichText_base: typeof RichText & import("../../../../../phet-core.js").Constructor<import("../../../accessibility/voicing/ReadingBlock.js").TReadingBlock<RichText>>;
declare class VoicingRichText extends VoicingRichText_base {
    constructor(text: string | TReadOnlyProperty<string>, providedOptions?: VoicingRichTextOptions);
}
export default VoicingRichText;
//# sourceMappingURL=VoicingRichText.d.ts.map