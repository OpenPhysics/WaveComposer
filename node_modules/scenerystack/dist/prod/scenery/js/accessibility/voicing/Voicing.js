...
const Voicing = (Type) => {
    ...
    const VoicingClass = DelayedMutate('Voicing', VOICING_OPTION_KEYS, class VoicingClass extends InteractiveHighlighting(Type) {
        ...
        set voicingUtterance(utterance) { this.setVoicingUtterance(utterance); }
        ...
        set voicingPressable(pressable) { this.setVoicingPressable(pressable); }
        get voicingPressable() { return this.getVoicingPressable(); }
        getVoicingPressable() {
        ...
        set voicingFocusListener(focusListener) { this.setVoicingFocusListener(focusListener); }
...
//# sourceMappingURL=Voicing.js.map