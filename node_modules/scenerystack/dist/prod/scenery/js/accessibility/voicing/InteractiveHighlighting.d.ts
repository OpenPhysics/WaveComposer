...
declare const InteractiveHighlighting: {
    <SuperType extends Constructor<Node>>(Type: SuperType): SuperType & Constructor<TInteractiveHighlighting<InstanceType<SuperType>>>;
    forwardInteractiveHighlightFromPress(targetNode: Node, event: PressListenerEvent): void;
};
export type InteractiveHighlightingNodeType = Node & TInteractiveHighlighting;
export default InteractiveHighlighting;
//# sourceMappingURL=InteractiveHighlighting.d.ts.map