...
declare const VoicingText_base: typeof Text & import("../../../../../phet-core.js").Constructor<import("../../../accessibility/voicing/ReadingBlock.js").TReadingBlock<Text>>;
declare class VoicingText extends VoicingText_base {
    constructor(text: string | TReadOnlyProperty<string>, providedOptions?: VoicingTextOptions);
}
export default VoicingText;
//# sourceMappingURL=VoicingText.d.ts.map