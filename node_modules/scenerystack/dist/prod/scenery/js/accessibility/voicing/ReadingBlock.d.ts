...
type UnsupportedVoicingOptions = 'voicingNameResponse' | 'voicingObjectResponse' | 'voicingContextResponse' | 'voicingHintResponse' | 'voicingUtterance' | 'voicingResponsePatternCollection';
export type ReadingBlockOptions = SelfOptions & StrictOmit<VoicingOptions, UnsupportedVoicingOptions> & StrictOmit<NodeOptions, 'tagName' | 'focusable'>;
...
declare const ReadingBlock: <SuperType extends Constructor<Node>>(k: SuperType) => SuperType & Constructor<TReadingBlock<InstanceType<SuperType>>>;
export type TReadingBlockNode = Node & TReadingBlock;
export default ReadingBlock;
//# sourceMappingURL=ReadingBlock.d.ts.map