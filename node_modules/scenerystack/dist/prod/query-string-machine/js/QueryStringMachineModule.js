 ...
 */
const isParameterString = (string) => string.length === 0 || string.startsWith('?');
...
export const QueryStringMachine = {
    ...
    get: function (key, schema) {
        return this.getForString(key, schema, self.location.search);
    },
    /**
    ...
    getAll: function (schemaMap) {
        return {
            ...
            ...this.getAllForString(schemaMap, self.location.search),
    ...
    getForString: function (key, schema, string) {
        ...
        if (hasOwnProperty(schema, 'validValues')) {
            ...
            value = getValidValue(isValidValue(value, validValues), key, value, schema, `Invalid value supplied for key "${key}": ${value} is not a member of valid values: ${validValues.join(', ')}`);
        }
    ...
    containsKey: function (key) {
        return this.containsKeyForString(key, self.location.search);
    },
    /**
...
const validateSchema = function (key, schema) {
    ...
    queryStringMachineAssert(!(schema.hasOwnProperty('validValues') && schema.hasOwnProperty('isValidValue')), `validValues and isValidValue are mutually exclusive for key: ${key}`);
...
//# sourceMappingURL=QueryStringMachineModule.js.map