...
export default class ScreenSummaryContent extends Node {
    constructor(providedOptions) {
        ...
        this.inThePlayAreaParagraph = new Node({
            tagName: 'p',
            accessibleName: string_joist_a11y_inPlayArea_StringProperty
        });
        this.playAreaContentNode = new Node();
        this.inTheControlAreaParagraph = new Node({
            tagName: 'p',
            accessibleName: string_joist_a11y_inControlArea_StringProperty
        });
...
//# sourceMappingURL=ScreenSummaryContent.js.map