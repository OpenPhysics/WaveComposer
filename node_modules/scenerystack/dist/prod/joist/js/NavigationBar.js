...
class NavigationBar extends Node {
    constructor(sim, tandem) {
        super();
        this.homeButton = null; // mutated if multiscreen sim
        ...
        if (sim.simScreens.length === 1) {
            ...
            buttons = new Node({
                ...
                accessibleHeading: string_joist_a11y_simScreens_StringProperty,
        ...
        const simResourcesContainer = new Node({
            ...
            accessibleHeading: string_joist_a11y_simResources_StringProperty,
