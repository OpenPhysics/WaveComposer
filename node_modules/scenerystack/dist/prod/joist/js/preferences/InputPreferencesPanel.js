...
// constants
const gestureControlEnabledAlertStringProperty = string_joist_a11y_preferences_tabs_input_gestureControl_enabledAlert_StringProperty;
const gestureControlDisabledAlertStringProperty = string_joist_a11y_preferences_tabs_input_gestureControl_disabledAlert_StringProperty;
...
class InputPreferencesPanel extends PreferencesPanel {
    constructor(inputModel, selectedTabProperty, tabVisibleProperty, providedOptions) {
        ...
        inputModel.customPreferences.forEach(customPreference => {
            ...
            contentNode.addChild(new Node({ children: [customContent] }));
        });
...
//# sourceMappingURL=InputPreferencesPanel.js.map