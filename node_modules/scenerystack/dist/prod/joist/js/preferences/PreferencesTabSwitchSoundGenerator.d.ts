...
declare class PreferencesTabSwitchSoundGenerator extends SoundClip {
    constructor(selectedTabProperty: EnumerationProperty<PreferencesType>, options: SoundClipOptions);
    dispose(): void;
}
export default PreferencesTabSwitchSoundGenerator;
//# sourceMappingURL=PreferencesTabSwitchSoundGenerator.d.ts.map