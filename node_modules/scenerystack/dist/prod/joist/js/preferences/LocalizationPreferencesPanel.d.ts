...
declare class LocalizationPreferencesPanel extends PreferencesPanel {
    constructor(localizationModel: LocalizationModel, selectedTabProperty: TReadOnlyProperty<PreferencesType>, tabVisibleProperty: TReadOnlyProperty<boolean>, providedOptions: LocalizationPreferencesPanelOptions);
}
export default LocalizationPreferencesPanel;
//# sourceMappingURL=LocalizationPreferencesPanel.d.ts.map