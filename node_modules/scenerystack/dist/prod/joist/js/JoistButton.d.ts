...
declare const JoistButton_base: typeof Node & import("../../phet-core.js").Constructor<import("../../scenery/js/accessibility/voicing/Voicing.js").TVoicing<Node>>;
export default class JoistButton extends JoistButton_base {
     ...
     */
    constructor(content: Node, navigationBarFillProperty: TReadOnlyProperty<Color>, providedOptions: JoistButtonOptions);
    /**
...
export {};
//# sourceMappingURL=JoistButton.d.ts.map