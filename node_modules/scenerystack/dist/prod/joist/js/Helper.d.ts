...
declare class PointerAreaType extends EnumerationValue {
    static readonly MOUSE: PointerAreaType;
    static readonly TOUCH: PointerAreaType;
    static readonly NONE: PointerAreaType;
    static readonly enumeration: Enumeration<PointerAreaType>;
}
