...
declare class SimInfo extends PhetioObject {
    readonly info: SimInfoState;
    constructor(sim: Sim);
    private putInfo;
    static SimInfoIO: IOType<SimInfo, SimInfoState, SimInfoState>;
}
export default SimInfo;
//# sourceMappingURL=SimInfo.d.ts.map