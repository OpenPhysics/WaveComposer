...
class NavigationBarAudioToggleButton extends JoistButton {
    constructor(soundEnabledProperty, backgroundColorProperty, providedOptions) {
        const options = optionize()({
            ...
            phetioFeatured: true,
            // pdom
            accessibleName: string_joist_a11y_soundToggle_label_StringProperty,
            // voicing
            voicingNameResponse: string_joist_a11y_soundToggle_label_StringProperty
        }, providedOptions);
        ;
        ...
        const speakerNode = new Path(new Shape()
        ...
        const soundOffX = new Path(new Shape().moveTo(0, 0).lineTo(X_WIDTH, X_WIDTH).moveTo(0, X_WIDTH)
            .lineTo(X_WIDTH, 0), {
            stroke: 'black',
            lineWidth: 1.7,
            lineCap: 'round',
        ...
        const soundOnCurves = new Path(new Shape()
        ...
        const enabledListener = (enabled) => {
            if (options.supportsAudioPreferences) {
                ...
                soundUtterance.alert = enabled ? string_joist_a11y_soundToggle_alert_simSoundOn_StringProperty
                    : string_joist_a11y_soundToggle_alert_simSoundOff_StringProperty;
...
//# sourceMappingURL=NavigationBarAudioToggleButton.js.map