...
class UpdateCheck {
    constructor() {
        ...
        this.updateURL = `${'https://phet.colorado.edu/html-sim-update' +
            '?simulation='}${encodeURIComponent(simName)}&version=${encodeURIComponent(simVersion.toString())}&buildTimestamp=${encodeURIComponent(`${phet.chipper.buildTimestamp}`)}`;
        this.timeoutId = -1;
    }
    ...
    setTimeout() {
        this.timeoutId = self.setTimeout(this.timeoutCallback, TIMEOUT_MILLISECONDS); // eslint-disable-line phet/bad-sim-text
    }
