...
export declare const DEFAULT_REGION_AND_CULTURE = "usa";
declare const RegionAndCultureValues: readonly ["usa", "africa", "africaModest", "asia", "latinAmerica", "oceania", "random"];
export type RegionAndCulture = typeof RegionAndCultureValues[number];
export declare const supportedRegionAndCultureValues: RegionAndCulture[];
declare class RegionAndCultureProperty extends Property<RegionAndCulture> {
    protected unguardedSet(value: RegionAndCulture): void;
}
declare const regionAndCultureProperty: RegionAndCultureProperty;
export default regionAndCultureProperty;
//# sourceMappingURL=regionAndCultureProperty.d.ts.map