...
export declare class LocaleProperty extends Property<Locale> {
    readonly availableRuntimeLocales: Locale[];
    private _isLocaleChanging;
    constructor(value: Locale, providedOptions?: LocalePropertyOptions);
    /**
     * True when the locale is in the process of changing, so that you can opt out of work while many strings are changing.
     */
    get isLocaleChanging(): boolean;
    protected unguardedSet(value: Locale): void;
    protected toStateObject<StateType>(): ReadOnlyPropertyState<StateType>;
    get supportsDynamicLocale(): boolean;
}
declare const localeProperty: LocaleProperty;
export default localeProperty;
//# sourceMappingURL=localeProperty.d.ts.map