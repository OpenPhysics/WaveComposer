...
import { type ConcreteRegionAndCulture } from './concreteRegionAndCultureProperty.js';
export default class LocalizedImageProperty extends DerivedProperty1<ImageableImage, ConcreteRegionAndCulture> {
    ...
    constructor(imageName: string, imageMap: Partial<Record<ConcreteRegionAndCulture, ImageableImage>> & {
        usa: ImageableImage;
    });
}
//# sourceMappingURL=LocalizedImageProperty.d.ts.map