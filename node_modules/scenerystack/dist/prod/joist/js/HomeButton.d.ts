...
export default class HomeButton extends JoistButton {
     ...
     */
    constructor(navBarHeight: number, navigationBarFillProperty: TReadOnlyProperty<Color>, pdomDisplayNameProperty: TReadOnlyProperty<string | null>, providedOptions: HomeButtonOptions);
}
export {};
//# sourceMappingURL=HomeButton.d.ts.map