...
export default function launchCounter(simNameProperty) {
    ...
    try {
        storedRunCountString = self.localStorage.getItem(LOCAL_STORAGE_KEY);
    }
    catch (error) {
    ...
    try {
        self.localStorage.setItem(LOCAL_STORAGE_KEY, toFixed(newRunCount, 0));
    }
    catch (error) {
        console.error('Error accessing localStorage:', error);
    }
...
//# sourceMappingURL=launchCounter.js.map