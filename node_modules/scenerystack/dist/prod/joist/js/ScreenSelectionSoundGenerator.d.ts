...
declare class ScreenSelectionSoundGenerator extends SoundClip {
    constructor(screenProperty: ReadOnlyProperty<AnyScreen>, homeScreen: HomeScreen | null, options?: SoundClipOptions);
}
export default ScreenSelectionSoundGenerator;
//# sourceMappingURL=ScreenSelectionSoundGenerator.d.ts.map