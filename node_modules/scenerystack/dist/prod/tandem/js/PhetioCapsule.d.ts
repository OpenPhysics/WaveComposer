...
declare class PhetioCapsule<T extends PhetioObject, P extends IntentionalAny[] = []> extends PhetioDynamicElementContainer<T, P> {
    private element;
    private readonly disposeOnClear;
    private readonly disposeCreatedOnStateSet;
    /**
     ...
     */
    constructor(createElement: (t: Tandem, ...p: P) => T, defaultArguments: P | (() => P), providedOptions?: PhetioCapsuleOptions);
    /**
     ...
     */
    clear(providedOptions?: ClearOptions): void;
    /**
     ...
     * (phet-io)
     */
    create(argsForCreateFunction: P, fromStateSetting?: boolean): T;
    /**
     ...
     * @constructor
     */
    static PhetioCapsuleIO: <ParameterType extends PhetioObject, ParameterStateType>(parameterType: IOType<ParameterType, ParameterStateType>) => AnyIOType;
}
export default PhetioCapsule;
//# sourceMappingURL=PhetioCapsule.d.ts.map