 ...
 */
import '../../globals.js';
import { PhetioAPI } from './phet-io-types.js';
import type PhetioObject from './PhetioObject.js';
declare class PhetioAPIValidation {
    private readonly apiMismatches;
    private simHasStarted;
    private everyPhetioType;
    /**
     ...
     */
    validatePreferencesModel(): void;
    validateFullAPI(api: PhetioAPI): void;
    /**
     * Checks if a removed phetioObject is part of a Group
     */
    onPhetioObjectRemoved(phetioObject: PhetioObject): void;
    /**
     * Should be called from phetioEngine when a PhetioObject is added to the PhET-iO
     */
    onPhetioObjectAdded(phetioObject: PhetioObject): void;
    private validateOverridesFile;
    /**
     * Assert out the failed API validation rule.
     */
    private assertAPIError;
    /**
     * Compare a dynamic phetioObject's metadata to the expected metadata
     */
    private checkDynamicInstanceAgainstArchetype;
}
declare const phetioAPIValidation: PhetioAPIValidation;
export default phetioAPIValidation;
//# sourceMappingURL=phetioAPIValidation.d.ts.map