...
declare class DynamicTandem extends Tandem {
    constructor(parentTandem: Tandem, name: string, providedOptions?: DynamicTandemOptions);
}
export default DynamicTandem;
//# sourceMappingURL=DynamicTandem.d.ts.map