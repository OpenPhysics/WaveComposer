...
class PhetioAPIValidation {
    ...
    validateOverridesFile() {
        ...
        for (const phetioID in self.phet.preloads.phetio.phetioElementsOverrides) {
            ...
            if (!phet.preloads.phetio.createArchetypes && !entireBaseline.hasOwnProperty(phetioID)) {
                ...
                if (!entireBaseline.hasOwnProperty(phetioID)) {
                    ...
                    const override = self.phet.preloads.phetio.phetioElementsOverrides[phetioID];
...
//# sourceMappingURL=phetioAPIValidation.js.map