...
export default class Complex {
     ...
     */
    equalsEpsilon(other: Complex, epsilon?: number): boolean;
    /**
     ...
     */
    static solveLinearRoots(a: Complex, b: Complex): Complex[] | null;
    /**
     ...
     */
    static solveQuadraticRoots(a: Complex, b: Complex, c: Complex): Complex[] | null;
    /**
     ...
     * @returns The roots of the equation, or null if all values are roots (if multiplicity>1, returns multiple copies)
     */
    static solveCubicRoots(a: Complex, b: Complex, c: Complex, d: Complex): Complex[] | null;
    /**
