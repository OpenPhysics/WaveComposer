...
declare class Transform3 {
    ...
    matrix: Matrix3;
    inverse: Matrix3;
    matrixTransposed: Matrix3;
    inverseTransposed: Matrix3;
    inverseValid: boolean;
    transposeValid: boolean;
    inverseTransposeValid: boolean;
     ...
     * @protected
     */
    protected validateMatrix(matrix: Matrix): void;
    /**
     ...
     * @param {Matrix3} matrix
     */
    public prepend(matrix: Matrix3): void;
    /**
     ...
     * @param {Matrix3} matrix
     */
    public append(matrix: Matrix3): void;
    /**
     ...
     */
    public prependTransform(transform: Transform3): void;
    /**
     ...
     * @param {Transform3} transform
     */
    public appendTransform(transform: Transform3): void;
    /**
     ...
     */
    public applyToCanvasContext(context: CanvasRenderingContext2D): void;
    /**
     ...
     * @returns {Matrix3}
     */
    public getMatrixTransposed(): Matrix3;
    /**
     ...
     * @returns {Matrix3}
     */
    public getInverseTransposed(): Matrix3;
    /**
     ...
     * @returns {Vector2}
     */
    public transformPosition2(v: Vector2): Vector2;
    /**
     ...
     * @returns {Vector2}
     */
    public transformDelta2(v: Vector2): Vector2;
    /**
     ...
     * @returns {Vector2}
     */
    public transformNormal2(v: Vector2): Vector2;
    /**
     ...
     * @returns {number}
     */
    public transformDeltaX(x: number): number;
    /**
     ...
     * @returns {number}
     */
    public transformDeltaY(y: number): number;
    /**
     ...
     * @returns {Bounds2}
     */
    public transformBounds2(bounds: Bounds2): Bounds2;
    /**
     ...
     * @returns {Shape}
     */
    public transformShape(shape: Shape): Shape;
    /**
     ...
     * @returns {Ray2}
     */
    public transformRay2(ray: Ray2): Ray2;
    /**
     ...
     * @returns {Vector2}
     */
    public inversePosition2(v: Vector2): Vector2;
    /**
     ...
     * @returns {Vector2}
     */
    public inverseDelta2(v: Vector2): Vector2;
    /**
     ...
     * @returns {Vector2}
     */
    public inverseNormal2(v: Vector2): Vector2;
    /**
     ...
     * @returns {number}
     */
    public inverseX(x: number): number;
    /**
     ...
     * @returns {number}
     */
    public inverseY(y: number): number;
    /**
     ...
     * @returns {number}
     */
    public inverseDeltaX(x: number): number;
    /**
     ...
     * @returns {number}
     */
    public inverseDeltaY(y: number): number;
    /**
     ...
     * @returns {Bounds2}
     */
    public inverseBounds2(bounds: Bounds2): Bounds2;
    /**
     ...
     * @returns {Shape}
     */
    public inverseShape(shape: Shape): Shape;
    /**
     ...
     * @returns {Ray2}
     */
    public inverseRay2(ray: Ray2): Ray2;
}
