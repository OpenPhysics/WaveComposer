...
declare class CompletePiecewiseLinearFunction {
    points: Vector2[];
     ...
     */
    private binaryIntersectingOperation;
    /**
    ...
    static sum(...functions: CompletePiecewiseLinearFunction[]): CompletePiecewiseLinearFunction;
    static min(...functions: CompletePiecewiseLinearFunction[]): CompletePiecewiseLinearFunction;
    static max(...functions: CompletePiecewiseLinearFunction[]): CompletePiecewiseLinearFunction;
    static constant(y: number): CompletePiecewiseLinearFunction;
    static linear(a: number, b: number): CompletePiecewiseLinearFunction;
    /**
     * Returns a sorted list of the input numbers, ensuring no duplicates within a specified epsilon value
     */
    private static sortedUniqueEpsilon;
}
export default CompletePiecewiseLinearFunction;
//# sourceMappingURL=CompletePiecewiseLinearFunction.d.ts.map