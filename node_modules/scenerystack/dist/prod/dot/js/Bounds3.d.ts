...
declare class Bounds3 {
     ...
     */
    static cuboid(x: number, y: number, z: number, width: number, height: number, depth: number): Bounds3;
    /**
     ...
     * zero area.
     */
    static point(x: number, y: number, z: number): Bounds3;
    readonly isBounds = true;
     ...
     */
    static readonly NOTHING: Bounds3;
    /**
     ...
     */
    static readonly EVERYTHING: Bounds3;
    static readonly Bounds3IO: IOType<any, any, any>;
}
export default Bounds3;
//# sourceMappingURL=Bounds3.d.ts.map