...
export declare class Matrix3Type extends EnumerationValue {
    static readonly OTHER: Matrix3Type;
    static readonly IDENTITY: Matrix3Type;
    static readonly TRANSLATION_2D: Matrix3Type;
    static readonly SCALING: Matrix3Type;
    static readonly AFFINE: Matrix3Type;
    static readonly enumeration: Enumeration<Matrix3Type>;
}
type NineNumbers = [
    number,
    number,
...
export default class Matrix3 implements TPoolable {
    ...
    get cssTransformStyles(): Record<string, string>;
    /**
    ...
    freeToPool(): void;
    static readonly pool: Pool<typeof Matrix3>;
    /**
    ...
    static Matrix3IO: AnyIOType;
}
declare const m3: (v00: number, v01: number, v02: number, v10: number, v11: number, v12: number, v20: number, v21: number, v22: number, type?: Matrix3Type) => Matrix3;
export { m3 };
