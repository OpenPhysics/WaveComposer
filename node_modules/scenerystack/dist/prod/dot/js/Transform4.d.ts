...
declare class Transform4 {
    ...
    matrix: Matrix4;
    inverse: Matrix4;
    matrixTransposed: Matrix4;
    inverseTransposed: Matrix4;
     ...
     * @param {Matrix4} matrix
     */
    public prepend(matrix: Matrix4): void;
    /**
     ...
     * @param {Matrix4} matrix
     */
    public append(matrix: Matrix4): void;
    /**
     ...
     */
    public prependTransform(transform: Transform4): void;
    /**
     ...
     * @param {Transform4} transform
     */
    public appendTransform(transform: Transform4): void;
    /**
     ...
     * @returns {Matrix4}
     */
    public getMatrixTransposed(): Matrix4;
    /**
     ...
     * @returns {Matrix4}
     */
    public getInverseTransposed(): Matrix4;
    /**
     ...
     * @returns {Vector3}
     */
    public transformPosition3(v: Vector3): Vector3;
    /**
     ...
     * @returns {Vector3}
     */
    public transformDelta3(v: Vector3): Vector3;
    /**
     ...
     * @returns {Vector3}
     */
    public transformNormal3(v: Vector3): Vector3;
    /**
     ...
     * @returns {number}
     */
    public transformDeltaZ(z: number): number;
    /**
     ...
     * @returns {Ray3}
     */
    public transformRay(ray: Ray3): Ray3;
    /**
     ...
     * @returns {Vector3}
     */
    public inversePosition3(v: Vector3): Vector3;
    /**
     ...
     * @returns {Vector3}
     */
    public inverseDelta3(v: Vector3): Vector3;
    /**
     ...
     * @returns {Vector3}
     */
    public inverseNormal3(v: Vector3): Vector3;
    /**
     ...
     * @returns {number}
     */
    public inverseDeltaZ(z: number): number;
    /**
     ...
     * @returns {Ray3}
     */
    public inverseRay(ray: Ray3): Ray3;
}
import Matrix4 from './Matrix4.js';
import TinyEmitter from '../../axon/js/TinyEmitter.js';
import Vector3 from './Vector3.js';
import Ray3 from './Ray3.js';
//# sourceMappingURL=Transform4.d.ts.map