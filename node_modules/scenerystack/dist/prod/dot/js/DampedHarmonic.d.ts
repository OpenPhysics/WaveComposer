 ...
 */
import '../../globals.js';
declare class DampedHarmonic {
    private readonly dampingConstant;
    private readonly angularFrequencySquared;
    private readonly discriminant;
    private readonly solutionType;
    private readonly c1;
    private readonly c2;
    private readonly angularFrequency?;
    private readonly frequency?;
    private readonly positiveRoot?;
    private readonly negativeRoot?;
    /**
     ...
     */
    constructor(a: number, b: number, c: number, initialValue: number, initialDerivative: number);
    /**
...
//# sourceMappingURL=DampedHarmonic.d.ts.map