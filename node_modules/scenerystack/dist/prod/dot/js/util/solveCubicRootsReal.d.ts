 ...
 */
import '../../../globals.js';
export declare function solveCubicRootsReal(a: number, b: number, c: number, d: number, discriminantThreshold?: number): number[] | null;
//# sourceMappingURL=solveCubicRootsReal.d.ts.map