...
declare class Permutation {
     ...
     */
    apply<E, T extends E[] | number>(arrayOrInt: T): T extends E[] ? number[] : number;
    /**
     ...
     */
    static identity(size: number): Permutation;
    /**
     * Lists all permutations that have a given size
     */
    static permutations(size: number): Permutation[];
    /**
     ...
     */
    static forEachPermutation<T>(array: T[], callback: (array: readonly T[]) => void): void;
    static permutationsOf<T>(array: T[]): T[][];
}
