...
export default class RadioButtonGroupFocusListener<T> extends GroupFocusListener {
     ...
     */
    constructor(radioButtonGroup: AquaRadioButtonGroup<T> | RectangularRadioButtonGroup<T>, groupHintResponse: SpeakableResolvedResponse, speakVoicingNameResponseOnFocus: boolean, groupNameResponse?: SpeakableResolvedResponse);
}
//# sourceMappingURL=RadioButtonGroupFocusListener.d.ts.map