...
const HELP_TEXT_BEHAVIOR = (node, options, accessibleHelpText, otherNodeCallbacks) => {
    otherNodeCallbacks.push(() => {
        node.button.accessibleHelpText = accessibleHelpText;
    });
    return options;
};
class ComboBox extends WidthSizable(Node) {
    /**
    ...
    constructor(property, items, listParent, providedOptions) {
        ...
        this.listBox = new ComboBoxListBox(property, items, nodes, this.hideListBox.bind(this), // callback to hide the list box
        () => {
        ...
        const inputEnabledProperty = new DerivedProperty([this.enabledProperty, this.displayOnlyProperty], (enabled, displayOnly) => enabled && !displayOnly);
