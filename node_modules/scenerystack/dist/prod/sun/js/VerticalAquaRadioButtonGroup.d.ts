...
export default class VerticalAquaRadioButtonGroup<T> extends AquaRadioButtonGroup<T> {
    constructor(property: PhetioProperty<T>, items: AquaRadioButtonGroupItem<T>[], options?: VerticalAquaRadioButtonGroupOptions);
}
export {};
//# sourceMappingURL=VerticalAquaRadioButtonGroup.d.ts.map