...
declare const ARROW_DIRECTION_VALUES: readonly ["up", "down"];
...
export default class ComboBoxButton<T> extends RectangularPushButton {
    private _blockNextVoicingFocusListener;
    private readonly disposeComboBoxButton;
    private arrow;
    private separatorLine;
    constructor(property: TProperty<T>, items: ComboBoxItemNoNode<T>[], nodes: Node[], providedOptions?: ComboBoxButtonOptions);
    private setAriaHasPopUp;
    /**
     ...
     * For use by ComboBox.
     */
    blockNextVoicingFocusListener(): void;
    dispose(): void;
}
export {};
//# sourceMappingURL=ComboBoxButton.d.ts.map