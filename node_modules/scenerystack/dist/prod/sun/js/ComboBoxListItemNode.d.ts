...
declare const ComboBoxListItemNode_base: typeof Node & import("../../phet-core.js").Constructor<import("../../scenery/js/accessibility/voicing/Voicing.js").TVoicing<Node>>;
export default class ComboBoxListItemNode<T> extends ComboBoxListItemNode_base {
    private _supplyOpenResponseOnNextFocus;
    readonly item: ComboBoxItemNoNode<T>;
    private readonly disposeComboBoxListItemNode;
    constructor(item: ComboBoxItemNoNode<T>, node: Node, highlightWidthProperty: TReadOnlyProperty<number>, highlightHeightProperty: TReadOnlyProperty<number>, providedOptions?: ComboBoxListItemNodeOptions);
    /**
     * Ask for the voicing response for opening the ComboBox upon next focus, but only for the very next focus event.
     */
    supplyOpenResponseOnNextFocus(): void;
    /**
...
export {};
//# sourceMappingURL=ComboBoxListItemNode.d.ts.map