...
export type AquaRadioButtonGroupItem<T> = {
    value: T;
    options?: StrictOmit<AquaRadioButtonOptions, 'tandem'>;
} & GroupItemOptions;
export default class AquaRadioButtonGroup<T> extends FlowBox {
    private readonly radioButtons;
    readonly onInputEmitter: TEmitter;
    private readonly disposeAquaRadioButtonGroup;
    constructor(property: PhetioProperty<T>, items: AquaRadioButtonGroupItem<T>[], providedOptions?: AquaRadioButtonGroupOptions);
    private onRadioButtonInput;
    dispose(): void;
    /**
...
export {};
//# sourceMappingURL=AquaRadioButtonGroup.d.ts.map