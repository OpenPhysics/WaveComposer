...
export default class ClosestDragForwardingListener {
    private readonly touchThreshold;
    private readonly mouseThreshold;
    private readonly items;
    constructor(touchThreshold: number, mouseThreshold: number);
    /**
     * Adds an item that can be dragged.
     */
    addDraggableItem(item: DraggableItem): void;
    /**
     * Removes a previously-added item.
     */
    removeDraggableItem(item: DraggableItem): void;
    /**
...
export {};
//# sourceMappingURL=ClosestDragForwardingListener.d.ts.map