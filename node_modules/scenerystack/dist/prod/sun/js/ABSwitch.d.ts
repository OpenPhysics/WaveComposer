...
import { type ToggleSwitchOptions } from './ToggleSwitch.js';
type SelfOptions = {
...
export default class ABSwitch<T> extends HBox {
    ...
    private readonly valueA;
    private readonly valueB;
    private readonly labelA;
    private readonly labelB;
    private readonly toggleSwitch;
    private readonly setLabelEnabled;
    private readonly disposeABSwitch;
     ...
     */
    private updateLabelsEnabled;
}
export {};
//# sourceMappingURL=ABSwitch.d.ts.map