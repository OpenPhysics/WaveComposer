...
export default class BooleanToggleNode extends ToggleNode<boolean> {
    constructor(booleanProperty: TReadOnlyProperty<boolean>, trueNode: Node, falseNode: Node, providedOptions?: BooleanToggleNodeOptions);
}
export {};
//# sourceMappingURL=BooleanToggleNode.d.ts.map