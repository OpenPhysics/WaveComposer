...
import { type PopupableOptions } from './Popupable.js';
...
declare const Dialog_base: typeof Panel & import("../../phet-core.js").Constructor<{
...
export default class Dialog extends Dialog_base {
    ...
    private readonly disposeDialog;
    /**
    ...
    dispose(): void;
    static DialogIO: IOType<any, any, any>;
}
export {};
