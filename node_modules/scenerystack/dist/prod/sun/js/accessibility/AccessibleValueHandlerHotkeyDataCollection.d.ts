...
declare const AccessibleValueHandlerHotkeyDataCollection: {
    HOME_HOTKEY_DATA: HotkeyData;
    END_HOTKEY_DATA: HotkeyData;
    PAGE_UP_HOTKEY_DATA: HotkeyData;
    PAGE_DOWN_HOTKEY_DATA: HotkeyData;
    UP_ARROW_HOTKEY_DATA: HotkeyData;
    DOWN_ARROW_HOTKEY_DATA: HotkeyData;
    RIGHT_ARROW_HOTKEY_DATA: HotkeyData;
    LEFT_ARROW_HOTKEY_DATA: HotkeyData;
    SHIFT_HOTKEY_DATA: HotkeyData;
    /**
...
//# sourceMappingURL=AccessibleValueHandlerHotkeyDataCollection.d.ts.map