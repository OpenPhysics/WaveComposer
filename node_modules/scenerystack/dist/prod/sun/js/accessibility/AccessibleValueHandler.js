...
const AccessibleValueHandler = (Type, optionsArgPosition) => {
    const AccessibleValueHandlerClass = DelayedMutate('AccessibleValueHandler', ACCESSIBLE_VALUE_HANDLER_OPTIONS, class AccessibleValueHandler extends Voicing(Type) {
        constructor(...args) {
            ...
            this._oldValue = null;
            this._pdomCreateContextResponseAlert = null;
            ...
            this._rangeKeysDown = {};
            this._pdomMapPDOMValue = _.identity;
            this._pdomCreateAriaValueText = toString; // by default make sure it returns a string
            this._dependenciesMultilink = null;
            this._pdomRepeatEqualValueText = true;
            ...
            this._voicingOnEndResponseOptions = DEFAULT_VOICING_ON_END_RESPONSE_OPTIONS;
                    ...
                    if (!domEvent.metaKey) {
                        ...
                        if (HotkeyData.anyHaveKeyStroke([AccessibleValueHandlerHotkeyDataCollection.HOME_HOTKEY_DATA, AccessibleValueHandlerHotkeyDataCollection.END_HOTKEY_DATA], englishKeyString)) {
                            ...
                            if (HotkeyData.anyHaveKeyStroke([AccessibleValueHandlerHotkeyDataCollection.PAGE_DOWN_HOTKEY_DATA, AccessibleValueHandlerHotkeyDataCollection.PAGE_UP_HOTKEY_DATA], englishKeyString)) {
                                ...
                                AccessibleValueHandlerHotkeyDataCollection.UP_ARROW_HOTKEY_DATA, AccessibleValueHandlerHotkeyDataCollection.DOWN_ARROW_HOTKEY_DATA
                            ], englishKeyString)) {
...
//# sourceMappingURL=AccessibleValueHandler.js.map