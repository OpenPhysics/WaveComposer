...
export default class RoundMomentaryButton<T> extends RoundButton {
    private readonly disposeRoundMomentaryButton;
    /**
     * @param property
     ...
     */
    constructor(property: TProperty<T>, valueOff: T, valueOn: T, providedOptions?: RoundMomentaryButtonOptions);
    dispose(): void;
}
export {};
//# sourceMappingURL=RoundMomentaryButton.d.ts.map