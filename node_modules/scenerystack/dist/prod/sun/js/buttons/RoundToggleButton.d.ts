...
export default class RoundToggleButton<T> extends RoundButton {
    private readonly disposeRoundToggleButton;
    /**
     ...
     */
    constructor(property: Property<T>, valueOff: T, valueOn: T, providedOptions?: RoundToggleButtonOptions);
    dispose(): void;
}
export {};
//# sourceMappingURL=RoundToggleButton.d.ts.map