...
import { type ParallelDOMOptions, type TrimParallelDOMOptions } from '../../../scenery/js/accessibility/pdom/ParallelDOM.js';
...
type SelfOptions = {
    ...
    radioButtonOptions?: StrictOmit<RectangularRadioButtonOptions, 'soundPlayer' | // use SelfOptions.soundPlayers
...
export default class RectangularRadioButtonGroup<T> extends FlowBox {
    private readonly disposeRadioButtonGroup;
    private readonly radioButtonMap;
    constructor(property: PhetioProperty<T>, items: RectangularRadioButtonGroupItem<T>[], providedOptions?: RectangularRadioButtonGroupOptions);
    /**
...
export {};
//# sourceMappingURL=RectangularRadioButtonGroup.d.ts.map