...
type TContentAppearanceStrategy = {
    new (content: Node, interactionStateProperty: TReadOnlyProperty<RadioButtonInteractionState>, options?: TContentAppearanceStrategyOptions): {
        dispose?: () => void;
    };
};
export default TContentAppearanceStrategy;
//# sourceMappingURL=TContentAppearanceStrategy.d.ts.map