...
export default class ButtonModel extends EnabledComponent {
    ...
    readonly isOverOrFocusedProperty: Property<boolean>;
    readonly pdomClickingProperty: Property<boolean>;
    readonly fireCompleteEmitter: TEmitter;
    interrupted: boolean;
    private listeners;
    private looksPressedMultilink;
    private overOrFocusedMultilink;
    private readonly disposeButtonModel;
...
export {};
//# sourceMappingURL=ButtonModel.d.ts.map