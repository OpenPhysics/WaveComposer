...
export default class RoundButton extends ButtonNode {
    static ThreeDAppearanceStrategy: TButtonAppearanceStrategy;
    private readonly buttonNodeConstraint;
    protected constructor(buttonModel: ButtonModel, interactionStateProperty: TReadOnlyProperty<ButtonInteractionState>, providedOptions?: RoundButtonOptions);
}
/**
 ...
 */
export declare class ThreeDAppearanceStrategy {
    readonly maxLineWidth: number;
    private readonly disposeThreeDAppearanceStrategy;
    /**
     ...
     */
    constructor(buttonBackground: Path, interactionStateProperty: TReadOnlyProperty<ButtonInteractionState | RadioButtonInteractionState>, baseColorProperty: TReadOnlyProperty<Color>, providedOptions?: TButtonAppearanceStrategyOptions);
    dispose(): void;
}
export {};
