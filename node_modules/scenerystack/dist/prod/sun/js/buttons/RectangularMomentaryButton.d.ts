...
export default class RectangularMomentaryButton<T> extends RectangularButton {
    private readonly disposeRectangularMomentaryButton;
    /**
     * @param property
     ...
     */
    constructor(property: TProperty<T>, valueOff: T, valueOn: T, providedOptions?: RectangularMomentaryButtonOptions);
    dispose(): void;
}
export {};
//# sourceMappingURL=RectangularMomentaryButton.d.ts.map