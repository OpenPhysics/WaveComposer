...
export default class StickyToggleButtonModel<T> extends ButtonModel {
    readonly valueProperty: TProperty<T>;
    readonly valueUp: T;
    readonly valueDown: T;
    private readonly toggledEmitter;
    private readonly pressedWhileDownProperty;
    private readonly disposeToggleButtonModel;
    /**
     ...
     */
    constructor(valueUp: T, valueDown: T, valueProperty: TProperty<T>, providedOptions?: StickyToggleButtonModelOptions);
    dispose(): void;
    private toggle;
}
export {};
//# sourceMappingURL=StickyToggleButtonModel.d.ts.map