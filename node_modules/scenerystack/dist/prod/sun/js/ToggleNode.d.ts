...
export default class ToggleNode<T, N extends Node = Node> extends Node {
    private readonly disposeToggleNode;
    readonly nodes: N[];
    constructor(valueProperty: TReadOnlyProperty<T>, elements: ToggleNodeElement<T, N>[], providedOptions?: ToggleNodeOptions);
    dispose(): void;
    /**
     * A value for the alignChildren option.
     * Centers the latter nodes on the x,y center of the first node.
     */
    static CENTER(children: Layoutable[]): void;
    /**
     * A value for the alignChildren option.
     * Centers the latter nodes on the x center of the first node.
     */
    static CENTER_X(children: Layoutable[]): void;
    /**
     * A value for the alignChildren option.
     * Centers the latter nodes on the y center of the first node.
     */
    static CENTER_Y(children: Layoutable[]): void;
    /**
     * A value for the alignChildren option.
     * Left aligns nodes on the left of the first node.
     */
    static LEFT(children: Layoutable[]): void;
    /**
     * A value for the alignChildren option.
     * Aligns nodes on the bottom of the first node.
     */
    static BOTTOM(children: Layoutable[]): void;
    /**
     * A value for the alignChildren option.
     * Aligns nodes on the bottom of the first node.
     */
    static CENTER_BOTTOM(children: Layoutable[]): void;
    /**
     * A value for the alignChildren option.
     * Right aligns nodes on the right of the first node.
     */
    static RIGHT(children: Layoutable[]): void;
    /**
     * A value for the alignChildren option.
     * No alignment is performed.
     */
    static NONE(children: Layoutable[]): void;
}
export {};
