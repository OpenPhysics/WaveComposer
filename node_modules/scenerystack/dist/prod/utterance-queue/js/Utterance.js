...
class Utterance extends Disposable {
    ...
    get alert() { return this.getAlert(); }
    set alert(alert) { this.setAlert(alert); }
    setAlert(alert) {
        this._alert = alert;
    }
    /**
...
class AnnouncingControlProperty extends DynamicProperty {
    ...
    set dependentProperties(dependentProperties) { this.setDependentProperties(dependentProperties); }
