...
if (self.phet && phet.chipper && phet.chipper.queryParameters && phet.chipper.queryParameters.speechSynthesisFromParent) {
...
class SpeechSynthesisAnnouncer extends Announcer {
    ...
    initialize(userGestureEmitter, providedOptions) {
        ...
        this.synth = self.speechSynthesis;
    ...
    getPrioritizedVoices() {
        ...
        const getIndex = (voice) => voice.localService ? -1 : // Prefer local voices by default, helps solves bugs like, https://github.com/phetsims/number-pairs/issues/164
...
//# sourceMappingURL=SpeechSynthesisAnnouncer.js.map