...
import { SpeakableNullableResolvedOptions } from './ResponsePacket.js';
type ResponseCollectorOptions = PhetioObjectOptions & PickRequired<PhetioObjectOptions, 'tandem'>;
declare class ResponseCollector extends PhetioObject {
    ...
    constructor(options?: ResponseCollectorOptions);
    reset(): void;
    /**
     ...
     */
    collectResponses(providedOptions?: SpeakableNullableResolvedOptions): string;
}
declare const responseCollector: ResponseCollector;
export default responseCollector;
//# sourceMappingURL=responseCollector.d.ts.map