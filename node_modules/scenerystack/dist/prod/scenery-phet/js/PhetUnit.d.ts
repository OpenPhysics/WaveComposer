...
export default class PhetUnit<InputPropertyType extends TReadOnlyProperty<string>> implements Unit {
    ...
    readonly hasVisualStandaloneString: boolean;
    readonly hasVisualString: boolean;
    readonly hasAccessibleString: boolean;
    readonly visualStandaloneStringProperty?: InputPropertyType;
    readonly visualPatternStringProperty?: InputPropertyType;
    readonly accessiblePattern?: AccessibleValuePattern;
    constructor(name: string, // Basic "backwards-compatible" name, e.g. "m" or "m/s^2"
     ...
     */
    getVisualStandaloneStringProperty(): InputPropertyType;
    /**
     * Get a string Property for a visual string (value + units) based on a value Property.
     */
    getVisualStringProperty(valueProperty: TReadOnlyProperty<number>, providedOptions?: FormattedNumberPropertyOptions<string>): ReadOnlyProperty<string>;
    /**
     * Get a string Property for a accessible string (value + units) based on a value Property.
     */
    getAccessibleStringProperty(valueProperty: TReadOnlyProperty<number>, providedOptions?: FormattedNumberPropertyOptions<string>): ReadOnlyProperty<string>;
    /**
     * Get an AccessibleString Property for a visual + accessible string (value + units) based on a value Property.
     */
    getDualStringProperty(valueProperty: TReadOnlyProperty<number>, providedOptions?: FormattedNumberPropertyOptions<string>): ReadOnlyProperty<DualString>;
    /**
     * Get a list of the dependent properties that this unit relies on.
     */
    getDependentProperties(): TReadOnlyProperty<unknown>[];
}
export declare const getFallbackAccessibleUnitsStringProperty: (valueProperty: TReadOnlyProperty<number>, providedOptions?: FormattedNumberPropertyOptions<string>) => ReadOnlyProperty<string>;
//# sourceMappingURL=PhetUnit.d.ts.map