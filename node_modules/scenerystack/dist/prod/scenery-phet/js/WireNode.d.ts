...
export default class WireNode extends Path {
     ...
     * @param [options]
     */
    constructor(position1Property: TReadOnlyProperty<Vector2>, normal1Property: TReadOnlyProperty<Vector2>, position2Property: TReadOnlyProperty<Vector2>, normal2Property: TReadOnlyProperty<Vector2>, options?: WireNodeOptions);
    dispose(): void;
}
export {};
//# sourceMappingURL=WireNode.d.ts.map