...
import { KeypadLayout, KeypadOptions } from '../../../scenery-phet/js/keypad/Keypad.js';
...
declare class KeypadDialog extends Dialog {
    private editValue;
    private valueRange;
    private editFinishedCallback;
    private readonly keypad;
    private readonly rangeText;
    private rangeStringProperty;
    private readonly valueText;
    private readonly defaultTextColor;
    private readonly errorTextColor;
    private readonly disposeKeypadDialog;
    constructor(providedOptions?: KeypadDialogOptions);
    /**
     ...
     */
    beginEdit(editValue: (value: number) => void, valueRange: Range, patternStringProperty: TReadOnlyProperty<string>, editFinishedCallback: () => void): void;
    /**
...
//# sourceMappingURL=KeypadDialog.d.ts.map