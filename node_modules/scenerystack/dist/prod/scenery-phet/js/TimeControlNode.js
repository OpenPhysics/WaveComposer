...
export default class TimeControlNode extends Node {
    constructor(isPlayingProperty, providedOptions) {
        ...
        super();
        this.pushButtonGroup = new PlayPauseStepButtonGroup(isPlayingProperty, combineOptions({
