...
export declare class ArrowKeyIconDisplay extends EnumerationValue {
    static readonly UP_DOWN: ArrowKeyIconDisplay;
    static readonly LEFT_RIGHT: ArrowKeyIconDisplay;
    static readonly BOTH: ArrowKeyIconDisplay;
    static readonly enumeration: Enumeration<ArrowKeyIconDisplay>;
}
type SelfOptions = {
...
export default class SliderControlsKeyboardHelpSection extends KeyboardHelpSection {
    static readonly ArrowKeyIconDisplay: typeof ArrowKeyIconDisplay;
    constructor(providedOptions?: SliderControlsKeyboardHelpSectionOptions);
}
export {};
//# sourceMappingURL=SliderControlsKeyboardHelpSection.d.ts.map