...
class KeyboardHelpIconFactory {
    ...
    static iconOrIcon(leftIcon, rightIcon, providedOptions) {
        ...
        const orText = new Text(string_scenery_phet_keyboardHelpDialog_or_StringProperty, {
            font: LABEL_FONT,
    ...
    static iconToIcon(leftIcon, rightIcon, providedOptions) {
        ...
        const hyphenText = new Text(string_scenery_phet_keyboardHelpDialog_hyphen_StringProperty, {
            font: LABEL_FONT,
            maxWidth: OR_TEXT_MAX_WIDTH
        });
    ...
    static upDownOrWSKeysRowIcon(providedOptions) {
        return KeyboardHelpIconFactory.iconOrIcon(KeyboardHelpIconFactory.upDownArrowKeysRowIcon(), KeyboardHelpIconFactory.wSKeysRowIcon(), providedOptions);
    }
    /**
    ...
    static leftRightOrADKeysRowIcon(providedOptions) {
        return KeyboardHelpIconFactory.iconOrIcon(KeyboardHelpIconFactory.leftRightArrowKeysRowIcon(), KeyboardHelpIconFactory.aDKeysRowIcon(), providedOptions);
    }
    /**
    ...
    static fromHotkeyData(hotkeyData) {
        ...
        return iconRows.reduce((acc, iconRow) => acc ? KeyboardHelpIconFactory.iconOrIcon(acc, iconRow) : iconRow, null);
    }
}
 ...
 */
KeyboardHelpIconFactory.ENGLISH_KEY_TO_KEY_NODE = {
...
;
//# sourceMappingURL=KeyboardHelpIconFactory.js.map