...
import { GrabReleaseCueNodeOptions } from '../../nodes/GrabReleaseCueNode.js';
...
declare class GroupSelectView<ItemModel, ItemNode extends Node> extends Disposable {
    readonly model: GroupSelectModel<ItemModel>;
    private readonly primaryFocusedNode;
    readonly groupSortGroupFocusHighlightPath: Path;
    readonly grabReleaseCueNode: Node;
    readonly positionSortCueNodeEmitter: Emitter<[]>;
    private readonly getNodeFromModelItem;
    private readonly isGroupItemEnabled;
     ...
     */
    keyboardGrab(groupItem: ItemModel): void;
    dispose(): void;
}
export default GroupSelectView;
//# sourceMappingURL=GroupSelectView.d.ts.map