...
declare class MovementAlerter extends Alerter {
    /**
     ...
     */
    private static getDirectionEnumerable;
    /**
     ...
     * @returns {DirectionEnum}
     */
    public static getDirectionEnumerableFromAngle(angle: any): import("../../../../phet-core/js/EnumerationDeprecated.js").default;
    /**
     ...
     * @returns {string}
     */
    public static getDirectionDescriptionFromAngle(angle: number, options?: Object): string;
    /**
     ...
     * @public
     */
    public static getDefaultMovementDescriptions(): any;
    /**
     * @param {Property.<Vector2>} positionProperty - Property that drives movement, in model coordinate frame
     * @param {Object} [options]
     */
    constructor(positionProperty: Property<Vector2>, options?: Object);
    movementAlertKeys: string[];
    movementAlerts: any;
    alertDiagonal: any;
    modelViewTransform: any;
    borderAlertsDescriber: BorderAlertsDescriber;
    directionChangeUtterance: Utterance;
    initialFirstPosition: any;
    positionProperty: Property<Vector2>;
    lastAlertedPosition: any;
    /**
     ...
     */
    protected alertDirections(directions: Array<import("../../../../phet-core/js/EnumerationDeprecated.js").default> | import("../../../../phet-core/js/EnumerationDeprecated.js").default): void;
    /**
     ...
     * @public
     */
    public alertDirectionalMovement(): void;
    /**
     ...
     * @protected
     */
    protected getDirections(newPoint: Vector2, oldPoint: Vector2): Array<import("../../../../phet-core/js/EnumerationDeprecated.js").default>;
    /**
     * @public
     * @param {window.Event} [domEvent]
     */
    public endDrag(domEvent?: window.Event): void;
    /**
     * @public
     */
    public reset(): void;
...
//# sourceMappingURL=MovementAlerter.d.ts.map