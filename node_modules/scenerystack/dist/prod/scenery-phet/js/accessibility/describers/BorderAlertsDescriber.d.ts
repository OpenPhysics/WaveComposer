 ...
 * @constructor
 */
declare class BorderAlertsDescriber {
    /**
     ...
     * @returns {string}
     */
    public static getDefaultTopAlert(): string;
     ...
     * @returns{TAlertable} - null if there is nothing to alert
     */
    public getAlertOnEndDrag(position: Vector2, domEvent?: KeyboardEvent): TAlertable;
    /**
     * @public
     */
    public reset(): void;
}
//# sourceMappingURL=BorderAlertsDescriber.d.ts.map