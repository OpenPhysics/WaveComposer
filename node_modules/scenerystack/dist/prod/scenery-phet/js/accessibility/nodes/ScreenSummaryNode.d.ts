...
export default class ScreenSummaryNode extends Node {
    private readonly openingSummaryNode;
    constructor();
    /**
     ...
     */
    setIntroString(simName: string, screenDisplayName: string | null, isMultiScreen: boolean): void;
}
//# sourceMappingURL=ScreenSummaryNode.d.ts.map