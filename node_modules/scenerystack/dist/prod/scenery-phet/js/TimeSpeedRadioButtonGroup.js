...
SPEED_LABEL_MAP.set(TimeSpeed.FAST, {
    stringProperty: string_scenery_phet_speed_fast_StringProperty,
    tandemName: 'fastRadioButton'
});
SPEED_LABEL_MAP.set(TimeSpeed.NORMAL, {
    stringProperty: string_scenery_phet_speed_normal_StringProperty,
    tandemName: 'normalRadioButton'
});
SPEED_LABEL_MAP.set(TimeSpeed.SLOW, {
    stringProperty: string_scenery_phet_speed_slow_StringProperty,
...
export default class TimeSpeedRadioButtonGroup extends VerticalAquaRadioButtonGroup {
    constructor(timeSpeedProperty, timeSpeeds, providedOptions) {
        const options = optionize()({
            ...
            // pdom
            accessibleName: string_scenery_phet_a11y_timeControlNode_simSpeeds_StringProperty,
            accessibleHelpText: string_scenery_phet_a11y_timeControlNode_simSpeedDescription_StringProperty
        }, providedOptions);
...
//# sourceMappingURL=TimeSpeedRadioButtonGroup.js.map