...
export default class WavelengthNumberControl extends NumberControl {
    ...
    constructor(wavelengthProperty, providedOptions) {
        const options = optionize()({
            title: string_scenery_phet_wavelength_StringProperty,
            range: DEFAULT_RANGE,
        ...
        super(options.title, wavelengthProperty, options.range, combineOptions({
            ...
            numberDisplayOptions: {
                ...
                valuePattern: string_scenery_phet_wavelengthNMValuePattern_StringProperty,
                maxWidth: 120
            },
            sliderOptions: {
                trackNode: trackNode,
...
//# sourceMappingURL=WavelengthNumberControl.js.map