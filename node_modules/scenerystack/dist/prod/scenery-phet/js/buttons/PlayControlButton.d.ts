...
export default class PlayControlButton extends BooleanRoundToggleButton {
    private readonly disposePlayStopButton;
    /**
     * @param isPlayingProperty
     * @param endPlayingIcon - icon for the button when pressing it will stop play
     * @param providedOptions
     */
    constructor(isPlayingProperty: Property<boolean>, endPlayingIcon: Node, providedOptions?: PlayControlButtonOptions);
    dispose(): void;
    static readonly TOGGLE_PLAY_HOTKEY_DATA: HotkeyData;
}
export {};
//# sourceMappingURL=PlayControlButton.d.ts.map