...
export default class GradientBackgroundNode extends Rectangle {
    constructor(x: number, y: number, width: number, height: number, color1: TColor, color2: TColor, y1: number, y2: number);
}
//# sourceMappingURL=GradientBackgroundNode.d.ts.map