...
export const GET_COLUMN_BODY_GRADIENT = (columnNode) => new LinearGradient(columnNode.bounds.minX, 0, columnNode.bounds.maxX, 0)
...
export const GET_COLUMN_SUPPORT_GRADIENT = (columnNode, supportWidth) => new LinearGradient(columnNode.bounds.centerX - supportWidth / 2, 0, columnNode.bounds.centerX + supportWidth / 2, 0)
    .addColorStop(0, '#BFBEBF')
    .addColorStop(0.15, '#BFBEBF')
    .addColorStop(0.16, '#CECECE')
...
//# sourceMappingURL=LevelSupportColumnNode.js.map