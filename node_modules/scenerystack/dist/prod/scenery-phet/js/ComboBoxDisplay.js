...
export default class ComboBoxDisplay extends ComboBox {
    ...
    constructor(choiceProperty, items, listParent, providedOptions) {
        ...
        items.forEach(item => {
            ...
            const valuePatternStringProperty = new PatternStringProperty(string_scenery_phet_comboBoxDisplay_valueUnits_StringProperty, {
                units: unitsProperty
...
//# sourceMappingURL=ComboBoxDisplay.js.map