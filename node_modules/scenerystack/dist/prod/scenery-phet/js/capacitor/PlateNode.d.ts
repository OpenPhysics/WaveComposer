...
declare class PlateNode extends BoxNode {
    /**
     ...
     */
    constructor(capacitor: Capacitor, modelViewTransform: YawPitchModelViewTransform3, polarity: string, maxPlateCharge: number, orientation: string, includeChargeNode?: boolean);
    modelViewTransform: YawPitchModelViewTransform3;
    plateChargeNode: PlateChargeNode;
    /**
