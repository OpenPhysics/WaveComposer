...
const BidirectionalControlChars = {
    ...
    LRI: '\u2066', // Left-to-Right Isolate, used to isolate a left-to-right section in a bidirectional string
    RLI: '\u2067', // Right-to-Left Isolate, used to isolate a right-to-left section in a bidirectional string
    PDI: '\u2069', // Pop Directional Isolate, used to end an isolated section in a bidirectional string
    ...
    LRE: '\u202A', // Left-to-Right Embedding, used to start a left-to-right section in a bidirectional string
    RLE: '\u202B', // Right-to-Left Embedding, used to start a right-to-left section in a bidirectional string
    PDF: '\u202C' // Pop Directional Formatting, used to end a bidirectional section
};
export default BidirectionalControlChars;
//# sourceMappingURL=BidirectionalControlChars.js.map