...
class HeaterCoolerFront extends Node {
    ...
    constructor(heatCoolAmountProperty, providedOptions) {
        ...
        const options = optionize()({
            ...
            heatString: string_scenery_phet_heat_StringProperty,
            coolString: string_scenery_phet_cool_StringProperty,
        ...
        const stoveBodyShape = new Shape()
            ...
            .ellipticalArc(DEFAULT_WIDTH / 2, height + burnerOpeningHeight / 4, bottomWidth / 2, burnerOpeningHeight, 0, Math.PI, 0, true).lineTo(DEFAULT_WIDTH, burnerOpeningHeight / 2);
        ...
        const sliderIsCloseToZero = () => {
            return options.coolEnabled && options.heatEnabled && (heatCoolAmountProperty.value < 0 && heatCoolAmountProperty.value / sliderRange.min < options.snapToZeroThreshold ||
...
HeaterCoolerFront.SET_TO_ZERO_HOTKEY_DATA = new HotkeyData({
    ...
    keyboardHelpDialogLabelStringProperty: string_scenery_phet_keyboardHelpDialog_heatCoolOff_StringProperty,
    binderName: 'Turn off heater/cooler'
});
export default HeaterCoolerFront;
//# sourceMappingURL=HeaterCoolerFront.js.map