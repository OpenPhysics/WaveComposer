...
export class RasterChunkReduceData {
    constructor(clippedChunkIndex, area, isFirstEdge, isLastEdge, 
    ...
    minXCount, minYCount, maxXCount, maxYCount) {
        this.clippedChunkIndex = clippedChunkIndex;
        this.area = area;
    ...
    writeEncoding(encoder) {
        ;
        encoder.pushU32((this.clippedChunkIndex & 0x2fffffff) |
    ...
    static readEncoding(arrayBuffer, byteOffset) {
        ...
        return new RasterChunkReduceData(clippedChunkIndex, floatBuffer[1], isFirstEdge, isLastEdge, floatBuffer[2], floatBuffer[3], floatBuffer[4], floatBuffer[5], intBuffer[6], intBuffer[7], intBuffer[8], intBuffer[9]);
    }
    ...
    apply(clippedChunk) {
        ...
        return new RasterClippedChunk(clippedChunk.renderProgramIndex, clippedChunk.needsFace, clippedChunk.isConstant, !isComplete, isComplete && !isDiscarded, isFullArea, area, minX, minY, maxX, maxY, minXCount, minYCount, maxXCount, maxYCount);
    }
    static combine(a, b) {
        if (a.clippedChunkIndex !== b.clippedChunkIndex) {
            ...
            return new RasterChunkReduceData(a.clippedChunkIndex, a.area + b.area, a.isFirstEdge, b.isLastEdge, Math.min(a.minX, b.minX), Math.min(a.minY, b.minY), Math.max(a.maxX, b.maxX), Math.max(a.maxY, b.maxY), a.minXCount + b.minXCount, a.minYCount + b.minYCount, a.maxXCount + b.maxXCount, a.maxYCount + b.maxYCount);
        }
    }
}
RasterChunkReduceData.ENCODING_BYTE_LENGTH = 4 * 10;
RasterChunkReduceData.INDETERMINATE = new RasterChunkReduceData(NaN, NaN, false, false, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN);
RasterChunkReduceData.OUT_OF_RANGE = new RasterChunkReduceData(-1, NaN, false, false, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN);
//# sourceMappingURL=RasterChunkReduceData.js.map