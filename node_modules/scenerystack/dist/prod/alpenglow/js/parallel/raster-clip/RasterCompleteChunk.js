...
export class RasterCompleteChunk {
    constructor(renderProgramIndex, edgesOffset, numEdges, isFullArea, area, 
    ...
    withEdgeInfo(startIndex, endIndex) {
        return new RasterCompleteChunk(this.renderProgramIndex, this.isFullArea ? 0 : startIndex, this.isFullArea ? 0 : endIndex - startIndex, this.isFullArea, this.area, this.minX, this.minY, this.maxX, this.maxY, this.isFullArea ? -1 : this.minXCount, this.isFullArea ? 1 : this.minYCount, this.isFullArea ? 1 : this.maxXCount, this.isFullArea ? -1 : this.maxYCount);
    }
    toString() {
    ...
    writeEncoding(encoder) {
        ;
        encoder.pushU32((this.renderProgramIndex & 0x00ffffff) |
    ...
    static readEncoding(arrayBuffer, byteOffset) {
        ...
        return new RasterCompleteChunk(renderProgramIndex, uintBuffer[1], uintBuffer[2], isFullArea, floatBuffer[3], floatBuffer[4], floatBuffer[5], floatBuffer[6], floatBuffer[7], intBuffer[8], intBuffer[9], intBuffer[10], intBuffer[11]);
    }
...
RasterCompleteChunk.ENCODING_BYTE_LENGTH = 4 * 12;
RasterCompleteChunk.INDETERMINATE = new RasterCompleteChunk(NaN, NaN, NaN, false, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN);
//# sourceMappingURL=RasterCompleteChunk.js.map