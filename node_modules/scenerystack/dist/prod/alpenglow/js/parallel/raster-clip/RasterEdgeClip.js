...
export class RasterEdgeClip {
    constructor(clippedChunkIndex, point0, point1, point2, point3, isFirstEdge, isLastEdge) {
    ...
    getArea() {
        return 0.5 * ((this.point1.x + this.point0.x) * (this.point1.y - this.point0.y) +
    ...
    static readEncoding(arrayBuffer, byteOffset) {
        ...
        return new RasterEdgeClip(clippedChunkIndex, new Vector2(floatBuffer[1], floatBuffer[2]), new Vector2(floatBuffer[3], floatBuffer[4]), new Vector2(floatBuffer[5], floatBuffer[6]), new Vector2(floatBuffer[7], floatBuffer[8]), isFirstEdge, isLastEdge);
    }
...
RasterEdgeClip.ENCODING_BYTE_LENGTH = 4 * 9;
RasterEdgeClip.INDETERMINATE = new RasterEdgeClip(NaN, new Vector2(NaN, NaN), new Vector2(NaN, NaN), new Vector2(NaN, NaN), new Vector2(NaN, NaN), false, false);
//# sourceMappingURL=RasterEdgeClip.js.map