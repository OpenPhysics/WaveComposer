...
export class RasterClippedChunk {
    ...
    isReducible, isComplete, isFullArea, area, 
    ...
    getSplitReduceData() {
        return new RasterSplitReduceData(this.isReducible ? 1 : 0, this.isComplete ? (this.needsCompleteOutputSplit() ? this.outputSplitCount() : 1) : 0);
    }
    isExportingCompleteEdges() {
    ...
    static readEncoding(arrayBuffer, byteOffset) {
        ...
        return new RasterClippedChunk(renderProgramIndex, needsFace, isConstant, isReducible, isComplete, isFullArea, floatBuffer[1], floatBuffer[2], floatBuffer[3], floatBuffer[4], floatBuffer[5], intBuffer[6], intBuffer[7], intBuffer[8], intBuffer[9]);
    }
...
RasterClippedChunk.ENCODING_BYTE_LENGTH = 4 * 10;
RasterClippedChunk.INDETERMINATE = new RasterClippedChunk(NaN, false, false, false, false, false, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN);
RasterClippedChunk.DISCARDABLE = new RasterClippedChunk(0, false, false, false, false, false, 0, 0, 0, 0, 0, 0, 0, 0, 0);
//# sourceMappingURL=RasterClippedChunk.js.map