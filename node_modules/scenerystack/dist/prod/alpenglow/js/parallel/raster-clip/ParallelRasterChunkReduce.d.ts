...
export declare class ParallelRasterChunkReduce {
    static dispatch(workgroupSize: number, inputChunkReduces: ParallelStorageArray<RasterChunkReduceQuad>, numReduces: number, clippedChunks: ParallelStorageArray<RasterClippedChunk>, outputChunkReduces: ParallelStorageArray<RasterChunkReduceQuad>): Promise<void>;
}
//# sourceMappingURL=ParallelRasterChunkReduce.d.ts.map