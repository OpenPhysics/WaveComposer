...
export class ParallelRasterChunkIndexPatch {
    ...
    // read
    chunkIndexMap, chunkIndices, clippedChunks, numClippedChunks, 
    // read-write
        ...
        const kernel = new ParallelKernel(async (context) => {
            ...
            if (exists) {
                ...
                if (clippedChunk.isComplete) {
                    ...
                    await completeChunks.set(context, outputChunkIndex, chunk.withEdgeInfo(clippedChunk.needsFace ? startIndex : 0, clippedChunk.needsFace ? endIndex : 0));
                }
            }
        }, () => ({
...
//# sourceMappingURL=ParallelRasterChunkIndexPatch.js.map