...
export class ParallelRasterSplitScan {
    ...
    // read
    clippedChunks, splitReduces0, splitReduces1, splitReduces2, numClippedChunks, 
    // write
    reducibleChunks, completeChunks, chunkIndexMap, debugReduces) {
        ...
        const kernel = new ParallelKernel(async (context) => {
            ...
            if (exists) {
                ...
                if (clippedChunk.isReducible) {
                    ...
                    await reducibleChunks.set(context, baseIndex, new RasterChunk(clippedChunk.renderProgramIndex, clippedChunk.needsFace, clippedChunk.isConstant, -1, // filled in later
                    -1, // filled in later
                    clippedChunk.minX, clippedChunk.minY, clippedChunk.maxX, clippedChunk.maxY, clippedChunk.minXCount, clippedChunk.minYCount, clippedChunk.maxXCount, clippedChunk.maxYCount));
                }
                if (clippedChunk.isComplete) {
                    ...
                    if (clippedChunk.needsCompleteOutputSplit()) {
                        ...
                        for (let i = 0; i < count; i++) {
                            ...
                            await completeChunks.set(context, baseIndex + i, new RasterCompleteChunk(clippedChunk.renderProgramIndex, 0, 0, clippedChunk.isFullArea, 1, x, y, x + 1, y + 1, -1, 1, 1, -1));
                        }
                    }
                    else {
                        await completeChunks.set(context, baseIndex, new RasterCompleteChunk(clippedChunk.renderProgramIndex, -1, // filled in later
                        -1, // filled in later
                        clippedChunk.isFullArea, clippedChunk.area, clippedChunk.minX, clippedChunk.minY, clippedChunk.maxX, clippedChunk.maxY, clippedChunk.minXCount, clippedChunk.minYCount, clippedChunk.maxXCount, clippedChunk.maxYCount));
                    }
                }
            }
        }, () => ({
...
//# sourceMappingURL=ParallelRasterSplitScan.js.map