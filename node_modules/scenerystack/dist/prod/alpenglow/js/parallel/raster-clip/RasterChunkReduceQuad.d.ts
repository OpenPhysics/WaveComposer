...
export declare class RasterChunkReduceQuad {
    leftMin: RasterChunkReduceData;
    leftMax: RasterChunkReduceData;
    rightMin: RasterChunkReduceData;
    rightMax: RasterChunkReduceData;
    constructor(leftMin: RasterChunkReduceData, leftMax: RasterChunkReduceData, rightMin: RasterChunkReduceData, rightMax: RasterChunkReduceData);
    static combine(a: RasterChunkReduceQuad, b: RasterChunkReduceQuad): RasterChunkReduceQuad;
    toStrings(): string[];
    static readonly ENCODING_BYTE_LENGTH: number;
    writeEncoding(encoder: ByteEncoder): void;
    static readEncoding(arrayBuffer: ArrayBuffer, byteOffset: number): RasterChunkReduceQuad;
    static fromArrayBuffer(arrayBuffer: ArrayBuffer): RasterChunkReduceQuad[];
    static readonly INDETERMINATE: RasterChunkReduceQuad;
    static readonly OUT_OF_RANGE: RasterChunkReduceQuad;
}
//# sourceMappingURL=RasterChunkReduceQuad.d.ts.map