...
export class ParallelRasterInitialChunk {
        ...
        const kernel = new ParallelKernel(async (context) => {
            ...
            if (chunkIndex < numChunks) {
                ...
                if (hasEdges) {
                    ...
                    minChunk = new RasterClippedChunk(chunk.renderProgramIndex, chunk.needsFace, chunk.isConstant, 
                    ...
                    chunk.minX, chunk.minY, isXSplit ? split : chunk.maxX, isXSplit ? chunk.maxY : split, chunk.minXCount, chunk.minYCount, chunk.maxXCount, chunk.maxYCount);
                    maxChunk = new RasterClippedChunk(chunk.renderProgramIndex, chunk.needsFace, chunk.isConstant, 
                    // Filled in and modified later (past this point)
                    false, false, false, -1, 
                    // Main bounds of the chunk. NOTE: if enabled, the content will get bounds-checked and possibly these
                    // bounds will be reduced.
                    isXSplit ? split : chunk.minX, isXSplit ? chunk.minY : split, chunk.maxX, chunk.maxY, chunk.minXCount, chunk.minYCount, chunk.maxXCount, chunk.maxYCount);
                }
                ...
                // output things satisfying these constraints.
                    ...
                    if (hasArea) {
                        ...
                        minChunk = new RasterClippedChunk(chunk.renderProgramIndex, chunk.needsFace, chunk.isConstant, false, true, true, xDiff * yDiff, chunk.minX, chunk.minY, chunk.maxX, chunk.maxY, -1, 1, 1, -1);
                    }
                    else {
    ...
    static validate(workgroupSize, chunks, numChunks, clippedChunks) {
        false;
    }
}
//# sourceMappingURL=ParallelRasterInitialChunk.js.map