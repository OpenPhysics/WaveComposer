...
export declare class ParallelStorageArray<T> {
    readonly data: T[];
    readonly indeterminateValue: T;
    private readonly writeLocalIDs;
    constructor(data: T[], indeterminateValue: T);
    get<WorkgroupValues extends BaseWorkgroupValues>(context: ParallelContext<WorkgroupValues>, index: number): Promise<T>;
    set<WorkgroupValues extends BaseWorkgroupValues>(context: ParallelContext<WorkgroupValues>, index: number, value: T): Promise<void>;
    synchronize(workgroupId: Vector3): void;
    synchronizeFull(): void;
}
//# sourceMappingURL=ParallelStorageArray.d.ts.map