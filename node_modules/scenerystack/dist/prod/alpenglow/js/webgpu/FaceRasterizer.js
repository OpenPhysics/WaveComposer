...
export class FaceRasterizer {
    constructor(providedOptions) {
        this.outputSlot = new TextureViewSlot();
        const options = optionize3()({}, FACE_RASTERIZER_DEFAULT_OPTIONS, providedOptions);
    ...
    async initialize() {
        ...
        const routine = await Routine.create(this.deviceContext, wrapBlitModule, [configSlot, initialRenderableFacesSlot, initialEdgesSlot, renderProgramInstructionsSlot], Routine.INDIVIDUAL_LAYOUT_STRATEGY, async (context, execute, input) => {
    ...
    async runRenderProgram(program, providedRunOptions, rasterizeOptions) {
        // TODO: avoid extra optionize somehow?
        const runOptions = optionize3()({}, FACE_RASTERIZER_RUN_DEFAULT_OPTIONS, providedRunOptions);
    ...
    async run(providedOptions) {
        ...
        const options = optionize3()({}, FACE_RASTERIZER_RUN_DEFAULT_OPTIONS, providedOptions);
...
//# sourceMappingURL=FaceRasterizer.js.map