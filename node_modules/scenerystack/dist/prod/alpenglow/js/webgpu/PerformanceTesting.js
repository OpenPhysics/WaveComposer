...
export class PerformanceTesting {
    static async loopRadixSortTest(combineStrategy, separateComputePasses) {
        ...
        const routine = await Routine.create(deviceContext, radixSortModule, [inputSlot, outputSlot], combineStrategy ? Routine.COMBINE_ALL_LAYOUT_STRATEGY : Routine.INDIVIDUAL_LAYOUT_STRATEGY, async (context, execute, input) => {
...
//# sourceMappingURL=PerformanceTesting.js.map