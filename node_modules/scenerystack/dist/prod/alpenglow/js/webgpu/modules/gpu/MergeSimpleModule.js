...
import { MAIN_MERGE_SIMPLE_DEFAULTS, mainMergeSimpleWGSL } from '../../wgsl/gpu/mainMergeSimpleWGSL.js';
...
export class MergeSimpleModule extends DirectModule {
    constructor(providedOptions) {
        const options = combineOptions({
            main: mainMergeSimpleWGSL(providedOptions),
            setDispatchSize: (dispatchSize, outputSize) => {
...
//# sourceMappingURL=MergeSimpleModule.js.map