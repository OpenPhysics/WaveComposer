...
import { mainTwoPassTileWGSLOptions } from '../../wgsl/rasterize-two-pass/mainTwoPassTileWGSL.js';
...
export declare const MAIN_TWO_PASS_TILE_MODULE_DEFAULTS: {
    readonly log: false;
};
export declare class MainTwoPassTileModule extends DirectModule<number> {
    ...
    constructor(providedOptions: MainTwoPassTileModuleOptions);
}
//# sourceMappingURL=MainTwoPassTileModule.d.ts.map