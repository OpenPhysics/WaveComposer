...
import { MAIN_TWO_PASS_TILE_DEFAULTS, mainTwoPassTileWGSL } from '../../wgsl/rasterize-two-pass/mainTwoPassTileWGSL.js';
...
export class MainTwoPassTileModule extends DirectModule {
    constructor(providedOptions) {
        const options = combineOptions({
            main: mainTwoPassTileWGSL(providedOptions),
            setDispatchSize: (dispatchSize, numRenderableFaceTiles) => {
...
//# sourceMappingURL=MainTwoPassTileModule.js.map