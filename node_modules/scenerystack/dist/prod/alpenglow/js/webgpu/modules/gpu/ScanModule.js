...
import { getArrayType } from '../../compute/ConcreteType.js';
import { MainScanModule } from './MainScanModule.js';
...
export class ScanModule extends CompositeModule {
    constructor(providedOptions) {
        const options = optionize3()({}, SCAN_MODULE_DEFAULTS, providedOptions);
        ...
        if (numStages === 1) {
            const module = new MainScanModule(combineOptions({
                name: `${options.name} 0`,
                log: options.log,
            ...
            const reduceModule = (options.inputOrder === 'blocked' && options.inputAccessOrder === 'striped' && !options.binaryOp.isCommutative) ? new MainReduceNonCommutativeModule(combineOptions({
                lengthExpression: options.lengthExpression
            }, reduceOptions, options.mainReduceNonCommutativeModuleOptions)) : new MainReduceModule(combineOptions({
                loadReducedOptions: {
                    lengthExpression: options.lengthExpression,
                    inputOrder: options.inputOrder,
                    inputAccessOrder: options.inputAccessOrder
            ...
            const lowerScanModule = new MainScanModule(combineOptions({
            ...
            const upperScanModule = new MainScanModule(combineOptions({
            ...
            const middleScanModule = new MainScanModule(combineOptions({
...
//# sourceMappingURL=ScanModule.js.map