...
export class ComputePipeline {
    constructor(deviceContext, name, wgsl, pipelineLayout, async) {
        this.deviceContext = deviceContext;
        this.name = name;
        this.wgsl = wgsl;
        this.pipelineLayout = pipelineLayout;
        this.logBarrierPipeline = null;
    ...
    static async withContextAsync(deviceContext, name, wgsl, pipelineLayout) {
