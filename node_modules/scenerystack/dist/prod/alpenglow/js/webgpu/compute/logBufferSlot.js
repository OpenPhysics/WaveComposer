...
export const logBufferSlot = new BufferSlot(getCastedType(getArrayType(U32Type, 2 << 24, 0), wgslWith(wgsl `_Log`, new WGSLModule('_Log', wgsl `
    struct _Log {
      next_space: atomic<u32>,
      data: array<u32>
    };
  `))));
//# sourceMappingURL=logBufferSlot.js.map