...
export class DeviceContext {
    ...
    constructor(device) {
        this.device = device;
        this.lostEmitter = new TinyEmitter();
    ...
    static async getDevice(providedOptions) {
        ...
        try {
            ...
            const features = supportsBGRATextureStorage ? ['bgra8unorm-storage'] : [];
    ...
    static async getMappedFloatArray(buffer) {
    ...
    static async getMappedUintArray(buffer) {
        await webgpu.bufferMapAsync(buffer, GPUMapMode.READ);
        const resultArrayBuffer = webgpu.bufferGetMappedRange(buffer);
    ...
    static async getMappedIntArray(buffer) {
        await webgpu.bufferMapAsync(buffer, GPUMapMode.READ);
        const resultArrayBuffer = webgpu.bufferGetMappedRange(buffer);
    ...
    static async getMappedByteArray(buffer) {
        await webgpu.bufferMapAsync(buffer, GPUMapMode.READ);
        const resultArrayBuffer = webgpu.bufferGetMappedRange(buffer);
    ...
    static async getMappedArrayBuffer(buffer) {
