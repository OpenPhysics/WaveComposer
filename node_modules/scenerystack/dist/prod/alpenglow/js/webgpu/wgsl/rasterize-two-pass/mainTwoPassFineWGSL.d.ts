...
export declare const MAIN_TWO_PASS_FINE_DEFAULTS: {
    readonly supportsGridFiltering: false;
    readonly supportsBilinear: true;
    readonly supportsMitchellNetravali: false;
};
export declare const mainTwoPassFineWGSL: (providedOptions: mainTwoPassFineWGSLOptions) => WGSLMainModule;
//# sourceMappingURL=mainTwoPassFineWGSL.d.ts.map