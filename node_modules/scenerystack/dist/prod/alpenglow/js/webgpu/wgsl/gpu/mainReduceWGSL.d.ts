...
import { loadReducedWGSLOptions } from './loadReducedWGSL.js';
import { reduceWGSLOptions } from './reduceWGSL.js';
...
export declare const MAIN_REDUCE_DEFAULTS: {
    readonly stripeOutput: false;
    readonly convergentRemap: false;
    readonly loadReducedOptions: {};
    readonly reduceOptions: {};
};
export declare const mainReduceWGSL: <T>(providedOptions: mainReduceWGSLOptions<T>) => WGSLMainModule;
//# sourceMappingURL=mainReduceWGSL.d.ts.map