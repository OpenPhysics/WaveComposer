...
import { LOCAL_INDEXABLE_DEFAULTS, WORKGROUP_INDEXABLE_DEFAULTS } from '../WGSLUtils.js';
...
export const scanRakedWGSL = (providedOptions) => {
    const options = optionize3()({}, SCAN_RAKED_DEFAULTS, providedOptions);
    ...
    ${storeReduction ? wgsl `
      ...
      if ( ${localIndex} == ${u32S(workgroupSize - 1)} ) {
        ${storeReduction(stripeReducedOutput ? toStripedIndexWGSL({
        i: workgroupIndex,
        workgroupSize: workgroupSize,
        grainSize: grainSize
    }) : workgroupIndex, wgsl `value`)}
      }
...
//# sourceMappingURL=scanRakedWGSL.js.map