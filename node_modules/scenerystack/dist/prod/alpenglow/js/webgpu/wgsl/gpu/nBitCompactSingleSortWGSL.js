...
import { U32Add, U32Type, Vec2uAdd, Vec2uType, Vec3uAdd, Vec3uType, Vec4uAdd, Vec4uType } from '../../compute/ConcreteType.js';
import { ConsoleLoggedLine } from '../../compute/ConsoleLogger.js';
import { decimalS, u32S, wgsl } from '../WGSLString.js';
...
export const nBitCompactSingleSortWGSL = (providedOptions) => {
    ...
    const logPackedBits = (name, varName) => logWGSL({
    ...
    ${logStringWGSL(`n_bit_compact_single_sort workgroupSize:${workgroupSize}, grainSize:${grainSize}, bitsPerInnerPass:${bitsPerInnerPass}, bitVectorSize:${bitVectorSize}, length:"${lengthExpression ? JSON.stringify(lengthExpression) : null}" earlyLoad:${earlyLoad}`)}
...
//# sourceMappingURL=nBitCompactSingleSortWGSL.js.map