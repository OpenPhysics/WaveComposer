 ...
 */
import '../../../../../globals.js';
import { wgsl, WGSLReferenceModule, wgslString, WGSLStringModule } from '../WGSLString.js';
...
`);
export const bounds_clip_edgeWGSL = (edge, // LinearEdge
minX, minY, maxX, maxY, centerX, centerY, useExactSlope = false) => {
    ...
    fn bounds_clip_edge(
      ...
      let clipResult: MD_ClipResult = ${matthes_drakopoulos_clipWGSL(wgsl `startPoint`, wgsl `endPoint`, wgsl `minX`, wgsl `minY`, wgsl `maxX`, wgsl `maxY`)};
...
//# sourceMappingURL=bounds_clip_edgeWGSL.js.map