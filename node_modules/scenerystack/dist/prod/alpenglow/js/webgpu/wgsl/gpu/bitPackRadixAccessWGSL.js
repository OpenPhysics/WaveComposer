...
export const bitPackRadixAccessWGSL = (options) => {
    ...
    countsPerComponent === 1 ? wgsl `` : wgsl `( `}${bitVector}${bitVectorSize > 1 ? wgsl `[ ${
    // Our access index (if we're a vector)
    countsPerComponent === 1 ? bits : wgsl `( ${bits} ) / ${u32S(countsPerComponent)}`} ]` : wgsl ``}${
...
//# sourceMappingURL=bitPackRadixAccessWGSL.js.map