...
import { U32Max, U32Type } from '../../compute/ConcreteType.js';
import { decimalS, u32S, wgsl, WGSLMainModule, WGSLSlot } from '../WGSLString.js';
import { loadMultipleWGSL } from './loadMultipleWGSL.js';
...
export const mainRadixScatterWGSL = (providedOptions) => {
    const options = optionize3()({}, MAIN_RADIX_SCATTER_DEFAULTS, providedOptions);
    ...
    fn main(
      ...
      if ( workgroup_id.x < num_valid_workgroups ) {
        ${loadMultipleWGSL(combineOptions({
...
//# sourceMappingURL=mainRadixScatterWGSL.js.map