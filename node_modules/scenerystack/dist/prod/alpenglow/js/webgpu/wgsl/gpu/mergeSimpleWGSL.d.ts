 ...
 */
import '../../../../../globals.js';
import { WGSLExpressionBool, WGSLExpressionI32, WGSLExpressionU32, WGSLStatements } from '../WGSLString.js';
import { GlobalIndexable, GrainSizable } from '../WGSLUtils.js';
...
export declare const MERGE_SIMPLE_DEFAULTS: {
    readonly globalIndex: import("../WGSLString.js").WGSLString;
    readonly greaterThan: null;
    readonly lessThanOrEqual: null;
};
export declare const mergeSimpleWGSL: (providedOptions: mergeSimpleWGSLOptions) => WGSLStatements;
//# sourceMappingURL=mergeSimpleWGSL.d.ts.map