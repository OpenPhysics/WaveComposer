...
import { LocalIndexable, RakedSizable } from '../WGSLUtils.js';
...
export declare const nBitCompactSingleSortWGSL: <T>(providedOptions: nBitCompactSingleSortWGSLOptions<T>) => WGSLStatements;
//# sourceMappingURL=nBitCompactSingleSortWGSL.d.ts.map