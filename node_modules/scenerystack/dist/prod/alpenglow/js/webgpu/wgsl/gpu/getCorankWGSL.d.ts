 ...
 */
import '../../../../../globals.js';
import { WGSLExpressionBool, WGSLExpressionI32, WGSLExpressionU32, WGSLStatements, WGSLVariableName } from '../WGSLString.js';
...
export declare const GET_CORANK_DEFAULTS: {
    readonly greaterThan: null;
    readonly lessThanOrEqual: null;
};
export declare const getCorankWGSL: (providedOptions: getCorankWGSLOptions) => WGSLStatements;
//# sourceMappingURL=getCorankWGSL.d.ts.map