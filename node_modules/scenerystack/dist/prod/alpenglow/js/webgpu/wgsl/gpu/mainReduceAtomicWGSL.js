...
import { loadReducedWGSL } from './loadReducedWGSL.js';
...
export const mainReduceAtomicWGSL = (providedOptions) => {
    const options = optionize3()({}, MAIN_REDUCE_ATOMIC_DEFAULTS, providedOptions);
    ...
    fn main(
      ...
      ${loadReducedWGSL(combineOptions({
        value: wgsl `value`,
        binaryOp: binaryOp,
...
//# sourceMappingURL=mainReduceAtomicWGSL.js.map