...
const dwords = 5;
export const TwoPassCoarseRenderableFaceType = {
    ...
    encode(value, encoder) {
        ...
        encoder.pushU32(((value.minXCount & 0xff) |
            ((value.minYCount & 0xff) << 8) |
            ((value.maxXCount & 0xff) << 16) |
            ((value.maxYCount & 0xff) << 24)) >>> 0 // because JS omg
        );
    ...
    toDebugString: (value) => 'TwoPassCoarseRenderableFace'
};
//# sourceMappingURL=TwoPassCoarseRenderableFaceType.js.map