...
export const partialWGSLBeautify = (wgsl) => {
...
export const addLineNumbers = (wgsl) => {
    return wgsl.split('\n').map((s, i) => `${i + 1} ${s}`).join('\n');
};
/**
 ...
 * @author Jonathan Olson <jonathan.olson@colorado.edu>
 */
export const stripWGSLComments = (str, allComments = true // if false, we'll leave things starting with /** and ending with **/ (for our own comments)
) => {
...
//# sourceMappingURL=WGSLUtils.js.map