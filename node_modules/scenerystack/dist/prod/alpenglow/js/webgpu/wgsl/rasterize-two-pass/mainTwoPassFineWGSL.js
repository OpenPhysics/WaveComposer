...
import { decimalS, f32S, u32S, wgsl, wgslBlueprint, WGSLMainModule, WGSLSlot } from '../WGSLString.js';
...
export const mainTwoPassFineWGSL = (providedOptions) => {
    const options = optionize3()({}, MAIN_TWO_PASS_FINE_DEFAULTS, providedOptions);
    ...
    const outputSlot = new WGSLSlot('output', options.output, new StorageTextureBindingType('write-only', options.storageFormat));
    ...
    const getInstructionWGSL = (index) => wgsl `render_program_instructions[ ${index} ]`;
...
//# sourceMappingURL=mainTwoPassFineWGSL.js.map