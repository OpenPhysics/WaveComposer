...
export const evaluateTwoPassTiled = async (name, deviceContext) => {
    ...
    const routine = await Routine.create(deviceContext, wrapBlitModule, [configSlot, initialRenderableFacesSlot, initialEdgesSlot, renderProgramInstructionsSlot], Routine.INDIVIDUAL_LAYOUT_STRATEGY, async (context, execute, input) => {
...
//# sourceMappingURL=TwoPassTiled.js.map