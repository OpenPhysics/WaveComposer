...
export const evaluateTwoPassFineSolo = async (name, deviceContext) => {
    ...
    const routine = await Routine.create(deviceContext, wrapBlitModule, [configSlot, addressesSlot, fineRenderableFacesSlot, edgesSlot], Routine.INDIVIDUAL_LAYOUT_STRATEGY, (context, execute, input) => {
...
//# sourceMappingURL=TwoPassFineSolo.js.map