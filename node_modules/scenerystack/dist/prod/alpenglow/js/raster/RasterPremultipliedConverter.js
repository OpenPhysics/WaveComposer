...
export class RasterPremultipliedConverter {
    ...
    clientToAccumulation(client) {
        ...
        if (a > 0) {
            ...
            return scratchVector.setXYZW(a * (x <= 0.0404482362771082 ? x / 12.92 : Math.pow((x + 0.055) / 1.055, 2.4)), a * (y <= 0.0404482362771082 ? y / 12.92 : Math.pow((y + 0.055) / 1.055, 2.4)), a * (z <= 0.0404482362771082 ? z / 12.92 : Math.pow((z + 0.055) / 1.055, 2.4)), a);
        }
        else {
    ...
    clientToOutput(client) {
        ...
        if (a <= 0) {
            ...
            return scratchVector.setXYZW(r / a * 255, g / a * 255, b / a * 255, a * 255);
        }
        else {
    ...
    // NOTE: DO NOT STORE THE VALUES OF THESE RESULTS, THEY ARE MUTATED. Create a copy if needed
    accumulationToOutput(accumulation) {
        ...
        if (a <= 0) {
            ...
            if (r >= 0 && r <= 1 && g >= 0 && g <= 1 && b >= 0 && b <= 1 && a <= 1) {
                return scratchVector.setXYZW(r * 255, g * 255, b * 255, a * 255);
            }
            else {
    ...
    static getOutOfGamutColor(color) {
...
RasterPremultipliedConverter.SRGB = new RasterPremultipliedConverter(RenderColor.gamutMapPremultipliedSRGB);
RasterPremultipliedConverter.DISPLAY_P3 = new RasterPremultipliedConverter(RenderColor.gamutMapPremultipliedDisplayP3);
RasterPremultipliedConverter.SRGB_SHOW_OUT_OF_GAMUT = new RasterPremultipliedConverter(RasterPremultipliedConverter.getOutOfGamutColor);
RasterPremultipliedConverter.DISPLAY_P3_SHOW_OUT_OF_GAMUT = new RasterPremultipliedConverter(RasterPremultipliedConverter.getOutOfGamutColor);
//# sourceMappingURL=RasterPremultipliedConverter.js.map