...
export class PolygonMitchellNetravali {
    static evaluateFull(pointX, pointY, minX, minY) {
     ...
     */
    static evaluateLinearEdges(edges, pointX, pointY, minX, minY) {
        const offsetX = minX - pointX;
        const offsetY = minY - pointY;
        ;
        ;
     ...
     * coordinates of the clipped polygon unit pixel.
     */
    static evaluatePolygons(polygons, pointX, pointY, minX, minY) {
        const offsetX = minX - pointX;
        const offsetY = minY - pointY;
    ...
    static evaluateWith(polygon, evaluator, transpose, bounds) {
        let sum = 0;
        const clippedPolygon = BoundsClipping.boundsClipPolygon(polygon, bounds.minX, bounds.minY, bounds.maxX, bounds.maxY, bounds.centerX, bounds.centerY);
    ...
    static evaluateCase00(p0x, p0y, p1x, p1y) {
        const p0x2 = p0x * p0x;
        const p0x3 = p0x2 * p0x;
        const p0y2 = p0y * p0y;
        const p1x2 = p1x * p1x;
        ...
        return (1 / 51840) * (p0x - p1x) * (3 * p0y2 * p0y2 * (896 + 735 * p0x3 + 45 * p0x2 * p1x732 + 15 * p01x * p1x732 + 3 * p1x2 * p1x732) +
            ...
            6 * p0y2 * p1y * (-16 * (80 + 30 * p0x3 + 36 * p0x2 * (p1x - 2) + 12 * (p1x - 3) * p1x2 + 9 * p01x * (3 * p1x - 8)) +
                (448 + 3 * (35 * p0x3 + 9 * p01x * p1x716 + p1x2 * (35 * p1x - 96) + p0x2 * (63 * p1x - 96))) * p1y) +
            4 * p0y * (32 * (160 + 84 * p0x3 + 9 * p0x2 * p1x720 + 6 * p01x * p1x720 + 3 * p1x2 * p1x720) -
    ...
    static evaluateCase10(p0x, p0y, p1x, p1y) {
        ...
        return -(1 / 51840) * (p0x - p1x) * (3 * p0y4 * (-1792 + 245 * p0x3 + 15 * p0x2 * p1x796 + 5 * p0x * p560 + p1x * p560) +
            ...
            12 * p0y3 * (8 * (-20 * Math.pow(p0x - 2, 3) - 2 * (30 + p0x * (5 * p0x - 24)) * p1x - 4 * (p0x - 3) * p1x2 - p1x3) +
                (-448 + 35 * p0x3 + 5 * p0x2 * (p1x7 - 48) + p1x * (280 + p1x * (-72 + p1x7)) + p0x * (560 + 3 * p1x * (p1x7 - 64))) * p1y) +
            6 * p0y2 * p1y * (16 * (-10 * p0x3 - 12 * p0x2 * (p1x - 6) - 9 * p0x * (20 + (p1x - 8) * p1x) - 4 * (p1x - 4) * (10 + (p1x - 5) * p1x)) +
                (-896 + 35 * p0x3 + 9 * p0x2 * (p1x7 - 32) + p0x * (840 + 9 * p1x * (p1x7 - 48)) + p1x * (840 + p1x * (35 * p1x - 288))) * p1y) +
            4 * p0y * (32 * (-320 + 28 * p0x3 + 3 * p0x2 * p1x760 + 2 * p0x * p1xp1x760200 + p1x * p1xp1x760200) -
    ...
    static evaluateCase11(p0x, p0y, p1x, p1y) {
        const p0x2 = p0x * p0x;
        const p0x3 = p0x2 * p0x;
        const p0y2 = p0y * p0y;
        const p0y3 = p0y2 * p0y;
        ...
        const p560 = 560 + p1x * p1x796;
        const p1xp1x760200 = 200 + p1x * p1x760;
        return (1 / 51840) * (p0x - p1x) * (p0y4 * (-1792 + 245 * p0x3 + 15 * p0x2 * p1x796 + 5 * p0x * p560 + p1x * p560) +
            4 * p0y3 * (24 * (-20 * Math.pow(p0x - 2, 3) - 2 * (30 + p0x * (5 * p0x - 24)) * p1x - 4 * (p0x - 3) * p1x2 - p1x3) +
                (-448 + 35 * p0x3 + 5 * p0x2 * (p1x7 - 48) + p1x * (280 + p1x * (-72 + p1x7)) + p0x * (560 + 3 * p1x * (p1x7 - 64))) * p1y) +
            2 * p0y2 * (40 * (-640 + 70 * p0x3 + 6 * p0x2 * (-72 + p1x7) + 3 * p0x * (300 + p1x * (-72 + p1x7)) + p1x * (300 + p1x * (-72 + p1x7))) -
            ...
            4 * p0y * (-64 * (-320 + 28 * p0x3 + 3 * p0x2 * p1x760 + 2 * p0x * p1xp1x760200 + p1x * p1xp1x760200) +
            ...
            p1y * (-256 * (-320 + 200 * p0x + p0x73 + 3 * p0x * p1x * (p1x7 - 40) + 2 * p0x2 * (p1x7 - 30) + 4 * p1x * (100 + p1x * (p1x7 - 45))) +
...
PolygonMitchellNetravali.full00 = 0.2640817901234568;
PolygonMitchellNetravali.full10 = -0.007137345679012345;
PolygonMitchellNetravali.full11 = 0.0001929012345679021;
//# sourceMappingURL=PolygonMitchellNetravali.js.map