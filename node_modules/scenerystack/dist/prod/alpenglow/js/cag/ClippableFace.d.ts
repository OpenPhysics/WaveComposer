...
import { GridClipCallback } from '../clip/GridClipping.js';
...
export type ClippableFace = {
     ...
     */
    getBinaryXClip(x: number, fakeCornerY: number): {
        minFace: ClippableFace;
        maxFace: ClippableFace;
    };
    /**
     ...
     */
    getBinaryYClip(y: number, fakeCornerX: number): {
        minFace: ClippableFace;
        maxFace: ClippableFace;
    };
    /**
     ...
     */
    getBinaryLineClip(normal: Vector2, value: number, fakeCornerPerpendicular: number): {
        minFace: ClippableFace;
        maxFace: ClippableFace;
    };
    /**
     ...
     */
    getBinaryCircularClip(center: Vector2, radius: number, maxAngleSplit: number): {
        insideFace: ClippableFace;
        outsideFace: ClippableFace;
    };
    /**
     ...
     */
    gridClipIterate(minX: number, minY: number, maxX: number, maxY: number, stepX: number, stepY: number, stepWidth: number, stepHeight: number, callback: GridClipCallback, polygonCompleteCallback: PolygonCompleteCallback): void;
    /**
...
export declare const serializeClippableFace: (clippableFace: ClippableFace) => SerializedClippableFace;
export declare const deserializeClippableFace: (serialized: SerializedClippableFace) => ClippableFace;
/**
 ...
 * @author Jonathan Olson <jonathan.olson@colorado.edu>
 */
export declare class EdgedFace implements ClippableFace {
    readonly edges: LinearEdge[];
    constructor(edges: LinearEdge[], skipValidation?: boolean);
    /**
     * Converts the face to a polygonal face. Epsilon is used to determine whether start/end points match.
     *
     * NOTE: This is likely a low-performance method, and should only be used for debugging.
     ...
     */
    getBinaryCircularClip(center: Vector2, radius: number, maxAngleSplit: number): {
        insideFace: EdgedFace;
        outsideFace: EdgedFace;
    };
    /**
     * Given an integral bounding box and step sizes (which define the grid), this will clip the face to each cell in the
     * grid, calling the callback for each cell's contributing edges (in order, if we are a PolygonalFace).
     ...
     */
    static getScratchAccumulator(): ClippableFaceAccumulator<EdgedFace>;
    /**
     * Returns a new accumulator for this type of face. This should be used when concurrent clipping will need to happen.
     *
     * This is a method that can be called on an unknown-type face, to reproduce the same type of face. This is
    ...
    static deserialize(serialized: SerializedEdgedFace): EdgedFace;
    static fromBounds(bounds: Bounds2): EdgedFace;
    static fromBoundsValues(minX: number, minY: number, maxX: number, maxY: number): EdgedFace;
}
export declare class EdgedFaceAccumulator implements ClippableFaceAccumulator<EdgedFace> {
    private edges;
    readonly usesEndPoint = true;
    addEdge(startX: number, startY: number, endX: number, endY: number, startPoint: Vector2 | null, endPoint: Vector2 | null): void;
    markNewPolygon(): void;
    setAccumulationBounds(minX: number, minY: number, maxX: number, maxY: number): void;
 ...
 * @author Jonathan Olson <jonathan.olson@colorado.edu>
 */
export declare class EdgedClippedFace implements ClippableFace {
    readonly edges: LinearEdge[];
    readonly minX: number;
    readonly minY: number;
    readonly maxX: number;
    readonly maxY: number;
    readonly minXCount: number;
    readonly minYCount: number;
    readonly maxXCount: number;
    readonly maxYCount: number;
    readonly clippedEdgedFace: EdgedFace;
    constructor(edges: LinearEdge[], minX: number, minY: number, maxX: number, maxY: number, minXCount: number, minYCount: number, maxXCount: number, maxYCount: number);
    /**
     * Converts the face to a polygonal face. Epsilon is used to determine whether start/end points match.
     *
     * NOTE: This is likely a low-performance method, and should only be used for debugging.
     ...
     */
    toEdgedClippedFaceWithoutCheck(minX: number, minY: number, maxX: number, maxY: number): EdgedClippedFace;
    static fromEdges(edges: LinearEdge[], minX: number, minY: number, maxX: number, maxY: number): EdgedClippedFace;
    static fromEdgesWithoutCheck(edges: LinearEdge[], minX: number, minY: number, maxX: number, maxY: number): EdgedClippedFace;
    private static implicitEdge;
    forEachImplicitEdge(callback: (startPoint: Vector2, endPoint: Vector2) => void): void;
     ...
     */
    getBinaryXClip(x: number, fakeCornerY: number): {
        minFace: EdgedClippedFace;
        maxFace: EdgedClippedFace;
    };
    /**
     * Returns two copies of the face, one that is clipped to y values less than the given y value, and one that is
     * clipped to values greater than the given y value.
     ...
     */
    getBinaryCircularClip(center: Vector2, radius: number, maxAngleSplit: number): {
        insideFace: EdgedClippedFace;
        outsideFace: EdgedClippedFace;
    };
    /**
     * Given an integral bounding box and step sizes (which define the grid), this will clip the face to each cell in the
     * grid, calling the callback for each cell's contributing edges (in order, if we are a PolygonalFace).
     ...
     */
    static getScratchAccumulator(): ClippableFaceAccumulator<EdgedClippedFace>;
    /**
     * Returns a new accumulator for this type of face. This should be used when concurrent clipping will need to happen.
     *
     * This is a method that can be called on an unknown-type face, to reproduce the same type of face. This is
    ...
    static deserialize(serialized: SerializedEdgedClippedFace): EdgedClippedFace;
    static fromBounds(bounds: Bounds2): EdgedClippedFace;
    static fromBoundsValues(minX: number, minY: number, maxX: number, maxY: number): EdgedClippedFace;
}
export declare class EdgedClippedFaceAccumulator implements ClippableFaceAccumulator<EdgedClippedFace> {
    private edges;
    private minX;
    private minY;
    private maxX;
 ...
 * @author Jonathan Olson <jonathan.olson@colorado.edu>
 */
export declare class PolygonalFace implements ClippableFace {
    readonly polygons: Vector2[][];
     ...
     */
    getBinaryXClip(x: number, fakeCornerY: number): {
        minFace: PolygonalFace;
        maxFace: PolygonalFace;
    };
    /**
     * Returns two copies of the face, one that is clipped to y values less than the given y value, and one that is
     * clipped to values greater than the given y value.
     ...
     */
    getBinaryCircularClip(center: Vector2, radius: number, maxAngleSplit: number): {
        insideFace: PolygonalFace;
        outsideFace: PolygonalFace;
    };
    /**
     * Given an integral bounding box and step sizes (which define the grid), this will clip the face to each cell in the
     * grid, calling the callback for each cell's contributing edges (in order, if we are a PolygonalFace).
     ...
     */
    static getScratchAccumulator(): ClippableFaceAccumulator<PolygonalFace>;
    /**
     * Returns a new accumulator for this type of face. This should be used when concurrent clipping will need to happen.
     *
     * This is a method that can be called on an unknown-type face, to reproduce the same type of face. This is
    ...
    static deserialize(serialized: SerializedPolygonalFace): PolygonalFace;
    static fromBounds(bounds: Bounds2): PolygonalFace;
    static fromBoundsValues(minX: number, minY: number, maxX: number, maxY: number): PolygonalFace;
}
export declare class PolygonalFaceAccumulator implements ClippableFaceAccumulator<PolygonalFace> {
    private polygons;
    private simplifier;
    readonly usesEndPoint = false;
    addEdge(startX: number, startY: number, endX: number, endY: number, startPoint: Vector2 | null, endPoint: Vector2 | null): void;
    markNewPolygon(): void;
    setAccumulationBounds(minX: number, minY: number, maxX: number, maxY: number): void;
 ...
 * @author Jonathan Olson <jonathan.olson@colorado.edu>
 */
export declare class CircularClipping {
    /**
     ...
     */
    static binaryCircularClipEdges(edges: LinearEdge[], center: Vector2, radius: number, maxAngleSplit: number, inside: LinearEdge[], outside: LinearEdge[]): void;
    /**
     ...
     */
    static binaryCircularClipPolygon(polygons: Vector2[][], center: Vector2, radius: number, maxAngleSplit: number, inside: Vector2[][], outside: Vector2[][]): void;
    /**
     * Clips a polygon (represented by polygonal vertex lists) by a circle. This will output both the inside and outside,
     * appending vertices to the arrays.
     *
     ...
     * TODO: test this!
     */
    static binaryCircularTracingClipIterate(polygons: Vector2[][], center: Vector2, radius: number, maxAngleSplit: number, callback: BinaryClipCallback, polygonCompleteCallback: BinaryPolygonCompleteCallback): void;
}
export type BinaryClipCallback = (isMinFace: boolean, startX: number, startY: number, endX: number, endY: number, startPoint: Vector2 | null, endPoint: Vector2 | null) => void;
export type PolygonCompleteCallback = () => void;
export type BinaryPolygonCompleteCallback = (isMinFace: boolean) => void;
/**
 ...
 * @author Jonathan Olson <jonathan.olson@colorado.edu>
 */
export declare class BinaryClipping {
    private static binaryInitialPush;
    private static binaryPushClipEdges;
    static binaryXClipEdge(startPoint: Vector2, endPoint: Vector2, x: number, fakeCornerY: number, minLinearEdges: LinearEdge[], // Will append into this (for performance)
    maxLinearEdges: LinearEdge[]): void;
    static binaryYClipEdge(startPoint: Vector2, endPoint: Vector2, y: number, fakeCornerX: number, minLinearEdges: LinearEdge[], // Will append into this (for performance)
    maxLinearEdges: LinearEdge[]): void;
    static binaryLineClipEdge(startPoint: Vector2, endPoint: Vector2, normal: Vector2, // NOTE: does NOT need to be a unit vector
    value: number, fakeCornerPerpendicular: number, minLinearEdges: LinearEdge[], // Will append into this (for performance)
    maxLinearEdges: LinearEdge[]): void;
    static binaryXClipPolygon(polygon: Vector2[], x: number, minPolygon: Vector2[], // Will append into this (for performance)
    maxPolygon: Vector2[]): void;
    static binaryYClipPolygon(polygon: Vector2[], y: number, minPolygon: Vector2[], // Will append into this (for performance)
    maxPolygon: Vector2[]): void;
    static binaryLineClipPolygon(polygon: Vector2[], normal: Vector2, // NOTE: does NOT need to be a unit vector
    value: number, minPolygon: Vector2[], // Will append into this (for performance)
    maxPolygon: Vector2[]): void;
    static binaryXClipEdgedClipped(face: EdgedClippedFace, x: number): {
        minFace: EdgedClippedFace;
        maxFace: EdgedClippedFace;
    };
    static binaryYClipEdgedClipped(face: EdgedClippedFace, y: number): {
        minFace: EdgedClippedFace;
        maxFace: EdgedClippedFace;
    };
}
//# sourceMappingURL=ClippableFace.d.ts.map