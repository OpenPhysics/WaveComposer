...
export class RationalBoundary {
    ...
    toTransformedLinearEdges(matrix) {
        const result = [];
        for (let i = 0; i < this.edges.length; i++) {
            const edge = this.edges[i];
            result.push(new LinearEdge(matrix.timesVector2(edge.p0float), matrix.timesVector2(edge.p1float)));
        }
        return result;
    }
}
//# sourceMappingURL=RationalBoundary.js.map