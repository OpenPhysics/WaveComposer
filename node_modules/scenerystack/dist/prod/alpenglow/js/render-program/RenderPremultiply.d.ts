...
export declare class RenderPremultiply extends RenderColorSpaceConversion {
...
export declare class RenderInstructionPremultiply extends RenderInstruction {
    toString(): string;
    ...
    static readonly INSTANCE: RenderInstructionPremultiply;
}
//# sourceMappingURL=RenderPremultiply.d.ts.map