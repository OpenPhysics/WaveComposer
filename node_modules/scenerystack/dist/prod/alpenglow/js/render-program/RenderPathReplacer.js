...
export class RenderPathReplacer {
    constructor(program) {
        ...
        this.permanentChildrenMap = new Map();
        ;
        this.initialRecurse(program, []);
    }
    replace(includedPaths) {
    ...
    replaceRecurse(program, includedPaths, scaffold) {
        ...
        if (program instanceof RenderPathBoolean) {
            ...
            return this.replaceRecurse(included ? program.inside : program.outside, includedPaths, scaffold ? scaffold.getAtIndex(included ? 0 : 1) : null);
        }
    ...
    initialRecurse(program, indices) {
    ...
    addPermanentChild(program, index) {
...
//# sourceMappingURL=RenderPathReplacer.js.map