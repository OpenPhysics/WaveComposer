...
export class RenderLinearGradient extends RenderProgram {
    constructor(transform, start, end, stops, // should be sorted!!
    extend, accuracy, logic) {
        ...
        super(children, _.every(children, RenderProgram.closureIsFullyTransparent), _.every(children, RenderProgram.closureIsFullyOpaque), false, false, accuracy === RenderLinearGradientAccuracy.UnsplitCentroid || accuracy === RenderLinearGradientAccuracy.SplitAccurate);
    ...
    transformed(transform) {
        return new RenderLinearGradient(transform.timesMatrix(this.transform), this.start, this.end, this.stops.map(stop => new RenderGradientStop(stop.ratio, stop.program.transformed(transform))), this.extend, this.accuracy);
    }
    equalsTyped(other) {
            ...
            const renderableFaces = linearRanges.map((range, i) => {
                ...
                const replacer = (renderProgram) => {
                    ...
                    if (range.startProgram === range.endProgram) {
                        ...
                        return new RenderLinearBlend(scaledNormal, scaledOffset, blendAccuracy, range.startProgram.replace(replacer), range.endProgram.replace(replacer));
                    }
                };
...
//# sourceMappingURL=RenderLinearGradient.js.map