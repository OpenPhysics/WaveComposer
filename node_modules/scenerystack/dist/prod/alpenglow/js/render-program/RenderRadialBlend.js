...
export class RenderRadialBlend extends RenderProgram {
    constructor(transform, radius0, radius1, accuracy, zero, one, logic) {
        ;
        ;
        ;
        ;
        super([zero, one], zero.isFullyTransparent && one.isFullyTransparent, zero.isFullyOpaque && one.isFullyOpaque, accuracy === RenderRadialBlendAccuracy.Accurate, accuracy === RenderRadialBlendAccuracy.Accurate, 
    ...
    transformed(transform) {
        return new RenderRadialBlend(transform.timesMatrix(this.transform), this.radius0, this.radius1, this.accuracy, this.zero.transformed(transform), this.one.transformed(transform));
    }
    equalsTyped(other) {
...
//# sourceMappingURL=RenderRadialBlend.js.map