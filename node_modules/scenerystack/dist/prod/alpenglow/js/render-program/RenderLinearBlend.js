...
export class RenderLinearBlend extends RenderProgram {
    constructor(scaledNormal, offset, accuracy, zero, one, logic) {
        ;
        ;
        super([zero, one], zero.isFullyTransparent && one.isFullyTransparent, zero.isFullyOpaque && one.isFullyOpaque, false, false, accuracy === RenderLinearBlendAccuracy.Accurate);
    ...
    transformed(transform) {
        ...
        ;
        return new RenderLinearBlend(afterNormal, afterOffset, this.accuracy, this.zero.transformed(transform), this.one.transformed(transform));
    }
    equalsTyped(other) {
    ...
    evaluate(context) {
        ...
        if (t <= 0) {
            ...
            return RenderColor.ratioBlend(this.zero.evaluate(context), this.one.evaluate(context), t);
        }
    }
...
export class RenderInstructionLinearBlend extends RenderInstruction {
    ...
    execute(stack, context, executor) {
        ...
        if (t <= 0 || t >= 1) {
            ...
            const minusT = 1 - t;
            stack.pushValues(zeroColor.x * minusT + oneColor.x * t, zeroColor.y * minusT + oneColor.y * t, zeroColor.z * minusT + oneColor.z * t, zeroColor.w * minusT + oneColor.w * t);
        }
    }
...
RenderInstructionLinearBlend.INSTANCE = new RenderInstructionLinearBlend();
//# sourceMappingURL=RenderLinearBlend.js.map