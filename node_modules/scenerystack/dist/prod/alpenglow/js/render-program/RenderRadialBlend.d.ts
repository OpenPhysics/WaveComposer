...
export declare class RenderRadialBlend extends RenderProgram {
    readonly transform: Matrix3;
    readonly radius0: number;
    readonly radius1: number;
    readonly accuracy: RenderRadialBlendAccuracy;
    readonly zero: RenderProgram;
    readonly one: RenderProgram;
    readonly logic: RenderRadialBlendLogic;
    constructor(transform: Matrix3, radius0: number, radius1: number, accuracy: RenderRadialBlendAccuracy, zero: RenderProgram, one: RenderProgram, logic?: RenderRadialBlendLogic);
    getName(): string;
...
//# sourceMappingURL=RenderRadialBlend.d.ts.map