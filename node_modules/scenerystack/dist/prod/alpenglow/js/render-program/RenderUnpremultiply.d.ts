...
export declare class RenderUnpremultiply extends RenderColorSpaceConversion {
...
export declare class RenderInstructionUnpremultiply extends RenderInstruction {
    toString(): string;
    ...
    static readonly INSTANCE: RenderInstructionUnpremultiply;
}
//# sourceMappingURL=RenderUnpremultiply.d.ts.map