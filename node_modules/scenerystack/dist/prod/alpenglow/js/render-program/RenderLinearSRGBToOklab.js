...
export class RenderInstructionLinearSRGBToOklab extends RenderInstruction {
    ...
    execute(stack, context, executor) {
        ...
        stack.writeTopValues(0.2104542553 * l_ + 0.7936177850 * m_ - 0.0040720468 * s_, 1.9779984951 * l_ - 2.4285922050 * m_ + 0.4505937099 * s_, 0.0259040371 * l_ + 0.7827717662 * m_ - 0.8086757660 * s_, scratchVector.w);
    }
...
RenderInstructionLinearSRGBToOklab.INSTANCE = new RenderInstructionLinearSRGBToOklab();
//# sourceMappingURL=RenderLinearSRGBToOklab.js.map