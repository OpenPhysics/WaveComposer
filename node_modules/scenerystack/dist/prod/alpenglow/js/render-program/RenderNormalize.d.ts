...
export declare class RenderNormalize extends RenderProgram {
...
export declare class RenderInstructionNormalize extends RenderInstruction {
    toString(): string;
    ...
    static readonly INSTANCE: RenderInstructionNormalize;
}
export type SerializedRenderNormalize = {
    type: 'RenderNormalize';
    program: SerializedRenderProgram;
};
//# sourceMappingURL=RenderNormalize.d.ts.map