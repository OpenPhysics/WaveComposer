...
const fromPoly2 = (p0, p1) => {
    return Matrix3.affine(p1.y - p0.y, p1.x - p0.x, p0.x, p0.x - p1.x, p1.y - p0.y, p0.y);
...
export class RenderRadialGradientLogic {
    ...
    static from(transform, start, startRadius, end, endRadius, ratios, // should be sorted!!
    extend, accuracy) {
        ...
        return new RenderRadialGradientLogic(conicTransform, focalX, radius, kind, isSwapped, ratios, extend, accuracy);
    }
    equals(other) {
    ...
    computeLinearValue(context) {
        ...
        const point = (this.accuracy === RenderRadialGradientAccuracy.UnsplitCentroid ||
            this.accuracy === RenderRadialGradientAccuracy.SplitCentroid ||
            this.accuracy === RenderRadialGradientAccuracy.SplitAccurate) ? context.centroid : context.writeBoundsCentroid(scratchVectorA);
        // Pixel-specifics
...
//# sourceMappingURL=RenderRadialGradientLogic.js.map