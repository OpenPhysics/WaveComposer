...
export class RenderInstructionComputeBlendRatio extends RenderInstruction {
    constructor(logic, zeroLocation, oneLocation, blendLocation) {
        super();
        this.logic = logic;
    ...
    equals(other, areLocationsEqual) {
        ...
        if (!areLocationsEqual(this.zeroLocation, other.zeroLocation) ||
    ...
    writeBinary(encoder, getOffset) {
        ...
        if (this.logic.isLinear()) {
            const logic = this.logic;
            encoder.pushU32(RenderInstruction.ComputeLinearBlendRatioCode |
                (this.logic.accuracy << 8)); // 0
            ...
            const logic = this.logic;
            encoder.pushU32(RenderInstruction.ComputeRadialBlendRatioCode |
                (this.logic.accuracy << 8)); // 0
            encoder.pushU32(zeroOffset); // 1
            encoder.pushU32(oneOffset); // 2
            encoder.pushU32(blendOffset); // 3
...
//# sourceMappingURL=RenderInstructionComputeBlendRatio.js.map