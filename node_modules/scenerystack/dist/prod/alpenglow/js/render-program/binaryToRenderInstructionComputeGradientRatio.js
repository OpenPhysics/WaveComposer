...
export const binaryToRenderInstructionComputeGradientRatio = (encoder, offset, getLocation) => {
    ...
    const transform = Matrix3.rowMajor(encoder.fullF32Array[offset + 1], encoder.fullF32Array[offset + 2], encoder.fullF32Array[offset + 3], encoder.fullF32Array[offset + 4], encoder.fullF32Array[offset + 5], encoder.fullF32Array[offset + 6], 0, 0, 1);
    ...
    if (isLinear) {
        const start = new Vector2(encoder.fullF32Array[offset + 7], encoder.fullF32Array[offset + 8]);
        const gradDelta = new Vector2(encoder.fullF32Array[offset + 9], encoder.fullF32Array[offset + 10]);
        return new RenderInstructionComputeGradientRatio(new RenderLinearGradientLogic(transform, // inverseTransform
        start, gradDelta, ratios, extend, accuracy), stopLocations, blendLocation);
    }
    else {
        ...
        return new RenderInstructionComputeGradientRatio(new RenderRadialGradientLogic(transform, // conicTransform
        focalX, radius, kind, isSwapped, ratios, extend, accuracy), stopLocations, blendLocation);
    }
};
//# sourceMappingURL=binaryToRenderInstructionComputeGradientRatio.js.map