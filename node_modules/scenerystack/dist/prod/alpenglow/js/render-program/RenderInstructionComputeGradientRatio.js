...
export class RenderInstructionComputeGradientRatio extends RenderInstruction {
    constructor(logic, stopLocations, blendLocation) {
        super();
        this.logic = logic;
    ...
    writeBinary(encoder, getOffset) {
        ...
        if (this.logic.isLinear()) {
            const logic = this.logic;
            encoder.pushU32(RenderInstruction.ComputeLinearGradientRatioCode |
            ...
            const logic = this.logic;
            encoder.pushU32(RenderInstruction.ComputeRadialGradientRatioCode |
                (logic.accuracy << 8) | // 3-bit accuracy
                (logic.extend << 11) | // 2-bit
                (logic.kind << 13) | // 2-bit
                (logic.isSwapped ? 1 << 15 : 0) | // 1-bit
                (ratioCount << GRADIENT_BEFORE_RATIO_COUNT_BITS)); // 0
            ;
...
//# sourceMappingURL=RenderInstructionComputeGradientRatio.js.map