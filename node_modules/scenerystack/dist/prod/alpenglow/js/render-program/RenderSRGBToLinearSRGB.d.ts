...
export declare class RenderSRGBToLinearSRGB extends RenderColorSpaceConversion {
...
export declare class RenderInstructionSRGBToLinearSRGB extends RenderInstruction {
    toString(): string;
    ...
    static readonly INSTANCE: RenderInstructionSRGBToLinearSRGB;
}
//# sourceMappingURL=RenderSRGBToLinearSRGB.d.ts.map