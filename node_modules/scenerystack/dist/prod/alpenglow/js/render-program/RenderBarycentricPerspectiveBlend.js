...
export var RenderBarycentricPerspectiveBlendAccuracy;
(function (RenderBarycentricPerspectiveBlendAccuracy) {
    ...
    RenderBarycentricPerspectiveBlendAccuracy[RenderBarycentricPerspectiveBlendAccuracy["Centroid"] = 0] = "Centroid";
    RenderBarycentricPerspectiveBlendAccuracy[RenderBarycentricPerspectiveBlendAccuracy["PixelCenter"] = 1] = "PixelCenter";
})(RenderBarycentricPerspectiveBlendAccuracy || (RenderBarycentricPerspectiveBlendAccuracy = {}));
...
export class RenderBarycentricPerspectiveBlend extends RenderProgram {
    constructor(pointA, pointB, pointC, accuracy, a, b, c, logic) {
        ...
        ;
        ;
        super([a, b, c], a.isFullyTransparent && b.isFullyTransparent && c.isFullyTransparent, a.isFullyOpaque && b.isFullyOpaque && c.isFullyOpaque, false, false, accuracy === RenderBarycentricPerspectiveBlendAccuracy.Centroid);
        this.pointA = pointA;
        this.pointB = pointB;
        this.pointC = pointC;
    ...
    transformed(transform) {
        ...
        return new RenderBarycentricPerspectiveBlend(new Vector3(xyA.x, xyA.y, this.pointA.z), new Vector3(xyB.x, xyB.y, this.pointB.z), new Vector3(xyC.x, xyC.y, this.pointC.z), this.accuracy, this.a.transformed(transform), this.b.transformed(transform), this.c.transformed(transform));
    }
    equalsTyped(other) {
...
export class RenderBarycentricPerspectiveBlendLogic {
    constructor(det, diffA, diffB, point2C, zInverseA, zInverseB, zInverseC, accuracy) {
        this.det = det;
        this.diffA = diffA;
        this.diffB = diffB;
        this.point2C = point2C;
        this.zInverseA = zInverseA;
        this.zInverseB = zInverseB;
        this.zInverseC = zInverseC;
        this.accuracy = accuracy;
    }
    ...
    apply(output, context, aColor, bColor, cColor) {
        ...
        output.setXYZW(aColor.x * aFactor + bColor.x * bFactor + cColor.x * cFactor, aColor.y * aFactor + bColor.y * bFactor + cColor.y * cFactor, aColor.z * aFactor + bColor.z * bFactor + cColor.z * cFactor, aColor.w * aFactor + bColor.w * bFactor + cColor.w * cFactor);
    }
}
...
//# sourceMappingURL=RenderBarycentricPerspectiveBlend.js.map