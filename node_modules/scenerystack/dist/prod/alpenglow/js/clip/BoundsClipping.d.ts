...
export declare class BoundsClipping {
    /**
     ...
     */
    static boundsClipEdge(startPoint: Vector2, endPoint: Vector2, minX: number, minY: number, maxX: number, maxY: number, centerX: number, centerY: number, result?: LinearEdge[]): LinearEdge[];
    /**
     ...
     * @param centerY - Center y of the bounding box
     */
    static boundsClipPolygon(polygon: Vector2[], minX: number, minY: number, maxX: number, maxY: number, centerX: number, centerY: number): Vector2[];
}
//# sourceMappingURL=BoundsClipping.d.ts.map