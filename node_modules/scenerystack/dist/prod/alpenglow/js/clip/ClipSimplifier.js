...
export class ClipSimplifier {
    ...
    constructor(checkGeneralCollinearity = false) {
        this.checkGeneralCollinearity = checkGeneralCollinearity;
        this.points = [];
        // NOTHING NEEDED
    }
    addTransformed(matrix, x, y) {
        this.add(matrix.m00() * x + matrix.m01() * y + matrix.m02(), matrix.m10() * x + matrix.m11() * y + matrix.m12());
    }
    addPoint(p) {
        this.add(p.x, p.y);
    }
            ...
            if (this.points.length >= 3) {
                if (this.checkGeneralCollinearity) {
                    ...
                    if (xEquals || yEquals) {
                        const secondPoint = this.points[1];
                        const secondLastPoint = this.points[this.points.length - 2];
                        if ((xEquals && firstPoint.x === secondPoint.x) ||
                        ...
                        if ((xEquals && lastPoint.x === secondLastPoint.x) ||
    ...
    static simplifyPolygon(polygon, checkGeneralCollinearity = false) {
...
//# sourceMappingURL=ClipSimplifier.js.map