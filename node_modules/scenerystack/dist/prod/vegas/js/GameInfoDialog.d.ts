...
export default class GameInfoDialog extends Dialog {
    private readonly disposeGameInfoDialog;
    /**
     * @param levelDescriptions - level descriptions, in order of ascending level number
     * @param providedOptions
     */
    constructor(levelDescriptions: (string | TReadOnlyProperty<string>)[], providedOptions?: GameInfoDialogOptions);
    dispose(): void;
}
export {};
//# sourceMappingURL=GameInfoDialog.d.ts.map