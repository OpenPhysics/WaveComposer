...
export default class ScoreDisplayLabeledNumber extends Node {
    private readonly disposeScoreDisplayLabeledNumber;
    constructor(scoreProperty: ReadOnlyProperty<number>, providedOptions?: ScoreDisplayLabeledNumberOptions);
    dispose(): void;
}
export {};
//# sourceMappingURL=ScoreDisplayLabeledNumber.d.ts.map