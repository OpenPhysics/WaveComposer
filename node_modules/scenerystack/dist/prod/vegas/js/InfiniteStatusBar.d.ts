...
export default class InfiniteStatusBar extends StatusBar {
    private readonly disposeInfiniteStatusBar;
    /**
     ...
     */
    constructor(layoutBounds: Bounds2, visibleBoundsProperty: TReadOnlyProperty<Bounds2>, messageNode: Node, scoreProperty: ReadOnlyProperty<number>, providedOptions?: InfiniteStatusBarOptions);
    dispose(): void;
}
export {};
//# sourceMappingURL=InfiniteStatusBar.d.ts.map