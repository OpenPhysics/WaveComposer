    ...
    constructor(scoreProperty, providedOptions) {
        ...
        const scorePropertyListener = (score) => {
            ...
            for (let i = 0; i < numFilledStars; i++) {
                children.push(new StarNode(combineOptions({ value: 1 }, options.starNodeOptions)));
            }
            const remainder = proportion * numberOfStars - numFilledStars;
            if (remainder > 1E-6) {
                children.push(new StarNode(combineOptions({ value: remainder }, options.starNodeOptions)));
            }
            const numEmptyStars = numberOfStars - children.length;
            for (let i = 0; i < numEmptyStars; i++) {
                children.push(new StarNode(combineOptions({ value: 0 }, options.starNodeOptions)));
            }
...
//# sourceMappingURL=ScoreDisplayStars.js.map