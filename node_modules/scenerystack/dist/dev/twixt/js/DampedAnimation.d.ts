...
declare class DampedAnimation {
    readonly valueProperty: TProperty<number>;
    readonly velocityProperty: TProperty<number>;
    private _damping;
    private _force;
    private _targetValue;
    private harmonic;
    timeElapsed: number;
    constructor(providedOptions?: DampedAnimationOptions);
    /**
