...
declare class TransitionNode extends Node {
    private readonly transitionBoundsProperty;
    private readonly useBoundsClip;
    private readonly cachedNodes;
    private fromContent;
    private toContent;
    private transition;
    private paddingNode;
     ...
     * @param [options]
     */
    constructor(transitionBoundsProperty: TReadOnlyProperty<Bounds2>, providedOptions?: TransitionNodeOptions);
    /**
