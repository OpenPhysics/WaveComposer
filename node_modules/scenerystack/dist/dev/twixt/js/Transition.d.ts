...
type SelfOptions<TargetTypes> = {
    fromTargets: {
        [K in keyof TargetTypes]: AnimationTargetOptions<TargetTypes[K], Node>;
    };
    toTargets: {
        [K in keyof TargetTypes]: AnimationTargetOptions<TargetTypes[K], Node>;
    };
...
export type DissolveTransitionSelfOptions = {
    gamma?: number;
};
export type DissolveTransitionOptions = PartialTransitionOptions<number> & DissolveTransitionSelfOptions;
export type TransitionOptions<SelfType = unknown, SelfObjectType = unknown, TargetTypes = unknown[], TargetObjectTypes extends {
    [K in keyof TargetTypes]: Node;
} = {
    [K in keyof TargetTypes]: Node;
}> = SelfOptions<TargetTypes> & AnimationOptions<SelfType, SelfObjectType, TargetTypes, TargetObjectTypes>;
declare class Transition<SelfType = unknown, SelfObjectType = unknown, TargetTypes = unknown[], TargetObjectTypes extends {
    [K in keyof TargetTypes]: Node;
} = {
    [K in keyof TargetTypes]: Node;
}> extends Animation<SelfType, SelfObjectType, TargetTypes, TargetObjectTypes> {
    /**
     ...
     */
    constructor(fromNode: Node | null, toNode: Node | null, config: TransitionOptions);
    /**
     ...
     */
    static slideLeft(bounds: Bounds2, fromNode: Node | null, toNode: Node | null, options?: SlideTransitionOptions): Transition;
    /**
     ...
     * @param [options] - Usually specify duration, easing, or other Animation options.
     */
    static slideRight(bounds: Bounds2, fromNode: Node | null, toNode: Node | null, options?: SlideTransitionOptions): Transition;
    /**
     ...
     * @param [options] - Usually specify duration, easing, or other Animation options.
     */
    static slideUp(bounds: Bounds2, fromNode: Node | null, toNode: Node | null, options?: SlideTransitionOptions): Transition;
    /**
     ...
     * @param [options] - Usually specify duration, easing, or other Animation options.
     */
    static slideDown(bounds: Bounds2, fromNode: Node | null, toNode: Node | null, options?: SlideTransitionOptions): Transition;
    /**
     ...
     * @param [options] - Usually specify duration, easing, or other Animation options.
     */
    static wipeLeft(bounds: Bounds2, fromNode: Node | null, toNode: Node | null, options?: WipeTransitionOptions): Transition;
    /**
     ...
     * @param [options] - Usually specify duration, easing, or other Animation options.
     */
    static wipeRight(bounds: Bounds2, fromNode: Node | null, toNode: Node | null, options?: WipeTransitionOptions): Transition;
    /**
     ...
     * @param [options] - Usually specify duration, easing, or other Animation options.
     */
    static wipeUp(bounds: Bounds2, fromNode: Node | null, toNode: Node | null, options?: WipeTransitionOptions): Transition;
    /**
     ...
     * @param [options] - Usually specify duration, easing, or other Animation options.
     */
    static wipeDown(bounds: Bounds2, fromNode: Node | null, toNode: Node | null, options?: WipeTransitionOptions): Transition;
    /**
     ...
     */
    static dissolve(fromNode: Node | null, toNode: Node | null, providedOptions?: DissolveTransitionOptions): Transition;
    /**
