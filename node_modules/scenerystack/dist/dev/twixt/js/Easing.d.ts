...
declare class Easing {
    readonly value: NumberFunction;
    readonly derivative: NumberFunction;
    readonly secondDerivative: NumberFunction;
    /**
     ...
     */
    constructor(value: NumberFunction, derivative: NumberFunction, secondDerivative: NumberFunction);
    /**
     ...
     */
    static polynomialEaseInValue(n: number, t: number): number;
    /**
     ...
     * @param t - The linear ratio [0,1] of the animation
     */
    static polynomialEaseOutValue(n: number, t: number): number;
    /**
     ...
     * @param t - The linear ratio [0,1] of the animation
     */
    static polynomialEaseInOutValue(n: number, t: number): number;
    /**
     ...
     * @param t - The linear ratio [0,1] of the animation
     */
    static polynomialEaseInDerivative(n: number, t: number): number;
    /**
     ...
     * @param t - The linear ratio [0,1] of the animation
     */
    static polynomialEaseOutDerivative(n: number, t: number): number;
    /**
     ...
     * @param t - The linear ratio [0,1] of the animation
     */
    static polynomialEaseInOutDerivative(n: number, t: number): number;
    /**
     ...
     * @param t - The linear ratio [0,1] of the animation
     */
    static polynomialEaseInSecondDerivative(n: number, t: number): number;
    /**
     ...
     * @param t - The linear ratio [0,1] of the animation
     */
    static polynomialEaseOutSecondDerivative(n: number, t: number): number;
    /**
     ...
     * @param t - The linear ratio [0,1] of the animation
     */
    static polynomialEaseInOutSecondDerivative(n: number, t: number): number;
    /**
     * Creates a polynomial "in" easing (smooth start)
     *
     * @param n - The degree of the polynomial (does not have to be an integer!)
     */
    static polynomialEaseIn(n: number): Easing;
    /**
     * Creates a polynomial "out" easing (smooth end)
     *
     * @param n - The degree of the polynomial (does not have to be an integer!)
     */
    static polynomialEaseOut(n: number): Easing;
    /**
     * Creates a polynomial "in-out" easing (smooth start and end)
     *
     * @param n - The degree of the polynomial (does not have to be an integer!)
     */
    static polynomialEaseInOut(n: number): Easing;
    static readonly LINEAR: Easing;
    static readonly QUADRATIC_IN: Easing;
    static readonly QUADRATIC_OUT: Easing;
    static readonly QUADRATIC_IN_OUT: Easing;
