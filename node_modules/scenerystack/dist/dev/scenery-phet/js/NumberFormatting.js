 ...
 */
import { fluent_string_scenery_phet_a11y_scientificNotation_StringProperty } from './fluent-strings/a11y/scientificNotation.js';
import { fluent_string_scenery_phet_scientificNotation_StringProperty } from './fluent-strings/scientificNotation.js';
import { fluent_string_scenery_phet_a11y_negativeNumber_StringProperty } from './fluent-strings/a11y/negativeNumber.js';
import '../../globals.js';
...
import { DEFAULT_FORMATTED_NUMBER_ACCESSIBLE_OPTIONS, DEFAULT_FORMATTED_NUMBER_VISUAL_OPTIONS } from '../../axon/js/AccessibleStrings.js';
/**
 ...
 */
export const getFormattedNumber = (value, isAccessible, providedOptions) => {
    const options = optionize3()({}, getDefaultOptions(isAccessible), providedOptions);
    ...
    if (isNegative) {
        if (isAccessible && options.replaceMinusWithNegative) {
            absoluteValueOutput = fluent_string_scenery_phet_a11y_negativeNumber_StringProperty.format({ value: absoluteValueOutput });
        }
        else {
    ...
    if (options.useScientificNotation && exponent !== 0) {
        ...
        if (isAccessible) {
            absoluteValueOutput = fluent_string_scenery_phet_a11y_scientificNotation_StringProperty.format(formatArgs);
        }
        else {
            absoluteValueOutput = StringUtils.fillIn(fluent_string_scenery_phet_scientificNotation_StringProperty, formatArgs);
        }
    }
 ...
 */
const getDefaultOptions = (isAccessible) => {
 ...
 */
export const getFormattedVisualNumber = (value, providedOptions) => {
    return getFormattedNumber(value, false, providedOptions);
};
/**
 * Convenience function for getFormattedNumber with isAccessible = true
 */
export const getFormattedAccessibleNumber = (value, providedOptions) => {
 ...
 */
export const getFormattedNumberString = (value, isAccessible, options) => {
 ...
 */
export const getFormattedVisualNumberString = (value, options) => {
 ...
 */
export const getFormattedAccessibleNumberString = (value, options) => {
    return `${getFormattedNumber(value, true, options)}`;
};
/**
 * DerivedProperty that applies getFormattedNumber to a number Property.
 */
export const getFormattedNumberProperty = (valueProperty, isAccessible, providedOptions) => {
    ...
    return new DerivedProperty([
        ...
        ...(usesNegativeString ? fluent_string_scenery_phet_a11y_negativeNumber_StringProperty.getDependentProperties() : [])
    ], value => {
 ...
 */
export const getFormattedVisualNumberProperty = (valueProperty, providedOptions) => {
    return getFormattedNumberProperty(valueProperty, false, providedOptions);
};
/**
 * Convenience function for getFormattedNumberProperty with isAccessible = false
 */
export const getFormattedAccessibleNumberProperty = (valueProperty, providedOptions) => {
 ...
 */
export const getFormattedNumberStringProperty = (valueProperty, isAccessible, providedOptions) => {
 ...
 */
export const getFormattedVisualNumberStringProperty = (valueProperty, providedOptions) => {
 ...
 */
export const getFormattedAccessibleNumberStringProperty = (valueProperty, providedOptions) => {
 ...
 */
export const getDisposableNumberStringPatternProperty = (valueProperty, patternStringProperty, isAccessible, providedOptions) => {
 ...
 * For use in APIs where we return a single object to the user for them to dispose when they are done.
 */
export const getDisposableNumberStringFluentPatternProperty = (valueProperty, fluentPattern, isAccessible, providedOptions) => {
    const formattedNumberProperty = getFormattedNumberProperty(valueProperty, isAccessible, {
        numberFormatOptions: providedOptions?.numberFormatOptions
    });
 ...
 */
export const combineToDisposableDualString = (visualStringProperty, accessibleStringProperty) => {
