...
import { StepBackwardButtonOptions } from './StepBackwardButton.js';
import { StepForwardButtonOptions } from './StepForwardButton.js';
type SelfOptions = {
...
export default class PlayPauseStepButtonGroup extends HBox {
    readonly playPauseButton: PlayPauseButton;
    private readonly disposePlayPauseStepButtonGroup;
