...
export default class PlayStopButton extends PlayControlButton {
    constructor(isPlayingProperty, providedOptions) {
        const options = optionize()({
            ...
            endPlayingAccessibleName: string_scenery_phet_a11y_playControlButton_stop_StringProperty
        }, providedOptions);
        ...
        assert && self.phet?.chipper?.queryParameters?.binder && InstanceRegistry.registerDataURL('scenery-phet', 'PlayStopButton', this);
    }
}
