...
export default class PlayPauseStepButtonGroup extends HBox {
    constructor(isPlayingProperty, providedOptions) {
        ...
        const playingHelpText = options.playingHelpText || (eitherStepButtonVisible
            ? string_scenery_phet_a11y_playPauseStepButtonGroup_playingHelpText_StringProperty
            : null);
        const pausedHelpText = options.pausedHelpText || (eitherStepButtonVisible
            ? string_scenery_phet_a11y_playPauseStepButtonGroup_pausedHelpText_StringProperty
            : null);
