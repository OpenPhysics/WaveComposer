...
export default class ArrowNode extends Path {
    ...
    constructor(tailX, tailY, tipX, tipY, providedOptions) {
        ...
        assert && self.phet?.chipper?.queryParameters?.binder && InstanceRegistry.registerDataURL('scenery-phet', 'ArrowNode', this);
    }
    get tailX() { return this._tailX; }
    get tailY() { return this._tailY; }
    get tipX() { return this._tipX; }
    get tipY() { return this._tipY; }
    /**
