...
export default class GridNode extends Path {
     ...
     */
    constructor(transformProperty: TReadOnlyProperty<ModelViewTransform2>, spacing: number, center: Vector2, numberOfGridLines: number, providedOptions?: GridNodeOptions);
}
export {};
