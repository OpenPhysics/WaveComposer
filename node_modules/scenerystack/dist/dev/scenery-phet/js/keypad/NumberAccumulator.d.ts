...
declare class NumberAccumulator extends AbstractKeyAccumulator {
    readonly stringProperty: ReadOnlyProperty<string>;
    readonly valueProperty: ReadOnlyProperty<number | null>;
    constructor(providedOptions?: NumberAccumulatorOptions);
    /**
     ...
     */
    handleKeyPressed(keyID: KeyIDValue): void;
    /**
     ...
     */
    private getNumberOfDigitsLeftOfMantissa;
    /**
     * Gets the number of digits to the right of mantissa in the accumulator.
     */
    private getNumberOfDigitsRightOfMantissa;
    /**
