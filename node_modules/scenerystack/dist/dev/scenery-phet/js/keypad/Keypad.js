...
const WIDE_ZERO = new Key('0', KeyID.ZERO, { horizontalSpan: 2, keyboardIDs: ['0'] });
const DECIMAL = new Key('.', KeyID.DECIMAL, { keyboardIDs: ['period'] });
const BACKSPACE = new Key((new BackspaceIcon({ scale: 1.5 })), KeyID.BACKSPACE, { keyboardIDs: ['backspace'] });
...
function createKeyNode(keyObject, keyAccumulator, width, height, keyPadTandem, options) {
    ...
    const keyNode = new RectangularPushButton({
        ...
        tagName: keyObject.keyboardIDs.length === 0 ? 'button' : null, // Duplicated tagName with `ButtonNode`
        // phet-io
