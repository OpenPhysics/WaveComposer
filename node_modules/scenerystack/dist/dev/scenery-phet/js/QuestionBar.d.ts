...
export default class QuestionBar extends StatusBar {
    private readonly disposeQuestionBar;
    constructor(layoutBounds: Bounds2, visibleBoundsProperty: TReadOnlyProperty<Bounds2>, providedOptions: QuestionBarOptions);
    dispose(): void;
}
export {};
