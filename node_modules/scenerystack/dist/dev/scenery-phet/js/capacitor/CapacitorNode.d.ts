...
declare class CapacitorNode extends Node {
    /**
     ...
     */
    constructor(circuit: ParallelCircuit, modelViewTransform: YawPitchModelViewTransform3, plateChargeVisibleProperty: Property<boolean>, electricFieldVisibleProperty: Property<boolean>, options?: Object);
    capacitor: any;
    modelViewTransform: YawPitchModelViewTransform3;
    topPlateNode: PlateNode;
    bottomPlateNode: PlateNode;
    disposeCapacitorNode: () => void;
    /**
     ...
     * @public
     */
    public getTopPlateClipShapeToGlobal(): Shape;
    /**
     ...
     * @public
     */
    public getBottomPlateClipShapeToGlobal(): Shape;
    /**
     ...
     * @returns {Bounds2}
     */
    public getPlatesBounds(): Bounds2;
}
