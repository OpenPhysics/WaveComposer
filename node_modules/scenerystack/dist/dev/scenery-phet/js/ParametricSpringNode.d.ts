...
export default class ParametricSpringNode extends Node {
    readonly loopsProperty: NumberProperty;
    readonly radiusProperty: NumberProperty;
    readonly aspectRatioProperty: NumberProperty;
    readonly pointsPerLoopProperty: NumberProperty;
    readonly lineWidthProperty: NumberProperty;
    readonly phaseProperty: NumberProperty;
    readonly deltaPhaseProperty: NumberProperty;
    readonly xScaleProperty: NumberProperty;
    constructor(providedOptions?: ParametricSpringNodeOptions);
    reset(): void;
}
export {};
