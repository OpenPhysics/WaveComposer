...
export default class SpinningIndicatorNode extends Node {
    private indicatorRotation;
    private readonly angleDelta;
    private readonly speed;
    private readonly activeColorProperty;
    private readonly inactiveColorProperty;
    private readonly elements;
    constructor(providedOptions?: SpinningIndicatorNodeOptions);
    step(dt: number): void;
    dispose(): void;
    /**
     * Factory method for creating rectangle-shaped elements, sized to fit.
     */
    static rectangleFactory(diameter: number, numberOfElements: number): Rectangle;
    /**
     * Factory method for creating circle-shaped elements, sized to fit.
     */
    static circleFactory(diameter: number, numberOfElements: number): Circle;
}
export {};
