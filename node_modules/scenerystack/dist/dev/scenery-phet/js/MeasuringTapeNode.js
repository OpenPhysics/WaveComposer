...
class MeasuringTapeNode extends Node {
    constructor(unitsProperty, providedOptions) {
        ...
        const readoutStringProperty = new DerivedStringProperty([this.unitsProperty, this.measuredDistanceProperty, string_scenery_phet_measuringTapeReadoutPattern_StringProperty], (units, measuredDistance, measuringTapeReadoutPattern) => {
