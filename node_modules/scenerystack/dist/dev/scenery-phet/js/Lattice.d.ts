...
declare class Lattice {
    ...
    readonly dampX: number;
    readonly dampY: number;
    private readonly matrices;
    private readonly visitedMatrix;
    private readonly allowedMask;
    private currentMatrixIndex;
    readonly changedEmitter: Emitter<[]>;
    interpolationRatio: number;
    readonly visibleBounds: Bounds2;
    static readonly WAVE_SPEED = 0.5;
    /**
     ...
     */
    constructor(width: number, height: number, dampX: number, dampY: number);
    /**
     ...
     */
    getCenterLineValues(array: number[]): void;
    /**
     ...
     * @param value
     */
    setCurrentValue(i: number, j: number, value: number): void;
    /**
     ...
     * @param value
     */
    setLastValue(i: number, j: number, value: number): void;
    /**
     ...
     */
    setAllowed(i: number, j: number, allowed: boolean): void;
    /**
