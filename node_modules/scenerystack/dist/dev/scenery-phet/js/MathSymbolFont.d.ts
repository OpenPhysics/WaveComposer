...
export default class MathSymbolFont extends Font {
    static readonly FAMILY = "\"Times New Roman\", Times, serif";
    constructor(providedOptions?: number | string | MathSymbolFontOptions);
    /**
     ...
     */
    static getRichTextMarkup(text: string, style?: string): string;
    /**
     * Wraps a dynamic string in RichText markup that will display the string in the same font as MathSymbolFont.
     */
    static createDerivedProperty(symbolStringProperty: TReadOnlyProperty<string>, providedOptions?: CreateDerivedPropertyOptions): TReadOnlyProperty<string>;
}
export {};
