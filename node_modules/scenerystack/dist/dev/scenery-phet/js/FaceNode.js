...
export default class FaceNode extends Node {
    constructor(headDiameter, providedOptions) {
        ...
        options.headStroke = options.headStroke ||
            new DerivedProperty([headFillProperty], color => color.darkerColor());
        // Add head.
        ...
        assert && self.phet?.chipper?.queryParameters?.binder && InstanceRegistry.registerDataURL('scenery-phet', 'FaceNode', this);
    }
    smile() {
