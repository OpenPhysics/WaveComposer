...
export default class ConductivityTesterNode extends Node {
    ...
    constructor(brightnessProperty, positionProperty, positiveProbePositionProperty, negativeProbePositionProperty, providedOptions) {
        ...
        const shortCircuitNode = new Text(string_scenery_phet_shortCircuit_StringProperty, {
        ...
        assert && self.phet?.chipper?.queryParameters?.binder && InstanceRegistry.registerDataURL('scenery-phet', 'ConductivityTesterNode', this);
    }
    /**
