...
export type ConductivityTesterNodeOptions = SelfOptions & StrictOmit<NodeOptions, 'children'> & PickRequired<NodeOptions, 'tandem'>;
export default class ConductivityTesterNode extends Node {
    private readonly shortCircuitNode;
    /**
     ...
     */
    constructor(brightnessProperty: TReadOnlyProperty<number>, positionProperty: TProperty<Vector2>, positiveProbePositionProperty: TProperty<Vector2>, negativeProbePositionProperty: TProperty<Vector2>, providedOptions?: ConductivityTesterNodeOptions);
    /**
     * Is 'Short circuit' shown above the light bulb?
     */
    get shortCircuit(): boolean;
    /**
     ...
     */
    set shortCircuit(value: boolean);
}
export {};
