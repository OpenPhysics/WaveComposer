...
export default class ThermometerNode extends Node {
    private readonly temperatureLinearFunction;
    private readonly disposeThermometerNode;
    /**
     ...
     */
    constructor(temperatureProperty: TReadOnlyProperty<number | null>, minTemperature: number, maxTemperature: number, providedOptions?: ThermometerNodeOptions);
    dispose(): void;
    /**
