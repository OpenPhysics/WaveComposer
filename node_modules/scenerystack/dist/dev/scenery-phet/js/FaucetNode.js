...
const SHOOTER_WINDOW_BOUNDS = new Bounds2(10, 10, 90, 25); // bounds of the self in faucetBody_png, through which you see the shooter handle
...
class FaucetNode extends AccessibleSlider(Node, 0) {
    constructor(maxFlowRate, flowRateProperty, enabledProperty, providedOptions) {
        ...
        const shooterWindowNode = new Rectangle(SHOOTER_WINDOW_BOUNDS.minX, SHOOTER_WINDOW_BOUNDS.minY, SHOOTER_WINDOW_BOUNDS.maxX - SHOOTER_WINDOW_BOUNDS.minX, SHOOTER_WINDOW_BOUNDS.maxY - SHOOTER_WINDOW_BOUNDS.minY, { fill: 'rgb(107,107,107)' });
        ...
        // layout
        {
            ...
            // shooter self is in the body's coordinate frame
        ...
        assert && self.phet?.chipper?.queryParameters?.binder && InstanceRegistry.registerDataURL('scenery-phet', 'FaucetNode', this);
    }
    dispose() {
        this.disposeFaucetNode();
        super.dispose();
...
FaucetNode.ZERO_CLOSE_FAUCET_STRING = '0';
FaucetNode.CLOSE_FAUCET_HOTKEY_DATA = new HotkeyData({
    keys: [FaucetNode.ZERO_CLOSE_FAUCET_STRING, 'home'],
    repoName: sceneryPhet.name,
    keyboardHelpDialogLabelStringProperty: string_scenery_phet_keyboardHelpDialog_faucetControls_closeFaucet_StringProperty,
    keyboardHelpDialogPDOMLabelStringProperty: string_scenery_phet_a11y_keyboardHelpDialog_faucetControls_closeFaucetDescription_StringProperty
});
// The hotkey data for closing the faucet when `reverseAlternativeInput` is true.
FaucetNode.CLOSE_FAUCET_REVERSED_HOTKEY_DATA = new HotkeyData({
    keys: [FaucetNode.ZERO_CLOSE_FAUCET_STRING, 'end'],
    repoName: sceneryPhet.name,
    keyboardHelpDialogLabelStringProperty: string_scenery_phet_keyboardHelpDialog_faucetControls_closeFaucet_StringProperty,
    keyboardHelpDialogPDOMLabelStringProperty: string_scenery_phet_a11y_keyboardHelpDialog_faucetControls_closeFaucetWithEndDescription_StringProperty
});
