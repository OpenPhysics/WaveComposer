...
import { TimeSpeedRadioButtonGroupOptions } from './TimeSpeedRadioButtonGroup.js';
type SelfOptions = {
...
export default class TimeControlNode extends Node {
    ...
    private readonly speedRadioButtonGroup;
     ...
     */
    addPushButton(pushButton: RoundPushButton, index: number): void;
}
export {};
