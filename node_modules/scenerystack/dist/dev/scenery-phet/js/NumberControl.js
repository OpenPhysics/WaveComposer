...
class NumberControl extends WidthSizable(Node) {
    constructor(title, numberProperty, numberRange, providedOptions) {
        ...
        assert && self.phet?.chipper?.queryParameters?.binder && InstanceRegistry.registerDataURL('scenery-phet', 'NumberControl', this);
    }
    dispose() {
        this.disposeNumberControl();
        super.dispose();
