...
export default class ComboBoxDisplay<T> extends ComboBox<T> {
    private readonly disposeComboBoxDisplay;
    /**
     ...
     */
    constructor(choiceProperty: Property<T>, items: ComboBoxDisplayItem<T>[], listParent: Node, providedOptions?: ComboBoxDisplayOptions);
    dispose(): void;
}
export {};
