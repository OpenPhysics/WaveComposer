...
export default class GaugeNode extends Node {
    ...
    private readonly disposeGaugeNode;
    /**
     * @param valueProperty
     ...
     */
    constructor(valueProperty: TReadOnlyProperty<number>, labelProperty: TReadOnlyProperty<string>, range: Range, providedOptions?: GaugeNodeOptions);
    dispose(): void;
}
export {};
