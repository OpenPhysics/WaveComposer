...
export type PDOMSectionNodeOptions = SelfOptions & StrictOmit<NodeOptions, 'containerTagName' | 'tagName' | 'labelContent' | 'labelTagName'>;
export default class PDOMSectionNode extends Node {
    constructor(labelStringProperty: TReadOnlyProperty<string>, providedOptions?: PDOMSectionNodeOptions);
}
export {};
