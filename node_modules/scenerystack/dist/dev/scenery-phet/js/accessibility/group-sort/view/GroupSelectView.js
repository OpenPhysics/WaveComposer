...
const navigableStringProperty = string_scenery_phet_a11y_groupSort_navigable_StringProperty;
const sortableStringProperty = string_scenery_phet_a11y_groupSort_sortable_StringProperty;
class GroupSelectView extends Disposable {
    constructor(model, primaryFocusedNode, // Client is responsible for setting accessibleName and nothing else!
    providedOptions) {
