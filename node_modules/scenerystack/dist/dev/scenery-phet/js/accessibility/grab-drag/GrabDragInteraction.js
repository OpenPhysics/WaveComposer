...
// constants
const grabPatternStringStringProperty = string_scenery_phet_a11y_grabDrag_grabPattern_StringProperty;
const gestureHelpTextPatternStringProperty = string_scenery_phet_a11y_grabDrag_gestureHelpTextPattern_StringProperty;
const movableStringProperty = string_scenery_phet_a11y_grabDrag_movable_StringProperty;
const buttonStringProperty = string_scenery_phet_a11y_grabDrag_button_StringProperty;
const defaultObjectToGrabStringProperty = string_scenery_phet_a11y_grabDrag_defaultObjectToGrab_StringProperty;
const releasedStringProperty = string_scenery_phet_a11y_grabDrag_released_StringProperty;
const grabbedStringProperty = string_scenery_phet_a11y_grabDrag_grabbed_StringProperty;
...
export default class GrabDragInteraction extends Disposable {
    ...
    constructor(node, keyboardDragListener, interactionCueParent, providedOptions) {
        ...
        this.grabDragInteractiveHighlight = !ownsInteractiveHighlight ? node.interactiveHighlight :
        ...
        const inputEnabledListener = (nodeInputEnabled) => { this.grabDragModel.enabled = nodeInputEnabled; };
        ...
        if (isVoicing(node)) {
            ...
            this.onGrabButtonFocusEmitter.addListener(() => {
                if (this.grabDragModel.enabled && this.shouldShowGrabCueNode()) {
                    ...
                    alert.hintResponse = string_scenery_phet_a11y_grabDrag_spaceToGrabOrRelease_StringProperty;
