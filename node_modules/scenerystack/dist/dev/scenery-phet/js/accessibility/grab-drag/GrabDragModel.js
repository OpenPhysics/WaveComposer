...
export default class GrabDragModel extends EnabledComponent {
    constructor(grabDragUsageTracker = new GrabDragUsageTracker(), providedOptions) {
        ...
        this._releasedEmitter = new Emitter({ parameters: [{ validValues: InputTypeValues }] }); // called after setting to "idle" state
        this._grabbedEmitter = new Emitter({ parameters: [{ validValues: InputTypeValues }] }); // called after setting to "grabbed" state
    }
    get grabbedEmitter() { return this._grabbedEmitter; }
    get releasedEmitter() { return this._releasedEmitter; }
    /**
