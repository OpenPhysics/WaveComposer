...
export default class AccessibleListNode extends Node {
    constructor(listItems, providedOptions) {
        ...
        const collectedListItems = listItems.map(item => {
            const patternProperty = options.punctuationStyle === 'comma' ?
                string_scenery_phet_a11y_listItemPunctuation_commaPattern_StringProperty :
                string_scenery_phet_a11y_listItemPunctuation_semicolonPattern_StringProperty;
            ...
            return {
                ...
                periodStringProperty: new PatternStringProperty(string_scenery_phet_a11y_listItemPunctuation_periodPattern_StringProperty, { content: contentProperty })
            };
        });
        ...
        this.voicingContentStringProperty = DerivedProperty.deriveAny([...allVisibleProperties, ...allPunctuationStringProperties, options.leadingParagraphStringProperty].filter(property => !!property), () => {
