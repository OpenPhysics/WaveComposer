...
class StopwatchNode extends InteractiveHighlighting(Node) {
    constructor(stopwatch, providedOptions) {
        const options = optionize4()({}, AccessibleDraggableOptions, {
            // SelfOptions
            cursor: 'pointer',
        ...
        if (options.includePlayPauseResetButtons) {
            ...
            const playPauseButton = new BooleanRectangularToggleButton(stopwatch.isRunningProperty, pausePath, playPath, combineOptions({
                ...
                accessibleName: new DerivedProperty([
                    ...
                    string_scenery_phet_a11y_stopwatch_pauseButton_accessibleName_StringProperty,
                    string_scenery_phet_a11y_stopwatch_playButton_accessibleName_StringProperty
        ...
        if (options.dragBoundsProperty) {
            ...
            // interrupt user interactions when the visible bounds changes, such as a device orientation change or self resize
        ...
        assert && self.phet?.chipper?.queryParameters?.binder && InstanceRegistry.registerDataURL('scenery-phet', 'StopwatchNode', this);
    }
    dispose() {
        this.disposeStopwatchNode();
        super.dispose();
    ...
    static createRichTextNumberFormatter(providedOptions) {
        const options = optionize()({
            ...
            valueUnitsPattern: string_scenery_phet_stopwatchValueUnitsPattern_StringProperty
        }, providedOptions);
        return (time) => {
