...
import { HeaterCoolerBackOptions } from './HeaterCoolerBack.js';
import { HeaterCoolerFrontOptions } from './HeaterCoolerFront.js';
type SelfOptions = {
...
export default class HeaterCoolerNode extends Node {
    readonly heatCoolAmountProperty: NumberProperty;
    readonly slider: VSlider;
    private readonly disposeHeaterCoolerNode;
    /**
