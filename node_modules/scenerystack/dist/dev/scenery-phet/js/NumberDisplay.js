    ...
    constructor(numberProperty, displayRange, providedOptions) {
        ...
        if (assert) {
            ...
            if (numberFormatterProvided || formatInfoProvided) {
                assert && assert(numberFormatterProvided !== formatInfoProvided, 'options.numberFormatter is mutually exclusive with options.valuePattern, options.decimalPlaces, and options.numberFormatOptions');
            }
        }
