...
declare class Bucket extends PhetioObject {
    position: Vector2;
    readonly baseColor: TColor | null;
    readonly captionText: string | TReadOnlyProperty<string>;
    readonly captionColor: TColor;
    readonly size: Dimension2;
    readonly holeShape: Shape;
    readonly containerShape: Shape;
    constructor(providedOptions?: BucketOptions);
}
