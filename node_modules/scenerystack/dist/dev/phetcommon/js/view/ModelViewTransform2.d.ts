...
declare class ModelViewTransform2 extends Transform3 {
    ...
    protected validateMatrix(matrix: Matrix3): void;
    /**
     ...
     */
    static createIdentity(): ModelViewTransform2;
    /**
     ...
     */
    static createOffsetScaleMapping(offset: Vector2, scale: number): ModelViewTransform2;
    /**
     ...
     */
    static createOffsetXYScaleMapping(offset: Vector2, xScale: number, yScale: number): ModelViewTransform2;
    /**
     ...
     */
    static createSinglePointXYScaleMapping(modelPoint: Vector2, viewPoint: Vector2, xScale: number, yScale: number): ModelViewTransform2;
    /**
     * Creates a shearless ModelViewTransform2 that maps the specified model point to the specified view point,
     ...
     */
    static createSinglePointScaleMapping(modelPoint: Vector2, viewPoint: Vector2, scale: number): ModelViewTransform2;
    /**
     * Creates a shearless ModelViewTransform2 that maps the specified model point to the specified view point,
     ...
     * @param scale - the amount to scale in the x and y directions
     */
    static createSinglePointScaleInvertedYMapping(modelPoint: Vector2, viewPoint: Vector2, scale: number): ModelViewTransform2;
    /**
     ...
     */
    static createRectangleMapping(modelBounds: Bounds2, viewBounds: Bounds2): ModelViewTransform2;
    /**
     * Creates a shearless ModelViewTransform2 that maps the specified rectangle in the model to the specified rectangle
     * in the view, so that any point x% of the way across and y% down in the model rectangle will be mapped to the
     ...
     * @param viewBounds - the reference rectangle in the view, must have area > 0
     */
    static createRectangleInvertedYMapping(modelBounds: Bounds2, viewBounds: Bounds2): ModelViewTransform2;
}
