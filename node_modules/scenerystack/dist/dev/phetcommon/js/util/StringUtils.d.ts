...
declare namespace StringUtils {
    function format(pattern: string, ...args: any[]): string;
    function fillIn(template: string | TReadOnlyProperty<string>, values: Object): string;
    function isEmbeddingMark(chr: any): boolean;
    function embeddedSlice(string: string, startIndex: number, endIndex?: number): string;
    function embeddedSplit(string: any, separator: any, limit: any): any;
    function embeddedDebugString(string: string): string;
    function wrapLTR(string: string): string;
    function wrapRTL(string: string): string;
    function wrapDirection(string: string, direction: string): string;
    function localeToLocalizedName(locale: string): string;
    /**
     ...
     * @returns {string}
     */
    function toFixedLTR(number: number, digits: number): string;
    /**
     ...
     * @returns {string}
     */
    function toFixedNumberLTR(number: number, digits: number): string;
}
