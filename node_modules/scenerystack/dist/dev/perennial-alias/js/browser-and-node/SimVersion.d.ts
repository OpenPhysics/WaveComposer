...
export default class SimVersion implements SimVersionSerialized {
    ...
    readonly testNumber: number | null;
     ...
     */
    constructor(major: number | string, minor: number | string, maintenance: number | string, options?: SimVersionOptions);
    /**
     * Convert into a plain JS object meant for JSON serialization.
     */
    serialize(): SimVersionSerialized;
    /**
     * @ignore - not needed by PhET-iO Clients
     */
    get isSimNotPublished(): boolean;
    /**
     * @ignore - not needed by PhET-iO Clients
     */
    get isSimPublished(): boolean;
    get majorMinor(): string;
    /**
     * Takes a serialized form of the SimVersion and returns an actual instance.
     */
    static deserialize({ major, minor, maintenance, testType, testNumber, buildTimestamp }: SimVersionSerialized): SimVersion;
    /**
     ...
     */
    compareNumber(version: SimVersion): number;
    /**
     ...
     * @returns {SimVersion}
     */
    static parse(versionString: string, buildTimestamp?: string): SimVersion;
    /**
     ...
     * @returns {SimVersion}
     */
    static fromBranch(branch: string): SimVersion;
    /**
     ...
     * @ignore - not needed by PhET-iO Clients
     */
    static ensureReleaseBranch(branch: string): void;
}
export {};
