...
export default class Vector2 implements TPoolable {
    ...
    freeToPool(): void;
    static readonly pool: Pool<typeof Vector2>;
    /**
     ...
     */
    static from(vector2Like: PartialVector2State): Vector2;
    /**
    ...
    static Vector2IO: AnyIOType;
}
declare const v2: (x: number, y: number) => Vector2;
declare const STATE_SCHEMA: {
    x: IOType<number, number, number>;
    y: IOType<number, number, number>;
};
