...
declare namespace Stats {
     ...
     * @returns {number|null}
     */
    function getPercentile(numbers: Array<number>, percentile: number): number | null;
    /**
     ...
     */
    function median(numbers: Array<number>): number | null;
    /**
     ...
     */
    function getBoxPlotValues(numbers: Array<number>): {
        q1: number;
        median: number;
        q3: number;
    };
     ...
     * @returns {Object}
     */
    function getBoxPlotLimits(numbers: Array<number>): Object;
}
