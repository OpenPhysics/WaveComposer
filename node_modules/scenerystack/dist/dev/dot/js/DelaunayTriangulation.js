...
class DelaunayTriangulation {
    ...
    constrainEdges(vertex, rightFrontEdge, leftFrontEdge) {
        ...
        for (let i = 0; i < vertex.constrainedVertices.length; i++) {
            ...
            self.triDebug && self.triDebug(this);
...
class Edge {
    ...
    intersectsConstrainedEdge(vertex, bottomVertex) {
        return lineSegmentIntersection(vertex.point.x, vertex.point.y, bottomVertex.point.x, bottomVertex.point.y, this.startVertex.point.x, this.startVertex.point.y, this.endVertex.point.x, this.endVertex.point.y);
    }
}
class Triangle {
    /**
    ...
    constructor(aVertex, bVertex, cVertex, aEdge, bEdge, cEdge) {
        ...
        assert && assert(triangleAreaSigned(aVertex.point, bVertex.point, cVertex.point) > 0, 'Should be counterclockwise');
        // @public {Vertex}
    ...
    getNonArtificialEdge() {
        assert && assert((this.aEdge.isArtificial() && this.bEdge.isArtificial() && !this.cEdge.isArtificial()) ||
            ...
            (!this.aEdge.isArtificial() && this.bEdge.isArtificial() && this.cEdge.isArtificial()) ||
            (this.aEdge.isArtificial() && this.bEdge.isArtificial() && this.cEdge.isArtificial()), 'At most one edge should be non-artificial');
