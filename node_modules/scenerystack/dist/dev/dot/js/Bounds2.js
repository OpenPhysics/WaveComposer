...
class Bounds2 {
    ...
    get xRange() { return this.getXRange(); }
    set xRange(range) { this.setXRange(range); }
    /**
    ...
    get yRange() { return this.getYRange(); }
    set yRange(range) { this.setYRange(range); }
    /**
