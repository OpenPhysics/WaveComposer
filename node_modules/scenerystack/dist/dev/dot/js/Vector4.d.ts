...
export default class Vector4 implements TPoolable {
     ...
     */
    toStateObject(): Vector4StateObject;
    freeToPool(): void;
    static readonly pool: Pool<typeof Vector4>;
    /**
     * Constructs a Vector3 from a duck-typed object, for use with tandem/phet-io deserialization.
     */
    static fromStateObject(stateObject: Vector4StateObject): Vector4;
    /**
     ...
     */
    static from(vector4Like: PartialVector4State, defaultW?: number): Vector4;
    isVector4: boolean;
    dimension: number;
    static ZERO: Vector4;
...
declare const v4: (x: number, y: number, z: number, w: number) => Vector4;
export { v4 };
