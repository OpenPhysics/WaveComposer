...
declare const STATE_SCHEMA: {
    width: IOType<number, import("../../tandem/js/types/InfiniteNumberIO.js").InfiniteNumberStateObject, import("../../tandem/js/types/InfiniteNumberIO.js").InfiniteNumberStateObject>;
    height: IOType<number, import("../../tandem/js/types/InfiniteNumberIO.js").InfiniteNumberStateObject, import("../../tandem/js/types/InfiniteNumberIO.js").InfiniteNumberStateObject>;
    depth: IOType<number, import("../../tandem/js/types/InfiniteNumberIO.js").InfiniteNumberStateObject, import("../../tandem/js/types/InfiniteNumberIO.js").InfiniteNumberStateObject>;
};
...
export default class Dimension3 {
    ...
    static fromStateObject(stateObject: Dimension3StateObject): Dimension3;
    static Dimension3IO: IOType<Dimension3, StateObject<{
        width: IOType<number, import("../../tandem/js/types/InfiniteNumberIO.js").InfiniteNumberStateObject, import("../../tandem/js/types/InfiniteNumberIO.js").InfiniteNumberStateObject>;
        height: IOType<number, import("../../tandem/js/types/InfiniteNumberIO.js").InfiniteNumberStateObject, import("../../tandem/js/types/InfiniteNumberIO.js").InfiniteNumberStateObject>;
        depth: IOType<number, import("../../tandem/js/types/InfiniteNumberIO.js").InfiniteNumberStateObject, import("../../tandem/js/types/InfiniteNumberIO.js").InfiniteNumberStateObject>;
    }>, StateObject<{
