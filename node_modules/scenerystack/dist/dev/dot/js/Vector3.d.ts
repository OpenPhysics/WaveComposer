...
export default class Vector3 implements TPoolable {
    ...
    freeToPool(): void;
    static readonly pool: Pool<typeof Vector3>;
    /**
     ...
     */
    static from(vector3Like: PartialVector3State): Vector3;
    isVector3: boolean;
    dimension: number;
    static ZERO: Vector3;
    ...
    static Vector3IO: AnyIOType;
}
declare const v3: (x: number, y: number, z: number) => Vector3;
export { v3 };
