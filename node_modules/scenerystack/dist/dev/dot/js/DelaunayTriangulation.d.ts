...
declare class DelaunayTriangulation {
    /**
     ...
     * @returns {number}
     */
    private static vertexComparison;
    /**
     ...
     */
    constructor(points: Array<Vector2>, constraints: Array<Array<number>>, options?: Object);
    points: Vector2[];
    constraints: number[][];
    triangles: any[];
    edges: any[];
    ...
    bottomVertex: any;
    remainingVertices: any[] | undefined;
    artificialMinVertex: any;
    artificialMaxVertex: any;
    firstFrontEdge: any;
    firstHullEdge: any;
    /**
