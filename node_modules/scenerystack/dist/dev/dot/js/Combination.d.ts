...
declare class Combination {
     ...
     */
    static full(size: number): Combination;
    /**
     * Lists all combinations from a given size
     */
    static combinations(size: number): Combination[];
    /**
     ...
     */
    static forEachCombination<T>(array: T[], callback: (array: readonly T[]) => void): void;
    static combinationsOf<T>(array: T[]): T[][];
}
