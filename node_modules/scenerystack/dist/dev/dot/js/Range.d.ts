...
declare const STATE_SCHEMA: {
    min: IOType<number, import("../../tandem/js/types/InfiniteNumberIO.js").InfiniteNumberStateObject, import("../../tandem/js/types/InfiniteNumberIO.js").InfiniteNumberStateObject>;
    max: IOType<number, import("../../tandem/js/types/InfiniteNumberIO.js").InfiniteNumberStateObject, import("../../tandem/js/types/InfiniteNumberIO.js").InfiniteNumberStateObject>;
};
export type RangeStateObject = StateObject<typeof STATE_SCHEMA>;
declare class Range implements TRange {
    private _min;
    private _max;
    /**
    ...
    static fromStateObject(stateObject: RangeStateObject): Range;
    static RangeIO: IOType<Range, StateObject<{
        min: IOType<number, import("../../tandem/js/types/InfiniteNumberIO.js").InfiniteNumberStateObject, import("../../tandem/js/types/InfiniteNumberIO.js").InfiniteNumberStateObject>;
        max: IOType<number, import("../../tandem/js/types/InfiniteNumberIO.js").InfiniteNumberStateObject, import("../../tandem/js/types/InfiniteNumberIO.js").InfiniteNumberStateObject>;
    }>, StateObject<{
        min: IOType<number, import("../../tandem/js/types/InfiniteNumberIO.js").InfiniteNumberStateObject, import("../../tandem/js/types/InfiniteNumberIO.js").InfiniteNumberStateObject>;
    ...
    static readonly EVERYTHING: Range;
    static readonly NOTHING: Range;
}
