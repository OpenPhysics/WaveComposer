...
import { InfiniteNumberStateObject } from '../../tandem/js/types/InfiniteNumberIO.js';
...
export default class Bounds2 implements TPoolable {
     ...
     */
    static create(bounds: Bounds2Like): Bounds2;
    /**
    ...
    freeToPool(): void;
    static readonly pool: Pool<typeof Bounds2>;
    /**
    ...
    static point(v: Vector2): Bounds2;
    isBounds: boolean;
    dimension?: number;
    /**
     ...
     */
    static readonly NOTHING: Bounds2;
    /**
     ...
     */
    static readonly EVERYTHING: Bounds2;
    static readonly Bounds2IO: IOType<Bounds2, Bounds2StateObject, Bounds2StateObject>;
}
export {};
