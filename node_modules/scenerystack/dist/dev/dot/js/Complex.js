...
class Complex {
     ...
     */
    sinOf() {
        return new Complex(Math.sin(this.real) * cosh(this.imaginary), Math.cos(this.real) * sinh(this.imaginary));
    }
    /**
     * Cosine.
     ...
     */
    cosOf() {
        return new Complex(Math.cos(this.real) * cosh(this.imaginary), -Math.sin(this.real) * sinh(this.imaginary));
    }
    /**
     ...
     */
    sin() {
        return this.setRealImaginary(Math.sin(this.real) * cosh(this.imaginary), Math.cos(this.real) * sinh(this.imaginary));
    }
    /**
     * Cosine.
     ...
     */
    cos() {
        return this.setRealImaginary(Math.cos(this.real) * cosh(this.imaginary), -Math.sin(this.real) * sinh(this.imaginary));
    }
    /**
     * Complex conjugate.
