...
declare class UnivariatePolynomial {
    ...
    dividedBy(polynomial: UnivariatePolynomial): {
        quotient: UnivariatePolynomial;
        remainder: UnivariatePolynomial;
    };
    ...
    getRoots(): Complex[];
    static singleCoefficient(coefficient: number, degree: number): UnivariatePolynomial;
    static readonly ZERO: UnivariatePolynomial;
}
