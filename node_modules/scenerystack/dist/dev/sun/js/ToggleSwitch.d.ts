...
declare const ToggleSwitch_base: typeof Node & import("../../phet-core.js").Constructor<import("../../scenery/js/accessibility/voicing/Voicing.js").TVoicing<Node>>;
export default class ToggleSwitch<T> extends ToggleSwitch_base {
    private readonly disposeToggleSwitch;
    readonly switchToLeftSoundPlayer: TSoundPlayer;
    readonly switchToRightSoundPlayer: TSoundPlayer;
