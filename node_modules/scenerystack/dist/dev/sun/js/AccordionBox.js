...
class AccordionBox extends Sizable(Node) {
    /**
    ...
    constructor(contentNode, providedOptions) {
        ...
        assert && self.phet?.chipper?.queryParameters?.binder && InstanceRegistry.registerDataURL('sun', 'AccordionBox', this);
...
class AccordionBoxConstraint extends LayoutConstraint {
    ...
    layout() {
        ...
        let minimumBoxWidth = Math.max(options.minWidth, options.buttonXMargin + this.expandCollapseButton.width + options.titleXSpacing + minimumTitleWidth + options.titleXMargin);
