...
import { type TVoicingNode } from '../../scenery/js/accessibility/voicing/Voicing.js';
...
export default class ComboBoxListBox<T> extends Panel {
    ...
    private readonly disposeComboBoxListBox;
    private readonly voiceOnSelectionNode;
    private selectionOnFireAction;
    /**
     * @param property
     * @param items
     * @param nodes
     ...
     */
    constructor(property: TProperty<T>, items: ComboBoxItemNoNode<T>[], nodes: Node[], hideListBoxCallback: () => void, focusButtonCallback: () => void, voiceOnSelectionNode: TVoicingNode, tandem: Tandem, providedOptions?: ComboBoxListBoxOptions);
    dispose(): void;
    /**
     ...
     */
    focusListItemNode(value: T): void;
    /**
     ...
     */
    private voiceOnNewSelection;
    static getMaxItemWidthProperty(nodes: Node[]): TReadOnlyProperty<number>;
    static getMaxItemHeightProperty(nodes: Node[]): TReadOnlyProperty<number>;
}
export {};
