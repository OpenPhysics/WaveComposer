...
export default class AquaRadioButtonGroup extends FlowBox {
    constructor(property, items, providedOptions) {
        ...
        const radioButtons = items.map((item, index) => {
            ...
            assert && assert(!node.hasPDOMContent, 'Accessibility is provided by AquaRadioButton and accessibleName of the AquaRadioButtonGroupItem options. ' +
        ...
        const radioButtonGroupFocusListener = new RadioButtonGroupFocusListener(this, options.voicingHintResponse || options.accessibleHelpText || null, options.speakVoicingNameResponseOnFocus, options.voicingNameResponse || options.accessibleName || null);
        // Remove it
