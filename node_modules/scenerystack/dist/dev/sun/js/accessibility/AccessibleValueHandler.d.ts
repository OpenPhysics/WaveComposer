...
import { type TVoicing, type VoicingOptions } from '../../../scenery/js/accessibility/voicing/Voicing.js';
...
export type AccessibleValueHandlerOptions = SelfOptions & VoicingOptions;
 ...
 */
declare const AccessibleValueHandler: {
    <SuperType extends Constructor<Node>>(Type: SuperType, optionsArgPosition: number): SuperType & Constructor<TAccessibleValueHandler>;
