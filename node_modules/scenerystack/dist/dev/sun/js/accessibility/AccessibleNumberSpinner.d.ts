...
import { type AccessibleValueHandlerOptions, type TAccessibleValueHandler } from './AccessibleValueHandler.js';
type SelfOptions = {
 ...
 */
declare const AccessibleNumberSpinner: <SuperType extends Constructor<Node>>(Type: SuperType, optionsArgPosition: number) => SuperType & Constructor<TAccessibleNumberSpinner>;
