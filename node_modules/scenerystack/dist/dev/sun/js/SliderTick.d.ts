...
export default class SliderTick {
    ...
    private readonly labelXProperty;
    readonly tickNode: Node;
    private readonly labelManualConstraint?;
    private readonly labelContainer?;
    constructor(parent: Node, value: number, label: Node | undefined, length: number, stroke: TPaint, lineWidth: number, tickOptions: Required<SliderTickOptions>, orientation: Orientation, track: SliderTrack);
    dispose(): void;
}
