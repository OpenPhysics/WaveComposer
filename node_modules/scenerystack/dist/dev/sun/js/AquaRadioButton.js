...
class AquaRadioButton extends WidthSizable(Voicing(Node)) {
    /**
     * @param property
    ...
    constructor(property, value, labelNode, providedOptions) {
        assert && assert(property.valueComparisonStrategy === 'reference', 'AquaRadioButton depends on "===" equality for value comparison');
        ...
        assert && self.phet?.chipper?.queryParameters?.binder && InstanceRegistry.registerDataURL('sun', 'AquaRadioButton', this);
    }
    dispose() {
        this.disposeAquaRadioButton();
        super.dispose();
