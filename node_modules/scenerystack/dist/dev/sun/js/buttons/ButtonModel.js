...
export default class ButtonModel extends EnabledComponent {
    ...
    createPressListener(options) {
        ...
        this.overOrFocusedMultilink = Multilink.multilinkAny(overOrFocusedProperties, (...args) => {
            this.isOverOrFocusedProperty.value = _.reduce(args, (sum, newValue) => sum || newValue, false);
        });
