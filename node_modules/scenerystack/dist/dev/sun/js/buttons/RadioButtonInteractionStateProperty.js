...
export default class RadioButtonInteractionStateProperty extends DerivedProperty5 {
    ...
    constructor(buttonModel, property, value) {
        super([buttonModel.focusedProperty, buttonModel.overProperty, buttonModel.isOverOrFocusedProperty, buttonModel.looksPressedProperty, property], (focused, over, overOrFocused, looksPressed, propertyValue) => {
