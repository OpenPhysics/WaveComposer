...
export default class MomentaryButtonInteractionStateProperty extends DerivedProperty3 {
    constructor(buttonModel) {
        super([buttonModel.isOverOrFocusedProperty, buttonModel.looksPressedProperty, buttonModel.valueProperty], (overOrFocused, looksPressed, buttonValue) => {
