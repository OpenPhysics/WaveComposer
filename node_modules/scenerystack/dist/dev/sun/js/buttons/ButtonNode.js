...
export default class ButtonNode extends Sizable(Voicing(Node)) {
    ...
    constructor(buttonModel, buttonBackground, interactionStateProperty, providedOptions) {
        ...
        super();
        this.contentContainer = null; // (sun-only)
