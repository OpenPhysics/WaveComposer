...
import { type VoicingOptions } from '../../../scenery/js/accessibility/voicing/Voicing.js';
import { type AlignBoxXAlign, type AlignBoxYAlign } from '../../../scenery/js/layout/nodes/AlignBox.js';
...
declare const ButtonNode_base: typeof Node & import("../../../phet-core.js").Constructor<import("../../../scenery/js/accessibility/voicing/Voicing.js").TVoicing<Node>> & import("../../../phet-core.js").Constructor<import("../../../scenery/js/layout/Sizable.js").TSizable>;
export default class ButtonNode extends ButtonNode_base {
    protected buttonModel: ButtonModel;
    private readonly _settableBaseColorProperty;
    private readonly _disabledColorProperty;
    private readonly baseColorProperty;
    private readonly _pressListener;
    private readonly disposeButtonNode;
    protected readonly content: Node | null;
    readonly contentContainer: Node | null;
    protected readonly layoutSizeProperty: TinyProperty<Dimension2>;
    private _accessibleContextResponse;
    protected readonly maxLineWidth: number;
    static FlatAppearanceStrategy: TButtonAppearanceStrategy;
    /**
     * @param buttonModel
     ...
     */
    protected constructor(buttonModel: ButtonModel, buttonBackground: Path, interactionStateProperty: TReadOnlyProperty<ButtonInteractionState>, providedOptions?: ButtonNodeOptions);
    dispose(): void;
    /**
     * Sets the base color, which is the main background fill color used for the button.
     */
    setBaseColor(baseColor: TColor): void;
    set baseColor(baseColor: TColor);
    get baseColor(): TColor;
    /**
     ...
     */
    setAccessibleContextResponse(response: TAlertable): void;
    set accessibleContextResponse(response: TAlertable);
    get accessibleContextResponse(): TAlertable;
    /**
     * Returns the context response that is spoken when the button is pressed.
     */
    getAccessibleContextResponse(): TAlertable;
    /**
 ...
 */
export declare class FlatAppearanceStrategy {
    readonly maxLineWidth: number;
    private readonly disposeFlatAppearanceStrategy;
    /**
     ...
     */
    constructor(buttonBackground: PaintableNode, interactionStateProperty: TReadOnlyProperty<ButtonInteractionState>, baseColorProperty: TReadOnlyProperty<Color>, providedOptions?: TButtonAppearanceStrategyOptions);
    dispose(): void;
}
export {};
