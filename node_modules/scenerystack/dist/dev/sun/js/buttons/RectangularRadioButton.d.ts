...
export type RectangularRadioButtonOptions = SelfOptions & StrictOmit<TrimParallelDOMOptions<RectangularButtonOptions>, 'enabledProperty' | 'enabled' | 'voicingFocusListener'>;
export default class RectangularRadioButton<T> extends RectangularButton {
    readonly property: TProperty<T>;
    readonly value: T;
    readonly interactionStateProperty: RadioButtonInteractionStateProperty<T>;
    private readonly firedEmitter;
    private readonly disposeRectangularRadioButton;
    /**
     ...
     */
    constructor(property: TProperty<T>, value: T, providedOptions?: RectangularRadioButtonOptions);
    dispose(): void;
    /**
     ...
     */
    static readonly FlatAppearanceStrategy: TButtonAppearanceStrategy;
    /**
     ...
     */
    static readonly ContentAppearanceStrategy: TContentAppearanceStrategy;
}
export {};
