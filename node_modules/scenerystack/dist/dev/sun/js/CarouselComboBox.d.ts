...
import { type ComboBoxButtonOptions } from './ComboBoxButton.js';
import { type PageControlOptions } from './PageControl.js';
type SelfOptions = {
...
declare const CarouselComboBox_base: typeof Node & import("../../phet-core.js").Constructor<import("../../scenery/js/layout/WidthSizable.js").TWidthSizable>;
export default class CarouselComboBox<T> extends CarouselComboBox_base {
    private readonly disposeCarouselComboBox;
    /**
     ...
     */
    constructor(property: TProperty<T>, comboBoxItems: ComboBoxItem<T>[], providedOptions?: CarouselComboBoxOptions);
    dispose(): void;
}
