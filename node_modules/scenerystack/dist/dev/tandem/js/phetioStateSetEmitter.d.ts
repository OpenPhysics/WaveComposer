...
export declare const writablePhetioStateSetEmitter: TEmitter<[FullPhetioState, Tandem]>;
declare const phetioStateSetEmitter: TReadOnlyEmitter<[FullPhetioState, Tandem]>;
