...
class PhetioGroup extends PhetioDynamicElementContainer {
    ...
    createIndexedElement(index, argsForCreateFunction, fromStateSetting = false) {
        ...
        assert && this.supportsDynamicState && _.hasIn(self, 'phet.joist.sim') &&
            assert && isSettingPhetioStateProperty.value && this.isPhetioInstrumented() && assert(fromStateSetting, 'dynamic elements should only be created by the state engine when setting state.');
