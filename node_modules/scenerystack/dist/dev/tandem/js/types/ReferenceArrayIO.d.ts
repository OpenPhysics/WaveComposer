 ...
 */
declare const ReferenceArrayIO: <ParameterType, ParameterStateType>(parameterType: IOType<ParameterType, ParameterStateType>) => IOType<ParameterType[], ParameterStateType[]>;
