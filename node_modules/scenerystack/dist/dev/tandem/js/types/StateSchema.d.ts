...
export default class StateSchema<T, SelfStateType> {
    private readonly displayString;
    private readonly validator;
    readonly compositeSchema: null | CompositeSchema<SelfStateType>;
    readonly apiStateKeys: APIStateKeys | null;
    constructor(providedOptions?: StateSchemaOptions<SelfStateType>);
    /**
     ...
     */
    defaultApplyState(coreObject: T, stateObject: CompositeStateObjectType): void;
    /**
     ...
     */
    private getCoreObjectAccessorName;
    /**
     ...
     */
    static asValue<T, StateType>(displayString: string, validator: Validator<IntentionalAny>): StateSchema<T, StateType>;
}
export {};
