...
const packageJSON = _.hasIn(self, 'phet.chipper.packageObject') ? phet.chipper.packageObject : { name: 'placeholder' };
 ...
 * @type {Tandem}
 */
Tandem.GENERAL = Tandem.ROOT.createTandem(PhetioIDUtils.GENERAL_COMPONENT_NAME);
/**
 * Used in unit tests
 */
 ...
 */
Tandem.GENERAL_MODEL = Tandem.GENERAL.createTandem(PhetioIDUtils.MODEL_COMPONENT_NAME);
/**
 * Tandem for view simulation elements that are general to all sims.
 */
Tandem.GENERAL_VIEW = Tandem.GENERAL.createTandem(PhetioIDUtils.VIEW_COMPONENT_NAME);
/**
 * Tandem for controller simulation elements that are general to all sims.
 */
Tandem.GENERAL_CONTROLLER = Tandem.GENERAL.createTandem(PhetioIDUtils.CONTROLLER_COMPONENT_NAME);
/**
 ...
 * @type {Tandem}
 */
Tandem.GLOBAL = Tandem.ROOT.createTandem(PhetioIDUtils.GLOBAL_COMPONENT_NAME);
/**
 ...
 */
Tandem.GLOBAL_MODEL = Tandem.GLOBAL.createTandem(PhetioIDUtils.MODEL_COMPONENT_NAME);
/**
 * View simulation elements that don't belong in specific screens should be nested under this Tandem. Note that this
 * tandem should only have simulation specific elements in them.
 */
Tandem.GLOBAL_VIEW = Tandem.GLOBAL.createTandem(PhetioIDUtils.VIEW_COMPONENT_NAME);
/**
 * Colors used in the simulation.
 */
Tandem.COLORS = Tandem.GLOBAL_VIEW.createTandem(PhetioIDUtils.COLORS_COMPONENT_NAME);
/**
 * Colors used in the simulation.
 */
Tandem.STRINGS = Tandem.GENERAL_MODEL.createTandem(PhetioIDUtils.STRINGS_COMPONENT_NAME);
/**
...
class GroupTandem extends Tandem {
     ...
     */
    constructor(parentTandem, groupName, groupMemberIndex // for generating indices from a pool
    ) {
