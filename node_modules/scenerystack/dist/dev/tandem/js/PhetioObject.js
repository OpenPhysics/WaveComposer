...
class PhetioObject extends Disposable {
    ...
    initializePhetioObject(baseOptions, providedOptions) {
        ...
        if (self.phet.preloads.phetio.phetioElementsOverrides) {
            const overrides = self.phet.preloads.phetio.phetioElementsOverrides[archetypalPhetioID];
            if (overrides) {
    ...
    phetioStartEvent(event, providedOptions) {
        if (PHET_IO_ENABLED && this.isPhetioInstrumented()) {
            ...
            if (!_.hasIn(self, 'phet.phetio.dataStream')) {
            ...
            const skipHighFrequencyEvent = this.phetioHighFrequency &&
                _.hasIn(self, 'phet.preloads.phetio.queryParameters') &&
                !self.phet.preloads.phetio.queryParameters.phetioEmitHighFrequencyEvents &&
            ...
            let skipFromUndefinedDatastream = !_.hasIn(self, 'phet.phetio.dataStream');
            if (assert) {
    ...
    hasTargetProperty() { return false; }
    /**
