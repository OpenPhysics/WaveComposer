...
declare class PhetioIDUtils {
     ...
     */
    static append(phetioID: string, ...componentNames: string[]): string;
    /**
     ...
     */
    static getComponentName(phetioID: string): string;
    /**
     ...
     */
    static getParentID(phetioID: string): string | null;
    /**
     ...
     * @deprecated
     */
    static getDOMElementID(phetioID: string): string;
    /**
     ...
     */
    static getScreenID(phetioID: string): string | null;
    /**
     ...
     * @public
     */
    static getGroupElementIndex(componentName: string): number;
    /**
     ...
     * @public
     */
    static isAncestor(potentialAncestorPhetioID: string, potentialDescendantPhetioID: string): boolean;
    /**
     ...
     * @returns {string}
     */
    static getArchetypalPhetioID(phetioID: string): string;
    /**
     ...
     * @public
     */
    static readonly GROUP_SEPARATOR = "_";
    /**
     ...
     * @public
     */
    static readonly INTER_TERM_SEPARATOR = "-";
    /**
     ...
     * @public
     */
    static readonly GENERAL_COMPONENT_NAME = "general";
    /**
     ...
     * @public
     */
    static readonly GLOBAL_COMPONENT_NAME = "global";
    /**
     ...
     * @public
     */
    static readonly HOME_SCREEN_COMPONENT_NAME = "homeScreen";
    /**
     ...
     * @public
     */
    static readonly MODEL_COMPONENT_NAME = "model";
    /**
     ...
     * @public
     */
    static readonly VIEW_COMPONENT_NAME = "view";
    /**
     ...
     * @public
     */
    static readonly CONTROLLER_COMPONENT_NAME = "controller";
    /**
     ...
     * @public
     */
    static readonly COLORS_COMPONENT_NAME = "colors";
    /**
     ...
     * @public
     */
    static readonly STRINGS_COMPONENT_NAME = "strings";
    /**
     ...
     * @public
     */
    static readonly ARCHETYPE = "archetype";
    /**
     ...
     * @public
     */
    static readonly CAPSULE_SUFFIX = "Capsule";
}
