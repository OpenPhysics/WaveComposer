...
declare class LinePlot extends Path {
    private chartTransform;
    dataSet: (Vector2 | null)[];
    private readonly disposeLinePlot;
    constructor(chartTransform: ChartTransform, dataSet: (Vector2 | null)[], providedOptions?: LinePlotOptions);
    /**
     ...
     */
    setDataSet(dataSet: (Vector2 | null)[]): void;
    update(): void;
    dispose(): void;
}
