...
export default class AreaPlot extends Path {
    ...
    private readonly disposeAreaChart;
    constructor(chartTransform: ChartTransform, dataSet: AreaChartDataSet, providedOptions?: AreaChartOptions);
    dispose(): void;
    update(): void;
    /**
     ...
     */
    setDataSet(dataSet: AreaChartDataSet): void;
    /**
