...
declare class ResponsePatternCollection {
    private readonly nameObjectContextHint;
    private readonly nameObjectContext;
    private readonly nameObjectHint;
    private readonly nameContextHint;
    private readonly nameObject;
    private readonly nameContext;
    private readonly nameHint;
    private readonly name;
    private readonly objectContextHint;
    private readonly objectContext;
    private readonly objectHint;
    private readonly contextHint;
    ...
    static readonly DEFAULT_RESPONSE_PATTERNS: ResponsePatternCollection;
    static readonly OBJECT_RESPONSE_FIRST_PATTERNS: ResponsePatternCollection;
    static readonly CONTEXT_RESPONSE_FIRST_PATTERNS: ResponsePatternCollection;
}
