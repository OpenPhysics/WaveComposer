...
class ResponsePacket {
    ...
    get nameResponse() { return this.getNameResponse(); }
    set nameResponse(nameResponse) { this.setNameResponse(nameResponse); }
    ...
    get objectResponse() { return this.getObjectResponse(); }
    set objectResponse(objectResponse) { this.setObjectResponse(objectResponse); }
    ...
    get contextResponse() { return this.getContextResponse(); }
    set contextResponse(contextResponse) { this.setContextResponse(contextResponse); }
    ...
    get hintResponse() { return this.getHintResponse(); }
    set hintResponse(hintResponse) { this.setHintResponse(hintResponse); }
