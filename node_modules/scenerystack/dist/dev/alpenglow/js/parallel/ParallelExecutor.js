...
export class ParallelExecutor {
    ...
    async dispatch(dispatchX = 1, dispatchY = 1, dispatchZ = 1) {
        // For each workgroup
        for (let workgroupX = 0; workgroupX < dispatchX; workgroupX++) {
            for (let workgroupY = 0; workgroupY < dispatchY; workgroupY++) {
                for (let workgroupZ = 0; workgroupZ < dispatchZ; workgroupZ++) {
                    ...
                    const workgroup = new ParallelWorkgroup(this.kernel, new Vector3(workgroupX, workgroupY, workgroupZ), this.kernel.createWorkgroupValues());
