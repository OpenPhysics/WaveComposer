...
export class ParallelRasterEdgeIndexPatch {
    ...
    // read
    chunkIndexMap, chunkIndices, numEdges, 
    // read-write
    edges) {
        const kernel = new ParallelKernel(async (context) => {
            ...
            if (exists) {
                ...
                await edges.set(context, edgeIndex, new RasterEdge(outputChunkIndex, edgeIndex === startIndex, edgeIndex === endIndex - 1, edge.startPoint, edge.endPoint));
            }
        }, () => ({
