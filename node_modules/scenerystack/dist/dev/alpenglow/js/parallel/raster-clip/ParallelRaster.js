...
export class ParallelRaster {
    static getTestRawInputChunks() {
        return [
            new RasterChunk(0, false, true, 0, 5, 0, 0, 10, 10, -1, 1, 0, 0),
            new RasterChunk(1, false, false, 5, 3, 10, 0, 20, 10, 0, 1, 0, 0),
            new RasterChunk(2, true, false, 8, 1, 9, 8, 10, 10, -1, 1, 0, 0),
            new RasterChunk(3, true, false, 9, 4, 7, 9, 9, 10, 0, 0, 0, 0),
            new RasterChunk(4, true, false, 13, 6, 10, 5, 20, 10, 0, 0, 0, 0),
            new RasterChunk(5, true, false, 19, 1, 19, 3, 20, 4, -1, 1, 0, 0),
            new RasterChunk(6, false, false, 20, 0, 11, 8, 12, 9, -1, 1, 1, -1),
            new RasterChunk(7, false, false, 20, 0, 12, 6, 18, 10, -1, 1, 1, -1),
            new RasterChunk(8, false, false, 20, 0, 0, 0, 10, 10, 0, 0, 0, 0)
        ];
    }
    static getTestRawInputEdges() {
        return [
            new RasterEdge(0, true, false, new Vector2(10, 0), new Vector2(10, 6)),
            new RasterEdge(0, false, false, new Vector2(10, 6), new Vector2(0, 10)),
            new RasterEdge(0, false, false, new Vector2(1, 1), new Vector2(3, 6)),
            new RasterEdge(0, false, false, new Vector2(3, 6), new Vector2(4, 2)),
            new RasterEdge(0, false, true, new Vector2(4, 2), new Vector2(1, 1)),
            new RasterEdge(1, true, false, new Vector2(20, 0), new Vector2(20, 2)),
            new RasterEdge(1, false, false, new Vector2(20, 2), new Vector2(10, 6)),
            new RasterEdge(1, false, true, new Vector2(10, 6), new Vector2(10, 0)),
            new RasterEdge(2, true, true, new Vector2(10, 8), new Vector2(9, 10)),
            new RasterEdge(3, true, false, new Vector2(7.5, 9), new Vector2(9, 9)),
            new RasterEdge(3, false, false, new Vector2(9, 9), new Vector2(9, 10)),
            new RasterEdge(3, false, false, new Vector2(9, 10), new Vector2(7.5, 10)),
            new RasterEdge(3, false, true, new Vector2(7.5, 10), new Vector2(7.5, 9)),
            new RasterEdge(4, true, false, new Vector2(10, 9), new Vector2(11, 9)),
            new RasterEdge(4, false, false, new Vector2(11, 9), new Vector2(10, 10)),
            new RasterEdge(4, false, false, new Vector2(10, 10), new Vector2(10, 9)),
            new RasterEdge(4, false, false, new Vector2(19, 9), new Vector2(20, 9)),
            new RasterEdge(4, false, false, new Vector2(20, 9), new Vector2(19, 10)),
            new RasterEdge(4, false, true, new Vector2(19, 10), new Vector2(19, 9)),
            new RasterEdge(5, true, true, new Vector2(20, 4), new Vector2(19, 5))
        ];
    }
    static async test() {
        ...
        if (USE_DEMO) {
            ...
            unprocessedEdges.forEach((edge, i) => {
                rawInputEdges.push(new RasterEdge(0, i === 0, i === unprocessedEdges.length - 1, 
                // NOTE: reversed here, due to our test path!!!
                edge.endPoint.timesScalar(0.35), edge.startPoint.timesScalar(0.35)));
            });
            rawInputChunks = [new RasterChunk(0, false, true, 0, rawInputEdges.length, 0, 0, 256, 256, 0, 0, 0, 0)];
        }
    ...
    static async process(workgroupSize, numInputChunks, numInputEdges, 
    // input
    inputChunks, inputEdges) {
        ...
        const toIndexedString = (n, i) => `${i} ${n.toString()}`;
        const createStorage = (length, indeterminateValue) => new ParallelStorageArray(_.range(0, ByteEncoder.alignUp(length, workgroupSize)).map(() => indeterminateValue), indeterminateValue);
        ...
        await ParallelRasterInitialClip.dispatch(workgroupSize, inputChunks, inputEdges, numInputEdges, clippedChunks, edgeClips, chunkReduces0, debugFullChunkReduces);
        ...
        await ParallelRasterChunkReduce.dispatch(workgroupSize, chunkReduces0, Math.ceil(numInputEdges / workgroupSize), clippedChunks, chunkReduces1);
        ...
        LOG && console.log('ParallelRasterChunkReduce dispatch');
        await ParallelRasterChunkReduce.dispatch(workgroupSize, chunkReduces1, Math.ceil(numInputEdges / (workgroupSize * workgroupSize)), clippedChunks, chunkReduces2);
        ...
        await ParallelRasterInitialSplitReduce.dispatch(workgroupSize, clippedChunks, numClippedChunks, debugFullSplitReduces, splitReduces0);
        ...
        await ParallelRasterSplitReduce.dispatch(workgroupSize, Math.ceil(numClippedChunks / workgroupSize), splitReduces0, splitReduces1);
        ...
        LOG && console.log('ParallelRasterSplitReduce dispatch');
        await ParallelRasterSplitReduce.dispatch(workgroupSize, Math.ceil(numClippedChunks / (workgroupSize * workgroupSize)), splitReduces1, splitReduces2);
        ...
        await ParallelRasterSplitScan.dispatch(workgroupSize, clippedChunks, splitReduces0, splitReduces1, splitReduces2, numClippedChunks, reducibleChunks, completeChunks, chunkIndexMap, debugSplitScanReduces);
        ...
        await ParallelRasterInitialEdgeReduce.dispatch(workgroupSize, clippedChunks, edgeClips, numEdgeClips, debugFullEdgeReduces, edgeReduces0);
        ...
        LOG && console.log('ParallelRasterSplitReduce dispatch');
        await ParallelRasterSplitReduce.dispatch(workgroupSize, Math.ceil(numEdgeClips / workgroupSize), edgeReduces0, edgeReduces1);
        ...
        LOG && console.log('ParallelRasterSplitReduce dispatch');
        await ParallelRasterSplitReduce.dispatch(workgroupSize, Math.ceil(numEdgeClips / (workgroupSize * workgroupSize)), edgeReduces1, edgeReduces2);
        ...
        await ParallelRasterEdgeScan.dispatch(workgroupSize, clippedChunks, edgeClips, edgeReduces0, edgeReduces1, edgeReduces2, numEdgeClips, reducibleEdges, completeEdges, chunkIndices, debugEdgeScan);
        ...
        await ParallelRasterChunkIndexPatch.dispatch(workgroupSize, chunkIndexMap, chunkIndices, clippedChunks, numClippedChunks, reducibleChunks, completeChunks);
        LOG && console.log(`reducibleChunks ${reducibleChunkCount}`);
        LOG && console.log(reducibleChunks.data.slice(0, reducibleChunkCount).map(toIndexedString).join('\n'));
        LOG && console.log(`completeChunks ${completeChunkCount}`);
        LOG && console.log(completeChunks.data.slice(0, completeChunkCount).map(toIndexedString).join('\n'));
        LOG && console.log('ParallelRasterEdgeIndexPatch dispatch');
        await ParallelRasterEdgeIndexPatch.dispatch(workgroupSize, chunkIndexMap, chunkIndices, reducibleEdgeCount, reducibleEdges);
        LOG && console.log(`reducibleEdges ${reducibleEdgeCount}`);
        LOG && console.log(reducibleEdges.data.slice(0, reducibleEdgeCount).map(toIndexedString).join('\n'));
        LOG && console.log(`completeEdges ${completeEdgeCount}`);
        LOG && console.log(completeEdges.data.slice(0, completeEdgeCount).map(toIndexedString).join('\n'));
