...
export class RasterEdge {
    constructor(chunkIndex, isFirstEdge, isLastEdge, startPoint, endPoint) {
    ...
    writeEncoding(encoder) {
        ...
        encoder.pushU32((this.chunkIndex & 0x2fffffff) |
    ...
    static readEncoding(arrayBuffer, byteOffset) {
        ...
        return new RasterEdge(chunkIndex, isFirstEdge, isLastEdge, new Vector2(floatBuffer[1], floatBuffer[2]), new Vector2(floatBuffer[3], floatBuffer[4]));
    }
...
RasterEdge.ENCODING_BYTE_LENGTH = 4 * 5;
RasterEdge.INDETERMINATE = new RasterEdge(NaN, false, false, new Vector2(NaN, NaN), new Vector2(NaN, NaN));
