...
export declare class RasterLog {
    scale: number | null;
...
export declare class RasterTileLog {
    ...
    renderableFaces: RenderableFace[] | null;
    integerIntersectionCount: number;
    integerIntersectionComputationCount: number;
    integerIntersectionOverlapCheckCount: number;
}
