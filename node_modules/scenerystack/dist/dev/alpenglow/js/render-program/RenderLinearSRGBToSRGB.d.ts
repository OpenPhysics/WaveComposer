...
export declare class RenderLinearSRGBToSRGB extends RenderColorSpaceConversion {
...
export declare class RenderInstructionLinearSRGBToSRGB extends RenderInstruction {
    toString(): string;
    ...
    static readonly INSTANCE: RenderInstructionLinearSRGBToSRGB;
}
