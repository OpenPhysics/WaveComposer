...
export declare class RenderOklabToLinearSRGB extends RenderColorSpaceConversion {
...
export declare class RenderInstructionOklabToLinearSRGB extends RenderInstruction {
    toString(): string;
    ...
    static readonly INSTANCE: RenderInstructionOklabToLinearSRGB;
}
