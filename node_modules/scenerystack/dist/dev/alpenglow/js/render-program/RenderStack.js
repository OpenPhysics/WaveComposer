...
export class RenderStack extends RenderProgram {
    ...
    constructor(children) {
        super(children, _.every(children, RenderProgram.closureIsFullyTransparent), _.some(children, RenderProgram.closureIsFullyOpaque));
    }
    getName() {
        return 'RenderStack';
    }
    ...
    static combine(a, b) {
        ...
        return new Vector4(a.x + backgroundAlpha * b.x, a.y + backgroundAlpha * b.y, a.z + backgroundAlpha * b.z, a.w + backgroundAlpha * b.w);
    }
    evaluate(context) {
        ...
        for (let i = this.children.length - 2; i >= 0 && color.w !== 1; i--) {
            ...
            color.setXYZW(backgroundAlpha * blendColor.x + color.x, backgroundAlpha * blendColor.y + color.y, backgroundAlpha * blendColor.z + color.z, backgroundAlpha * blendColor.w + color.w);
        }
        return color;
    }
...
export class RenderInstructionOpaqueJump extends RenderInstruction {
    ...
    writeBinary(encoder, getOffset) {
        ...
        encoder.pushU32(RenderInstruction.OpaqueJumpCode |
            offset << 8);
    }
...
RenderInstructionOpaqueJump.SKIP_RENDER_COLOR_JUMPS = false;
...
export class RenderInstructionStackBlend extends RenderInstruction {
    ...
    execute(stack, context, executor) {
        ...
        // Assume premultiplied
        stack.writeTopValues(backgroundAlpha * background.x + foreground.x, backgroundAlpha * background.y + foreground.y, backgroundAlpha * background.z + foreground.z, backgroundAlpha * background.w + foreground.w);
    }
    writeBinary(encoder, getOffset) {
...
RenderInstructionStackBlend.INSTANCE = new RenderInstructionStackBlend();
