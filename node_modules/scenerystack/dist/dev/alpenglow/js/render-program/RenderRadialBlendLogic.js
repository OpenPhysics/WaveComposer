...
export class RenderRadialBlendLogic {
    constructor(transform, radius0, radius1, accuracy) {
    ...
    computeLinearValue(context) {
        ...
        if (this.accuracy === RenderRadialBlendAccuracy.Accurate) {
            ...
            if (context.face) {
                ...
                averageDistance = (LinearEdge.evaluateLineIntegralDistance(p0.x, p0.y, p1.x, p1.y) +
                    LinearEdge.evaluateLineIntegralDistance(p1.x, p1.y, p2.x, p2.y) +
                    LinearEdge.evaluateLineIntegralDistance(p2.x, p2.y, p3.x, p3.y) +
                    LinearEdge.evaluateLineIntegralDistance(p3.x, p3.y, p0.x, p0.y)) / (context.area * this.inverseTransform.getSignedScale());
