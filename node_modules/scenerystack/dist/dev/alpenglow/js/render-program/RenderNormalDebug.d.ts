...
export declare class RenderNormalDebug extends RenderProgram {
    readonly normalProgram: RenderProgram;
    constructor(normalProgram: RenderProgram);
    getName(): string;
...
export declare class RenderInstructionNormalDebug extends RenderInstruction {
    toString(): string;
    ...
    static readonly INSTANCE: RenderInstructionNormalDebug;
}
