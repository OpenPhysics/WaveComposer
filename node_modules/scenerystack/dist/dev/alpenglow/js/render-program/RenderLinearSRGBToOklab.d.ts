...
export declare class RenderLinearSRGBToOklab extends RenderColorSpaceConversion {
...
export declare class RenderInstructionLinearSRGBToOklab extends RenderInstruction {
    toString(): string;
    ...
    static readonly INSTANCE: RenderInstructionLinearSRGBToOklab;
}
