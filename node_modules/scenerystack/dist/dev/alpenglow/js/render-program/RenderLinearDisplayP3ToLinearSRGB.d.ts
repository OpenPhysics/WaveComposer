...
export declare class RenderLinearDisplayP3ToLinearSRGB extends RenderColorSpaceConversion {
...
export declare class RenderInstructionLinearDisplayP3ToLinearSRGB extends RenderInstruction {
    toString(): string;
    ...
    static readonly INSTANCE: RenderInstructionLinearDisplayP3ToLinearSRGB;
}
