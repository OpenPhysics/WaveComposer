...
export class RenderPlanar {
    constructor(program, pointA, pointB, pointC) {
        ...
        assert && assert(this.plane.normal.z !== 0, 'If the normal is perpendicular to the Z axis, it will not define a valid depth for any point');
    }
    getDepth(x, y) {
    ...
    transformed(transform) {
        ...
        return new RenderPlanar(this.program.transformed(transform), new Vector3(pA.x, pA.y, this.pointA.z), new Vector3(pB.x, pB.y, this.pointB.z), new Vector3(pC.x, pC.y, this.pointC.z));
    }
    withProgram(program) {
