...
export class RenderFilter extends RenderProgram {
    constructor(program, colorMatrix, colorTranslation, logic) {
        ...
        super([program], isFullyTransparent, isFullyOpaque);
    ...
    static applyFilter(color, colorMatrix, colorTranslation) {
...
export class RenderFilterLogic {
    constructor(colorMatrix, colorTranslation) {
        this.colorMatrix = colorMatrix;
        this.colorTranslation = colorTranslation;
    }
    equals(other) {
...
export class RenderInstructionFilter extends RenderInstruction {
    ...
    static fromBinary(encoder, offset, getLocation) {
        return new RenderInstructionFilter(new RenderFilterLogic(new Matrix4(encoder.fullF32Array[offset + 1], encoder.fullF32Array[offset + 2], encoder.fullF32Array[offset + 3], encoder.fullF32Array[offset + 4], encoder.fullF32Array[offset + 5], encoder.fullF32Array[offset + 6], encoder.fullF32Array[offset + 7], encoder.fullF32Array[offset + 8], encoder.fullF32Array[offset + 9], encoder.fullF32Array[offset + 10], encoder.fullF32Array[offset + 11], encoder.fullF32Array[offset + 12], encoder.fullF32Array[offset + 13], encoder.fullF32Array[offset + 14], encoder.fullF32Array[offset + 15], encoder.fullF32Array[offset + 16]), new Vector4(encoder.fullF32Array[offset + 17], encoder.fullF32Array[offset + 18], encoder.fullF32Array[offset + 19], encoder.fullF32Array[offset + 20])));
    }
    getBinaryLength() {
        return 21;
    }
