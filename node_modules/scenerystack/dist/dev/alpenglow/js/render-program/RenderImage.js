...
export class RenderImage extends RenderProgram {
    ...
    constructor(transform, image, extendX, extendY, resampleType, logic) {
        ...
        super(emptyChildren, false, image.isFullyOpaque, needsFace, false, needsCentroid);
     ...
     */
    static evaluateAnalyticFilter(logic, context, inverseTransform, minExpand, maxExpand, boundsShift, evaluateFace, evaluateFull) {
    ...
    static extendInteger(i, size, extend) {
        switch (extend) {
            case RenderExtend.Pad: {
    ...
    static serializeRenderImageable(imageable) {
        return {
    ...
    static deserializeRenderImageable(obj) {
        return {
            width: obj.width,
            height: obj.height,
...
export class RenderImageLogic {
    constructor(transform, image, extendX, extendY, resampleType) {
        this.transform = transform;
        this.image = image;
        this.extendX = extendX;
        this.extendY = extendY;
    ...
    evaluate(context) {
        ...
        switch (this.resampleType) {
            ...
            case RenderResampleType.AnalyticBox: {
                return RenderImage.evaluateAnalyticFilter(this, context, this.inverseTransform, 0, 1, -1, (face, x, y, px, py, area) => {
                    return area;
                }, _.constant(1));
            }
            case RenderResampleType.AnalyticBilinear: {
                return RenderImage.evaluateAnalyticFilter(this, context, this.inverseTransformWithHalfOffset, 1, 1, 0, (face, x, y, px, py, area) => {
                    return face.getBilinearFiltered(x, y, px, py);
                }, _.constant(0.25));
            }
            case RenderResampleType.AnalyticMitchellNetravali: {
                return RenderImage.evaluateAnalyticFilter(this, context, this.inverseTransformWithHalfOffset, 2, 2, 0, (face, x, y, px, py, area) => {
