...
export class Mesh {
    ...
    static loadOBJ(str) {
        ...
        const getVector3 = (bits) => {
            return new Vector3(bits.length >= 2 ? parseFloat(bits[1]) : 0.0, bits.length >= 3 ? parseFloat(bits[2]) : 0.0, bits.length >= 4 ? parseFloat(bits[3]) : 0.0);
        };
            ...
            switch (bits[0].toLowerCase()) {
                ...
                case 'l': {
                    ...
                    for (let i = 0; i < vertexCount; i++) {
                        ...
                        line.uvIndices.push(vertexBits.length > 1 && vertexBits[1] ? parseInt(vertexBits[1], 10) - 1 : vertexIndex - 1);
                    }
                ...
                case 'f': {
                    ...
                    for (let i = 0; i < vertexCount; i++) {
                        ...
                        face.uvIndices.push(vertexBits.length > 1 && vertexBits[1] ? parseInt(vertexBits[1], 10) - 1 : vertexIndex - 1);
                        face.normalIndices.push(vertexBits.length > 2 ? parseInt(vertexBits[2], 10) - 1 : vertexIndex - 1);
                    }
...
export class MeshFace {
    constructor(material, group, smoothingGroup) {
