...
export class IntegerEdge {
    constructor(renderPath, x0, y0, x1, y1) {
        ...
        this.bounds = new Bounds2(Math.min(x0, x1), Math.min(y0, y1), Math.max(x0, x1), Math.max(y0, y1));
    }
    hasBoundsIntersectionWith(other) {
        return IntegerEdge.hasBoundsIntersection(this.bounds, other.bounds, this.x0 === this.x1 || other.x0 === other.x1, this.y0 === this.y1 || other.y0 === other.y1);
    }
    ...
    static hasBoundsIntersection(boundsA, boundsB, someXEqual, someYEqual) {
    ...
    static createTransformed(path, toIntegerMatrix, p0, p1) {
     ...
     */
    static clipScaleToIntegerEdges(boundedSubpaths, bounds, toIntegerMatrix) {
        const integerEdges = [];
     ...
     * integer coordinates.
     */
    static scaleToIntegerEdges(paths, toIntegerMatrix) {
        const integerEdges = [];
