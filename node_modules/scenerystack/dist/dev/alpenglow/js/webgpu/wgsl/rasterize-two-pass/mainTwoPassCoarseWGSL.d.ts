...
export declare const MAIN_TWO_PASS_COARSE_DEFAULTS: {};
export declare const mainTwoPassCoarseWGSL: (providedOptions: mainTwoPassCoarseWGSLOptions) => WGSLMainModule;
