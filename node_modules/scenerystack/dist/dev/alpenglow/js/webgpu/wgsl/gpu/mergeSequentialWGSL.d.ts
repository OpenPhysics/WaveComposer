 ...
 */
import '../../../../../globals.js';
import { WGSLExpressionI32, WGSLExpressionU32, WGSLStatements } from '../WGSLString.js';
...
export declare const MERGE_SEQUENTIAL_DEFAULTS: {
    readonly greaterThan: null;
    readonly lessThanOrEqual: null;
};
export declare const mergeSequentialWGSL: (providedOptions: mergeSequentialWGSLOptions) => WGSLStatements;
