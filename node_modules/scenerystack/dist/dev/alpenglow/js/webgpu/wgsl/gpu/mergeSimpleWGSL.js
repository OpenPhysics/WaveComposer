...
import { GLOBAL_INDEXABLE_DEFAULTS } from '../WGSLUtils.js';
...
export const mergeSimpleWGSL = (providedOptions) => {
    const options = optionize3()({}, MERGE_SIMPLE_DEFAULTS, providedOptions);
