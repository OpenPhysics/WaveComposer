...
import { u32S, wgsl, wgslBlueprint, WGSLString } from '../WGSLString.js';
...
export const logWGSL = (providedOptions) => {
    const options = optionize3()({}, LOG_DEFAULTS, providedOptions);
