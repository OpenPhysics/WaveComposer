...
export declare const MAIN_REDUCE_ATOMIC_DEFAULTS: {
...
export declare const mainReduceAtomicWGSL: <T>(providedOptions: mainReduceAtomicWGSLOptions<T>) => WGSLMainModule;
