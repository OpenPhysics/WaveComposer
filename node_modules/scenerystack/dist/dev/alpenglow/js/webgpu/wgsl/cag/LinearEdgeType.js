...
const dwords = 4;
export const LinearEdgeType = {
    name: 'LinearEdge',
    bytesPerElement: dwords * 4,
    equals: (a, b) => a.startPoint.equals(b.startPoint) && a.endPoint.equals(b.endPoint),
    equalsWGSL: (a, b) => new WGSLStringModule('equals_linear_edge', wgsl `equals_linear_edge( ${a}, ${b} )`, wgsl `
...
`),
    ...
    decode(encoder, offset) {
        return new LinearEdge(new Vector2(encoder.fullF32Array[offset + 0], encoder.fullF32Array[offset + 1]), new Vector2(encoder.fullF32Array[offset + 2], encoder.fullF32Array[offset + 3]));
    },
    ...
    toDebugString: (value) => 'LinearEdge'
};
