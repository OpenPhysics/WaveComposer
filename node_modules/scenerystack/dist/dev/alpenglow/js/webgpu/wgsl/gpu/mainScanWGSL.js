...
import { scanComprehensiveWGSL } from './scanComprehensiveWGSL.js';
...
export const mainScanWGSL = (providedOptions) => {
    // TODO: how to specify that we don't fill in defaults for things like factorOutSubexpressions?
    const options = optionize3()({}, MAIN_SCAN_DEFAULTS, providedOptions);
    ...
    fn main(
      ...
      ${scanComprehensiveWGSL({
        ...
        storeReduction: options.storeReduction ? (index, value) => wgsl `reduction[ ${index} ] = ${value};` : null
    })}
    }
  `);
};
