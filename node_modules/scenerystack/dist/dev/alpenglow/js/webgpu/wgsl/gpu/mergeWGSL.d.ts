 ...
 */
import '../../../../../globals.js';
import { WGSLExpressionBool, WGSLExpressionI32, WGSLExpressionT, WGSLExpressionU32, WGSLStatements, WGSLVariableName } from '../WGSLString.js';
...
export declare const MERGE_DEFAULTS: {
    readonly greaterThan: null;
    readonly lessThanOrEqual: null;
    readonly atomicConsumed: true;
};
export declare const mergeWGSL: (providedOptions: mergeWGSLOptions) => WGSLStatements;
