...
export declare const MAIN_REDUCE_NON_COMMUTATIVE_DEFAULTS: {
    readonly lengthExpression: null;
    readonly stripeOutput: false;
    readonly reduceOptions: {};
};
export declare const mainReduceNonCommutativeWGSL: <T>(providedOptions: mainReduceNonCommutativeWGSLOptions<T>) => WGSLMainModule;
