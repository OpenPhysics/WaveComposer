...
export class ByteEncoder {
    ...
    decodeValues(decode, bytesPerElement) {
        const result = [];
    ...
    static padLeft(input, padding, length) {
        let result = input;
    ...
    static padRight(input, padding, length) {
        let result = input;
        const padLength = length - input.length;
        for (let i = 0; i < padLength; i++) {
     ...
     */
    static toStripedIndex(blockedIndex, workgroupSize, grainSize) {
     ...
     */
    static fromStripedIndex(stripedIndex, workgroupSize, grainSize) {
     ...
     */
    static getConvergentIndex(index, size) {
     ...
     * @param compare
     */
    static getCorank(k, m, n, compare) {
        let i = Math.min(k, m);
        let j = k - i;
