...
export const shaderTestDevicePromise = (async () => {
    try {
...
export const asyncTestWithDevice = (name, test) => {
...
export const asyncTestWithDeviceContext = (name, test) => {
...
export const compareArrays = (type, inputValues, expectedValues, actualValues) => {
