...
export class GPUProfiling {
    ...
    static async loopingTest(profilerFactories) {
    ...
    static async getRadixProfiler(deviceContext, numbers, options) {
        ...
        const routine = await Routine.create(deviceContext, radixSortModule, [inputSlot, outputSlot], combineStrategy ? Routine.COMBINE_ALL_LAYOUT_STRATEGY : Routine.INDIVIDUAL_LAYOUT_STRATEGY, (context, execute, input) => {
