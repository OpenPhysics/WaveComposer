...
export declare const TWO_PASS_MODULE_DEFAULTS: {
    readonly mainTwoPassCoarseModuleOptions: {};
    readonly mainTwoPassFineModuleOptions: {};
    readonly mainTwoPassInitializeAddressesModule: {};
...
export declare class TwoPassModule extends CompositeModule<TwoPassRunSize> {
    readonly config: BufferSlot<TwoPassConfig>;
    readonly coarseRenderableFaces: BufferSlot<TwoPassCoarseRenderableFace[]>;
    readonly coarseEdges: BufferSlot<LinearEdge[]>;
    ...
    readonly coarseModule: MainTwoPassCoarseModule;
    readonly fineModule: MainTwoPassFineModule;
    constructor(providedOptions: TwoPassModuleOptions);
}
export {};
