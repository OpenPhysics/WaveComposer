...
export class BoundsClipping {
     ...
     */
    static boundsClipEdge(startPoint, endPoint, minX, minY, maxX, maxY, centerX, centerY, result = []) {
        ...
        if (needsStartCorner) {
            ...
            startCorner = new Vector2(startXLess ? minX : maxX, startYLess ? minY : maxY);
        }
        if (needsEndCorner) {
            endXLess = endPoint.x < centerX;
            endYLess = endPoint.y < centerY;
            endCorner = new Vector2(endXLess ? minX : maxX, endYLess ? minY : maxY);
        }
        if (clipped) {
            ...
            if (startXLess !== endXLess && startYLess !== endYLess) {
                ...
                const middlePoint = new Vector2(startSame === yGreater ? minX : maxX, yGreater ? maxY : minY);
     ...
     * @param centerY - Center y of the bounding box
     */
    static boundsClipPolygon(polygon, minX, minY, maxX, maxY, centerX, centerY) {
        ...
        for (let i = 0; i < polygon.length; i++) {
            ...
            if (needsStartCorner) {
                simplifier.add(startXLess ? minX : maxX, startYLess ? minY : maxY);
            }
            if (clipped) {
                ...
                if (startXLess !== endXLess && startYLess !== endYLess) {
                    ...
                    const startSame = startXLess === startYLess;
                    const yGreater = y > centerY;
                    simplifier.add(startSame === yGreater ? minX : maxX, yGreater ? maxY : minY);
                }
            }
            if (needsEndCorner) {
                simplifier.add(endXLess ? minX : maxX, endYLess ? minY : maxY);
            }
        }
