...
export declare class ClipSimplifier {
    private readonly checkGeneralCollinearity;
    private points;
    constructor(checkGeneralCollinearity?: boolean);
    addTransformed(matrix: Matrix3, x: number, y: number): void;
     ...
     */
    finalize(): Vector2[];
    finalizeInto(polygons: Vector2[][]): void;
    reset(): void;
    static simplifyPolygon(polygon: Vector2[], checkGeneralCollinearity?: boolean): Vector2[];
}
