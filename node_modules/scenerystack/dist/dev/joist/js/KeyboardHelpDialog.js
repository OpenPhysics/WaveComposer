...
export default class KeyboardHelpDialog extends Dialog {
    constructor(screens, screenProperty, providedOptions) {
        ...
        if (assert && self.phet?.chipper?.queryParameters?.binder) {
