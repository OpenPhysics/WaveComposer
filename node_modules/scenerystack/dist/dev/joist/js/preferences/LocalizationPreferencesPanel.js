...
// constants
const localizationTitleStringProperty = string_joist_preferences_tabs_localization_title_StringProperty;
const regionAndCultureTitleStringProperty = string_joist_preferences_tabs_localization_regionAndCulture_title_StringProperty;
const regionAndCultureDescriptionStringProperty = string_joist_preferences_tabs_localization_regionAndCulture_description_StringProperty;
class LocalizationPreferencesPanel extends PreferencesPanel {
    constructor(localizationModel, selectedTabProperty, tabVisibleProperty, providedOptions) {
        ...
        if (localizationModel.supportsDynamicLocale && localizationModel.includeLocalePanel) {
            ...
            const localeLabel = new VoicingText(string_joist_preferences_tabs_localization_languageSelection_title_StringProperty, combineOptions({}, PreferencesDialogConstants.CONTROL_LABEL_OPTIONS, {
                // Default behavior for VoicingText creates an accessibleParagraph
                // but this needs to be a heading.
                accessibleHeading: string_joist_preferences_tabs_localization_languageSelection_title_StringProperty,
                accessibleParagraph: null
            }));
            const localeDescription = new VoicingRichText(string_joist_preferences_tabs_localization_languageSelection_description_StringProperty, PreferencesDialogConstants.CONTROL_DESCRIPTION_OPTIONS);
