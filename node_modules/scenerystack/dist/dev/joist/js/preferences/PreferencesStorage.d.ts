...
declare class PreferencesStorage {
    private enabled;
    private readonly registedProperties;
    constructor();
    private registerToLocalStorage;
    static register(property: TProperty<unknown>, name: string): TProperty<unknown>;
}
