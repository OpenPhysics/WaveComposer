...
class PhetButton extends JoistButton {
    constructor(sim, backgroundFillProperty, tandem) {
        ...
        // or a grunt option (during the build), please see initialize-globals.js self.phet.chipper.brand for more
        // details
        ...
        super(icon, backgroundFillProperty, {
            ...
            // pdom
            accessibleName: string_joist_a11y_phetMenu_StringProperty,
            // voicing
            voicingNameResponse: string_joist_a11y_phetMenu_StringProperty
        });
