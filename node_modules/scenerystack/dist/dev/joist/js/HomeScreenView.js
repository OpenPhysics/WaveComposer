...
class HomeScreenView extends ScreenView {
    ...
    constructor(simNameProperty, model, providedOptions) {
        ...
        this.homeScreenScreenSummaryIntroProperty = new PatternStringProperty(string_joist_a11y_homeScreenDescriptionPattern_StringProperty, {
        ...
        homeScreenPDOMNode.accessibleName = new PatternStringProperty(string_joist_a11y_homeScreenIntroPattern_StringProperty, {
            description: this.homeScreenScreenSummaryIntroProperty,
            hint: string_joist_a11y_homeScreenHint_StringProperty
        }, { tandem: Tandem.OPT_OUT });
    ...
    getVoicingDetailsContent() {
        ...
        this.screenButtons.forEach(screenButton => {
            ...
            details += StringUtils.fillIn(string_joist_a11y_homeScreenButtonDetailsPattern_StringProperty, {
    ...
    getVoicingHintContent() {
        return string_joist_a11y_homeScreenHint_StringProperty;
    }
}
