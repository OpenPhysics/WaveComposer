...
declare class PhetButton extends JoistButton {
    /**
     ...
     */
    static readonly PhetButtonIO: IOType<any, any, any>;
    constructor(sim: Sim, backgroundFillProperty: TReadOnlyProperty<Color>, tandem: Tandem);
}
