...
declare class AudioManager extends PhetioObject {
    readonly audioAllowed: boolean;
    readonly audioEnabledProperty: BooleanProperty;
    readonly audioAndSoundEnabledProperty: TReadOnlyProperty<boolean>;
    readonly audioAndVoicingEnabledProperty: TReadOnlyProperty<boolean>;
    readonly anySubcomponentEnabledProperty: TReadOnlyProperty<boolean>;
    readonly anyOutputEnabledProperty: TReadOnlyProperty<boolean>;
