...
// constants
const homeStringProperty = string_joist_a11y_home_StringProperty;
...
export default class HomeButton extends JoistButton {
    ...
    constructor(navBarHeight, navigationBarFillProperty, pdomDisplayNameProperty, providedOptions) {
        ...
        // navigation bar.
        this.focusHighlight = Shape.bounds(new Bounds2(this.bounds.minX - options.highlightExtensionWidth, this.bounds.minY + 2, this.bounds.maxX + options.highlightExtensionWidth, this.bounds.maxY - 2));
