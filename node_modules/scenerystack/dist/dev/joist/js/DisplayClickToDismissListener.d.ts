...
declare class DisplayClickToDismissListener {
    private pointer;
    private readonly pointerListener;
    private readonly displayedProperty;
    /**
     * @param listener - The listener to be called when the Pointer goes up, likely to dismiss something.
     * @param [providedOptions]
     */
    constructor(listener: SceneryListenerFunction, providedOptions?: DisplayClickToDismissListenerOptions);
    /**
