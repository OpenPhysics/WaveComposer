...
class NavigationBarScreenButton extends Voicing(Node) {
    ...
    constructor(navigationBarFillProperty, screenProperty, screen, simScreenIndex, navBarHeight, providedOptions) {
        ...
        Multilink.multilink([selectedProperty, this.buttonModel.looksPressedProperty, this.buttonModel.isOverOrFocusedProperty, navigationBarFillProperty, this.buttonModel.enabledProperty], (selected, looksPressed, overOrFocused, navigationBarFill, enabled) => {
        ...
        assert && needsIconMaxWidth && assert(toFixed(this.width, 0) === toFixed(options.maxButtonWidth, 0), `this.width ${this.width} !== options.maxButtonWidth ${options.maxButtonWidth}`);
