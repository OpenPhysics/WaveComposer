...
export class LocaleProperty extends Property {
    constructor(value, providedOptions) {
        ...
        super(value, options);
        this.availableRuntimeLocales = availableRuntimeLocales;
    ...
    toStateObject() {
        ...
        parentObject.validValues = [...this.availableRuntimeLocales].sort();
        return parentObject;
    }
...
if (self.phet?.chipper?.queryParameters?.keyboardLocaleSwitcher) {
