...
assert && assert(_.every(supportedRegionAndCultureValues, value => RegionAndCultureValues.includes(value)), `unsupported value in packageJSON supportedRegionsAndCultures: ${supportedRegionAndCultureValues}`);
...
const regionAndCultureQueryParameter = self.phet.chipper.queryParameters.regionAndCulture;
const initialRegionAndCulture = isSupportedRegionAndCulture(regionAndCultureQueryParameter) ?
