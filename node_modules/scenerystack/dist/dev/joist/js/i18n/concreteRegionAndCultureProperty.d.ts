...
import { type RegionAndCulture } from './regionAndCultureProperty.js';
export type ConcreteRegionAndCulture = Exclude<RegionAndCulture, 'random'>;
export declare const concreteRegionAndCultureValues: ConcreteRegionAndCulture[];
export declare const concreteRegionAndCultureProperty: TReadOnlyProperty<ConcreteRegionAndCulture>;
