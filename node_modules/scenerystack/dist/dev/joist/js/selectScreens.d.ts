...
export default function selectScreens(allSimScreens: AnyScreen[], homeScreenQueryParameter: boolean, homeScreenQueryParameterProvided: boolean, initialScreenIndex: number, initialScreenQueryParameterProvided: boolean, screensQueryParameter: number[], screensQueryParameterProvided: boolean, setupScreens: (screens: AnyScreen[]) => void, createHomeScreen: (screens: AnyScreen[]) => HomeScreen): ScreenReturnType;
