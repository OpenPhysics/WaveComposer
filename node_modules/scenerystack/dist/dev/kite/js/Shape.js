...
import Segment, { Line, Quadratic, Cubic, Arc, EllipticalArc } from './segments/Segment.js';
...
import Boundary from './ops/Boundary.js';
import Edge from './ops/Edge.js';
import EdgeSegmentTree from './ops/EdgeSegmentTree.js';
import Face from './ops/Face.js';
import Loop from './ops/Loop.js';
import Vertex from './ops/Vertex.js';
...
export class Graph {
     ...
     */
    addSubpath(shapeId, subpath, providedOptions) {
        const options = optionize()({
            ensureClosed: true
        }, providedOptions);
    ...
    eliminateOverlap() {
        ...
        const queue = new FlatQueue(); // eslint-disable-line no-undef
     ...
     * `clipAreaShape`
     */
    static clipShape(clipAreaShape, shape, providedOptions) {
        let i;
        let j;
        let loop;
        const SHAPE_ID = 0;
