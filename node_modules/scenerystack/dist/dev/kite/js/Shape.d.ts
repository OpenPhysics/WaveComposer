...
import Segment, { ClosestToPointResult, PiecewiseLinearOptions } from './segments/Segment.js';
...
declare class Shape implements CanApplyParsedSVG {
    ...
    private lastQuadraticControlPoint;
    private lastCubicControlPoint;
    /**
     * All arguments optional, they are for the copy() method. if used, ensure that 'bounds' is consistent with 'subpaths'
     */
    constructor(subpaths?: Subpath[] | string, bounds?: Bounds2);
    /**
     ...
     */
    private setQuadraticControlPoint;
    /**
     * Sets the cubic control point
     */
    private setCubicControlPoint;
    /**
     ...
     */
    private notifyInvalidationListeners;
    private addSegmentAndBounds;
    /**
     ...
     */
    static deserialize(obj: SerializedShape): Shape;
    /**
     * Creates a rectangle
     */
    static rectangle(x: number, y: number, width: number, height: number): Shape;
    static rect: typeof Shape.rectangle;
    /**
     * Creates a round rectangle {Shape}, with {number} arguments. Uses circular or elliptical arcs if given.
     */
    static roundRect(x: number, y: number, width: number, height: number, arcw: number, arch: number): Shape;
    static roundRectangle: typeof Shape.roundRect;
    /**
     ...
     */
    static roundedRectangleWithRadii(x: number, y: number, width: number, height: number, cornerRadii?: Partial<CornerRadiiOptions>): Shape;
    /**
     * Returns a Shape from a bounds, offset (expanded) by certain amounts, and with certain corner radii.
     */
    static boundsOffsetWithRadii(bounds: Bounds2, offsets: OffsetsOptions, radii?: CornerRadiiOptions): Shape;
    /**
     ...
     */
    static polygon(vertices: Vector2[]): Shape;
    /**
     * Creates a rectangular shape from bounds
     */
    static bounds(bounds: Bounds2): Shape;
    /**
     * Creates a line segment, using either (x1,y1,x2,y2) or ({x1,y1},{x2,y2}) arguments
     */
    static lineSegment(x1: number, y1: number, x2: number, y2: number): Shape;
    static lineSegment(p1: Vector2, p2: Vector2): Shape;
    /**
     ...
     * @param radius
     */
    static regularPolygon(sides: number, radius: number): Shape;
    /**
     * Creates a circle
     * supports both circle( centerX, centerY, radius ), circle( center, radius ), and circle( radius ) with the center default to 0,0
     */
    static circle(centerX: number, centerY: number, radius: number): Shape;
    static circle(center: Vector2, radius: number): Shape;
     ...
     */
    static ellipse(centerX: number, centerY: number, radiusX: number, radiusY: number, rotation: number): Shape;
    static ellipse(center: Vector2, radiusX: number, radiusY: number, rotation: number): Shape;
    static ellipse(radiusX: number, radiusY: number, rotation: number): Shape;
    /**
     ...
     * @param [anticlockwise] - Decides which direction the arc takes around the center
     */
    static arc(centerX: number, centerY: number, radius: number, startAngle: number, endAngle: number, anticlockwise?: boolean): Shape;
    static arc(center: Vector2, radius: number, startAngle: number, endAngle: number, anticlockwise?: boolean): Shape;
    /**
     ...
     */
    static xor(shapes: Shape[]): Shape;
    /**
     * Returns a new Shape constructed by appending a list of segments together.
     */
    static segments(segments: Segment[], closed?: boolean): Shape;
    /**
     ...
     */
    static fromGraph(graph: Graph): Shape;
    static fromSegment(segment: Segment): Shape;
}
...
export declare class Graph {
     ...
     */
    static deserialize(obj: SerializedGraph): Graph;
    /**
     ...
     */
    computeFaceInclusion(windingMapFilter: (windingMap: Record<number, number>) => boolean): void;
    /**
     ...
     */
    private removeLowOrderVertices;
    /**
     * Sorts incident half-edges for each vertex.
     */
    private orderVertexEdges;
    /**
     ...
     */
    private getBoundaryOfHalfEdge;
    static isInternal(point: Vector2, t: number, segment: Segment, distanceThreshold: number, tThreshold: number): boolean;
    /**
     ...
     */
    static BINARY_NONZERO_UNION(windingMap: Record<number, number>): boolean;
    /**
     ...
     * @param windingMap - See computeFaceInclusion for more details
     */
    static BINARY_NONZERO_INTERSECTION(windingMap: Record<number, number>): boolean;
    /**
     ...
     * @param windingMap - See computeFaceInclusion for more details
     */
    static BINARY_NONZERO_DIFFERENCE(windingMap: Record<number, number>): boolean;
    /**
     ...
     * @param windingMap - See computeFaceInclusion for more details
     */
    static BINARY_NONZERO_XOR(windingMap: Record<number, number>): boolean;
    /**
     * Returns the resulting Shape obtained by combining the two shapes given with the filter.
     */
    static binaryResult(shapeA: Shape, shapeB: Shape, windingMapFilter: (windingMap: Record<number, number>) => boolean): Shape;
    /**
     * Returns the union of an array of shapes.
     */
    static unionNonZero(shapes: Shape[]): Shape;
    /**
     * Returns the intersection of an array of shapes.
     */
    static intersectionNonZero(shapes: Shape[]): Shape;
    /**
     * Returns the xor of an array of shapes.
     *
     * TODO: reduce code duplication? https://github.com/phetsims/kite/issues/76
     */
    static xorNonZero(shapes: Shape[]): Shape;
    /**
     * Returns a simplified Shape obtained from running it through the simplification steps with non-zero output.
     */
    static simplifyNonZero(shape: Shape): Shape;
    /**
     * Returns a clipped version of `shape` that contains only the parts that are within the area defined by
     * `clipAreaShape`
     */
    static clipShape(clipAreaShape: Shape, shape: Shape, providedOptions?: GraphClipOptions): Shape;
}
