...
export default class Face {
     ...
     */
    constructor(boundary: Boundary | null);
    /**
     ...
     */
    addBoundaryFaceReferences(boundary: Boundary): void;
    /**
     ...
     * all necessary holes.
     */
    recursivelyAddHoles(outerBoundary: Boundary): void;
    freeToPool(): void;
    static pool: Pool<typeof Face>;
}
