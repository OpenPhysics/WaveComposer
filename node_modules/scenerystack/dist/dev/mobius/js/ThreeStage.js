...
export default class ThreeStage {
    constructor(providedOptions) {
        ...
        this.contextLostEmitter = new TinyEmitter();
        this.contextRestoredEmitter = new TinyEmitter();
     ...
     */
    renderToCanvas(supersampleMultiplier = 1, backingMultiplier = 1, scale = new Vector2(1, 1)) {
        ...
        if (this.threeRenderer) {
            ...
            const buffer = new self.ArrayBuffer(width * height * 4);
            const pixels = new self.Uint8Array(buffer);
            // read the pixel data into the buffer
            const gl = this.threeRenderer.getContext();
            gl.readPixels(0, 0, width, height, gl.RGBA, gl.UNSIGNED_BYTE, pixels);
            let imageDataBuffer;
            if (supersampleMultiplier === 1) {
                imageDataBuffer = new self.Uint8ClampedArray(buffer);
            }
            else {
                imageDataBuffer = new self.Uint8ClampedArray(canvasWidth * canvasHeight * 4);
     ...
     */
    static scaleCanvas(canvas, scale = new Vector2(1, 1)) {
