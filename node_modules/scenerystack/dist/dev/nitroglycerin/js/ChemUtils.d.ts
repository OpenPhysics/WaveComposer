...
declare const ChemUtils: {
     ...
     */
    createSymbol: (elements: Element[]) => string;
    /**
     ...
     *    [H,H,O] becomes "H2O"
     */
    createSymbolWithoutSubscripts: (elements: Element[]) => string;
    /**
     ...
     */
    nonCarbonHillSortValue: (element: Element) => number;
    /**
     ...
     */
    carbonHillSortValue: (element: Element) => number;
    /**
     ...
     */
    toSubscript: (inputString: string) => string;
    /**
     ...
     */
    hillOrderedSymbol: (elements: Element[]) => string;
};
