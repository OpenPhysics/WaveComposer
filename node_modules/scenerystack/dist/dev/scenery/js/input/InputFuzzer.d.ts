...
declare class InputFuzzer {
    ...
    random: Random;
    mouseToggleAction: () => void;
    mouseMoveAction: () => void;
    touchStartAction: () => void;
    touchMoveAction: () => void;
    touchEndAction: () => void;
    touchCancelAction: () => void;
    /**
     ...
     */
    public fuzzEvents(averageEventCount: number, allowMouse: boolean, allowTouch: boolean, maximumPointerCount: number): void;
    /**
