...
export default class BrowserEvents {
    static blockFocusCallbacks: boolean;
    static dispatchingFocusEvents: boolean;
    /**
     ...
     */
    static addDisplay(display: Display, attachToWindow: boolean, passiveEvents: boolean | null): void;
    /**
     ...
     * @param passiveEvents - The value of the `passive` option for adding/removing DOM event listeners
     */
    static removeDisplay(display: Display, attachToWindow: boolean, passiveEvents: boolean | null): void;
    /**
     ...
     */
    private static getEventOptions;
    /**
     * Will be checked/mutated when listeners are added/removed.
     */
    private static listenersAttachedToWindow;
    /**
     * Will be checked/mutated when listeners are added/removed.
     */
    private static listenersAttachedToElement;
    /**
     * All Displays that should have input events forwarded.
     */
    private static attachedDisplays;
    /**
     ...
     *                                       used.
     */
    private static addOrRemoveListeners;
    /**
     ...
     */
    private static onwheel;
    static onfocusin(domEvent: Event): void;
    static onfocusout(domEvent: Event): void;
    static oninput(domEvent: Event): void;
    static onchange(domEvent: Event): void;
    static onclick(domEvent: Event): void;
    static onkeydown(domEvent: Event): void;
    static onkeyup(domEvent: Event): void;
}
