 ...
 */
import '../../../globals.js';
export declare const TARGET_SUBSTITUTE_KEY = "targetSubstitute";
declare const domEventPropertiesToSerialize: readonly ["altKey", "button", "charCode", "clientX", "clientY", "code", "ctrlKey", "deltaMode", "deltaX", "deltaY", "deltaZ", "key", "keyCode", "metaKey", "pageX", "pageY", "pointerId", "pointerType", "scale", "shiftKey", "target", "type", "relatedTarget", "which"];
 ...
 */
export declare const serializeDomEvent: (domEvent: Event) => SerializedDOMEvent;
/**
 * From a serialized dom event, return a recreated self.Event (scenery-internal)
 */
export declare const deserializeDomEvent: (eventObject: SerializedDOMEvent) => Event;
export {};
