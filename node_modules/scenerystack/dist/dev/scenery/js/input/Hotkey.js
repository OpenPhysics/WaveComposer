...
export default class Hotkey extends EnabledComponent {
    constructor(providedOptions) {
        ...
        this.keyDescriptorProperty = new DerivedProperty([this.keyStringProperty], (keyString) => {
            return KeyDescriptor.keyStrokeToKeyDescriptor(keyString);
        });
        this.keysProperty = new DerivedProperty([this.keyDescriptorProperty], (keyDescriptor) => {
