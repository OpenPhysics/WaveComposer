...
class Input extends PhetioObject {
    ...
    getRelatedTargetTrail(domEvent) {
        ...
        if (relatedTargetElement && this.display.isElementUnderPDOM(relatedTargetElement, false)) {
            ...
            assert && assert(relatedTarget instanceof self.Element);
