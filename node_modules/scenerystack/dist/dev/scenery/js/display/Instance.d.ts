...
declare class Instance {
     ...
     */
    constructor(display: Display, trail: Trail, isDisplayRoot: boolean, isSharedCanvasCacheRoot: boolean);
    /**
     * @public
     * @type {Display|null}
     */
     ...
     */
    public initialize(display: Display, trail: Trail, isDisplayRoot: boolean, isSharedCanvasCacheRoot: boolean): this;
    id: any;
    isWebGLSupported: any;
    relativeTransform: any;
    fittability: any;
    visible: boolean | undefined;
    relativeVisible: boolean | undefined;
    selfVisible: boolean | undefined;
    visibilityDirty: boolean | undefined;
    childVisibilityDirty: boolean | undefined;
    voicingVisible: boolean | undefined;
    branchIndexMap: any;
    branchIndexReferences: any;
    addRemoveCounter: number | undefined;
    stitchChangeFrame: any;
    stitchChangeBefore: number | undefined;
    stitchChangeAfter: number | undefined;
    stitchChangeOnChildren: any;
    stitchChangeIncluded: boolean | undefined;
    childInsertedListener: any;
    childRemovedListener: any;
    childrenReorderedListener: any;
    visibilityListener: any;
    markRenderStateDirtyListener: any;
    visibleEmitter: TinyEmitter<[]> | undefined;
    relativeVisibleEmitter: TinyEmitter<[]> | undefined;
    selfVisibleEmitter: TinyEmitter<[]> | undefined;
    canVoiceEmitter: TinyEmitter<[]> | undefined;
    externalReferenceCount: number | undefined;
    stateless: boolean | undefined;
    isDisplayRoot: boolean | undefined;
    isSharedCanvasCacheRoot: boolean | undefined;
    preferredRenderers: any;
    isUnderCanvasCache: any;
    isBackbone: boolean | undefined;
    isTransformed: boolean | undefined;
    isVisibilityApplied: boolean | undefined;
    isInstanceCanvasCache: boolean | undefined;
    isSharedCanvasCachePlaceholder: boolean | undefined;
    isSharedCanvasCacheSelf: boolean | undefined;
    selfRenderer: number | undefined;
    groupRenderer: number | undefined;
    sharedCacheRenderer: number | undefined;
    renderStateDirtyFrame: any;
    skipPruningFrame: any;
    /**
    ...
    node: import("../nodes/Node.js").default | null | undefined;
    parent: any;
    oldParent: any;
    children: any;
    sharedCacheInstance: any;
    instanceRemovalCheckList: any;
    selfDrawable: any;
    groupDrawable: any;
    sharedCacheDrawable: SharedCanvasCacheDrawable | null | undefined;
    firstDrawable: any;
    lastDrawable: any;
    firstInnerDrawable: any;
    lastInnerDrawable: any;
    svgGroups: any;
    /**
     ...
     */
    private cleanSyncTreeResults;
    beforeStableIndex: any;
    afterStableIndex: any;
    firstChangeInterval: any;
    lastChangeInterval: ChangeInterval | null | undefined;
    incompatibleStateChange: boolean | undefined;
    groupChanged: boolean | undefined;
    cascadingStateChange: boolean | undefined;
    anyStateChange: boolean | undefined;
    /**
     ...
     * @returns {Instance}
     */
    private updateIncompatibleChildInstance;
    /**
     * @private
     *
     * @param {boolean} wasStateless
     */
    private groupSyncTree;
    /**
     * @private
     */
    private sharedSyncTree;
    /**
     * @private
     *
     * @param {boolean} wasStateless
     */
    private prepareChildInstances;
    /**
     * @private
     */
    private ensureSharedCacheInitialized;
    /**
     ...
     * @returns {boolean}
     */
    private shouldIncludeInParentDrawables;
    /**
     ...
     * @param {number} index
     */
    private removeInstanceWithIndex;
    /**
     * @private
     *
     * @param {Instance} childInstance
     ...
     * @param {number} index
     */
    private replaceInstanceWithIndex;
    /**
     ...
     */
    private findChildInstanceOnNode;
    /**
     ...
     * @private
     */
    private markChildVisibilityDirty;
    /**
     ...
     */
    public updateDrawableFittability(fittable: boolean): void;
    /**
     ...
     */
    public updateVisibility(parentGloballyVisible: boolean, parentGloballyVoicingVisible: boolean, parentRelativelyVisible: boolean, updateFullSubtree: boolean): void;
    /**
     * @private
     *
     * @returns {number}
     */
    private getDescendantCount;
    /**
     ...
     */
    public addSVGGroup(group: SVGGroup): void;
    /**
     ...
     * @param {SVGGroup} group
     */
    public removeSVGGroup(group: SVGGroup): void;
    /**
     ...
     */
    public lookupSVGGroup(block: SVGBlock): SVGGroup | null;
    /**
     ...
     * @returns {Instance}
     */
    public getFilterRootInstance(): Instance;
    /**
     ...
     * @returns {Instance}
     */
    public getTransformRootInstance(): Instance;
    /**
     * @public
     *
     * @returns {Instance}
     */
    public getVisibilityRootInstance(): Instance;
    /**
     * @private
     */
     ...
     * @returns {number}
     */
    public getBranchIndexTo(instance: Instance): number;
    /**
     ...
     */
    public auditVisibility(parentVisible: boolean): void;
    /**
     * @private
     *
