...
class CanvasBlock extends FittedBlock {
    ...
    initialize(display, renderer, transformRootInstance, filterRootInstance) {
        ...
        // TODO: > You can use self.matchMedia() to check if the value of devicePixelRatio changes (which can happen, https://github.com/phetsims/scenery/issues/1581
        // TODO: > for example, if the user drags the self to a display with a different pixel density). https://github.com/phetsims/scenery/issues/1581
