...
class Instance {
        ...
        for (let i = 0; i < this.children.length; i++) {
            ...
            if (wasIncluded || isIncluded) {
                if (isBeforeOpen) {
                    ...
                    if (firstChildChangeInterval.drawableBefore === null) {
                        assert && assert(!currentChangeInterval || lastUnchangedDrawable, 'If we have a current change interval, we should be guaranteed a non-null ' +
    ...
    groupSyncTree(wasStateless) {
        ...
        assert && assert((this.isBackbone ? 1 : 0) +
            ...
            (this.isSharedCanvasCacheSelf ? 1 : 0) === (groupRenderer ? 1 : 0), 'We should have precisely one of these flags set for us to have a groupRenderer');
