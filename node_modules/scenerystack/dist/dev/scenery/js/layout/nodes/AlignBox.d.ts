...
export declare const AlignBoxXAlignValues: readonly ["left", "center", "right", "stretch"];
export type AlignBoxXAlign = (typeof AlignBoxXAlignValues)[number];
export declare const AlignBoxYAlignValues: readonly ["top", "center", "bottom", "stretch"];
...
declare const SuperType: typeof Node & import("../../../../phet-core.js").Constructor<import("../../layout/Sizable.js").TSizable>;
export default class AlignBox extends SuperType {
    private _content;
    private _alignBounds;
    private _xSet;
    private _ySet;
    private _xAlign;
    private _yAlign;
    ...
    _contentBoundsListener: (...args: any[]) => void;
    private readonly _alignBoundsProperty;
    private readonly _alignBoundsPropertyListener;
    /**
    ...
    set alignBounds(value: Bounds2 | null);
    get alignBounds(): Bounds2 | null;
    /**
    ...
    set group(value: AlignGroup | null);
    get group(): AlignGroup | null;
    /**
    ...
    set xAlign(value: AlignBoxXAlign);
    get xAlign(): AlignBoxXAlign;
    /**
    ...
    set yAlign(value: AlignBoxYAlign);
    get yAlign(): AlignBoxYAlign;
    /**
    ...
    get align(): AlignBoxXAlign & AlignBoxYAlign;
    set align(value: AlignBoxXAlign & AlignBoxYAlign);
    /**
