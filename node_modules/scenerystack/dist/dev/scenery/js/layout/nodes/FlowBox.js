...
class FlowBox extends LayoutNode {
    constructor(providedOptions) {
        ...
        this._forwardProperty = new TinyForwardingProperty(DEFAULT_OPTIONS.forward, false, this.onFlowBoxForwardReverseChanged.bind(this));
    ...
    onFlowBoxChildrenReordered(minChangeIndex, maxChangeIndex) {
        ...
        this._constraint.reorderCells(nodes.map(node => this._cellMap.get(node)), minChangeIndex, maxChangeIndex);
    }
    /**
    ...
    getSpacing() { return this.spacing; }
    setAlign(align) {
        this.align = align;
        return this;
    }
