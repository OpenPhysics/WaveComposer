...
declare const HSeparator_base: typeof Separator & import("../../../../phet-core.js").Constructor<import("../../layout/WidthSizable.js").TWidthSizable>;
export default class HSeparator extends HSeparator_base {
    constructor(options?: HSeparatorOptions);
}
export {};
