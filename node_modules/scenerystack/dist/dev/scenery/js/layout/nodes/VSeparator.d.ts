...
declare const VSeparator_base: typeof Separator & import("../../../../phet-core.js").Constructor<import("../../layout/HeightSizable.js").THeightSizable>;
export default class VSeparator extends VSeparator_base {
    constructor(options?: VSeparatorOptions);
}
export {};
