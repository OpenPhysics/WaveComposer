...
export default class FlowBox extends LayoutNode<FlowConstraint> {
    ...
    private readonly onChildInserted;
    private readonly onChildRemoved;
    private readonly onChildrenReordered;
    private readonly onChildrenChanged;
    private readonly _forwardProperty;
     ...
     */
    private onFlowBoxChildRemoved;
    /**
     * Called when children are rearranged
     */
    private onFlowBoxChildrenReordered;
    /**
     ...
     */
    private onFlowBoxForwardReverseChanged;
     ...
     */
    set forwardProperty(property: TReadOnlyProperty<boolean> | null);
    /**
     * See getForwardProperty() for more information
     */
    get forwardProperty(): TProperty<boolean>;
    /**
    ...
    static readonly DEFAULT_FLOW_BOX_OPTIONS: {
