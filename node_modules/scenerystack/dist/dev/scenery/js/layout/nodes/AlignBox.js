...
import { extendsHeightSizable, isHeightSizable, extendsWidthSizable, isWidthSizable } from '../../layout/sizableTypeChecks.js';
...
export default class AlignBox extends SuperType {
    ...
    getMargin() {
        assert && assert(this._leftMargin === this._rightMargin &&
            ...
            this._leftMargin === this._bottomMargin, 'Getting margin does not have a unique result if the left and right margins are different');
