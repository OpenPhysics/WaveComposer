...
export declare const WIDTH_SIZABLE_OPTION_KEYS: string[];
...
declare const WidthSizable: <SuperType extends Constructor<Node>>(k: SuperType) => SuperType & Constructor<TWidthSizable>;
