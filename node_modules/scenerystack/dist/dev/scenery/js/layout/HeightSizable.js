...
import { REQUIRES_BOUNDS_OPTION_KEYS } from '../nodes/Node.js';
...
const HeightSizable = memoize((Type) => {
    const HeightSizableTrait = DelayedMutate('HeightSizable', HEIGHT_SIZABLE_OPTION_KEYS, class HeightSizableTrait extends Type {
        ...
        constructor(...args) {
            ...
            this.localPreferredHeightProperty = new TinyProperty(null);
            this.localMinimumHeightProperty = new TinyProperty(null);
            this.isHeightResizableProperty = new TinyProperty(true);
        ...
        get extendsHeightSizable() { return true; }
