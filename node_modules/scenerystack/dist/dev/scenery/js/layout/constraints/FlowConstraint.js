...
export default class FlowConstraint extends FlowConfigurable(NodeLayoutConstraint) {
    constructor(ancestorNode, providedOptions) {
        ...
        this.cells = [];
        this._justify = LayoutJustification.SPACE_BETWEEN;
        this._justifyLines = null;
        this._wrap = false;
        this._spacing = 0;
        this._lineSpacing = 0;
        // (scenery-internal)
