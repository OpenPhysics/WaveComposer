...
declare const MARGIN_LAYOUT_CONFIGURABLE_OPTION_KEYS: string[];
...
declare const MarginLayoutConfigurable: <SuperType extends Constructor>(k: SuperType) => SuperType & Constructor<TMarginLayoutConfigurable>;
