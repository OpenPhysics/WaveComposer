...
import AlignBox from '../../layout/nodes/AlignBox.js';
import type { AlignBoxOptions } from '../../layout/nodes/AlignBox.js';
...
export default class AlignGroup extends Disposable {
    private readonly _alignBoxes;
    private _matchHorizontal;
    private _matchVertical;
    private _resizeLock;
    private readonly _maxWidthProperty;
    private readonly _maxHeightProperty;
    private readonly id;
    /**
    ...
    get maxWidthProperty(): TProperty<number>;
    /**
    ...
    get maxHeightProperty(): TProperty<number>;
    ...
    set matchHorizontal(value: boolean);
    get matchHorizontal(): boolean;
    /**
    ...
    set matchVertical(value: boolean);
    get matchVertical(): boolean;
    /**
