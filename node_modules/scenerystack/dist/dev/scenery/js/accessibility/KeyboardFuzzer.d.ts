...
declare class KeyboardFuzzer {
    private readonly display;
    private readonly random;
    private readonly numberOfComponentsTested;
     ...
     */
    fuzzBoardEvents(fuzzRate: number): void;
    /**
     * Taken from example in http://output.jsbin.com/awenaq/3,
     */
    private triggerDOMEvent;
}
