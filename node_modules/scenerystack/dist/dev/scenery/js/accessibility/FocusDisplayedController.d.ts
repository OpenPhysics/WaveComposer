...
declare class FocusDisplayedController {
    private node;
    private visibilityTracker;
    private focusProperty;
    private readonly boundVisibilityListener;
    private readonly boundInstancesChangedListener;
    private readonly boundNodeDisposedListener;
    private readonly boundFocusListener;
    constructor(focusProperty: TProperty<Focus | null>);
    /**
     ...
     */
    private handleTrailVisibilityChange;
    /**
