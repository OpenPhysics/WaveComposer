...
export default class GroupFocusListener implements TInputListener {
    readonly focusInGroupProperty: TProperty<boolean>;
    readonly focusTargetProperty: TProperty<Node | null>;
    private _focusWasInGroup;
    private readonly groupParent;
    constructor(groupParent: Node);
