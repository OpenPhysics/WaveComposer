...
declare class PDOMPeer {
    /**
     * @param {PDOMInstance} pdomInstance
     * @param {Object} [options]
     * @mixes Poolable
     */
    constructor(pdomInstance: PDOMInstance, options?: Object);
    /**
    ...
    visible: any;
    focusable: any;
    _headingSibling: HTMLElement | null | undefined;
    _labelSibling: HTMLElement | null | undefined;
    _descriptionSibling: HTMLElement | null | undefined;
    _accessibleParagraphSibling: HTMLElement | null | undefined;
    _containerParent: HTMLElement | null | undefined;
    topLevelElements: any[] | any[] | HTMLElement[] | undefined;
    positionDirty: boolean | undefined;
    forceReflowWorkaround: boolean | undefined;
    childPositionDirty: boolean | undefined;
    positionInPDOM: boolean | undefined;
    mutationObserver: any;
    transformListener: any;
    _preservedDisabledValue: any;
     ...
     * @public
     */
    public getPlaceableSibling(): any;
    /**
    ...
    get primarySibling(): HTMLElement | null;
    /**
    ...
    get headingSibling(): HTMLElement | null;
    /**
    ...
    get labelSibling(): HTMLElement | null;
    /**
    ...
    get descriptionSibling(): HTMLElement | null;
    /**
    ...
    get containerParent(): HTMLElement | null;
    /**
     ...
     * @returns {HTMLElement|null}
     */
    public getTopLevelElementContainingPrimarySibling(): HTMLElement | null;
    /**
     ...
     * @private
     */
    private handleAttributeWithPDOMOption;
    /**
    ...
    /**
     * Sets a attribute on one of the peer's self.Elements.
     * @public (scenery-internal)
     * @param {string} attribute
     * @param {*} attributeValue
     * @param {Object} [options]
     */
    public setAttributeToElement(attribute: string, attributeValue: any, options?: Object): void;
    /**
     * Remove attribute from one of the peer's self.Elements.
     * @public (scenery-internal)
     * @param {string} attribute
     * @param {Object} [options]
     */
    public removeAttributeFromElement(attribute: string, options?: Object): void;
    /**
     ...
     * @param {Object} [options]
     */
    public setClassToElement(className: string, options?: Object): void;
    /**
     ...
     * @param {Object} [options]
     */
    public removeClassFromElement(className: string, options?: Object): void;
    /**
     ...
     */
    public setAssociationAttribute(attribute: string, associationObject: Object): void;
    /**
     ...
     */
    public setPDOMTransformSourceNode(node: any): void;
    /**
    ...
    getElementId(siblingName: any, stringId: any): string;
    /**
     ...
     * @private
     */
    private invalidateCSSPositioning;
    /**
     ...
     * @public (scenery-internal)
     */
    public updateSubtreePositioning(parentPositionInPDOM?: boolean): void;
    /**
...
declare namespace PDOMPeer {
    export { PRIMARY_SIBLING };
    export { HEADING_SIBLING };
    export { LABEL_SIBLING };
    export { DESCRIPTION_SIBLING };
    export { ACCESSIBLE_PARAGRAPH_SIBLING as PARAGRAPH_SIBLING };
    export { CONTAINER_PARENT };
    export let OFFSCREEN_SIBLING_BOUNDS: Bounds2;
}
declare const PRIMARY_SIBLING: "PRIMARY_SIBLING";
declare const HEADING_SIBLING: "HEADING_SIBLING";
declare const LABEL_SIBLING: "LABEL_SIBLING";
declare const DESCRIPTION_SIBLING: "DESCRIPTION_SIBLING";
declare const ACCESSIBLE_PARAGRAPH_SIBLING: "PARAGRAPH_SIBLING";
declare const CONTAINER_PARENT: "CONTAINER_PARENT";
