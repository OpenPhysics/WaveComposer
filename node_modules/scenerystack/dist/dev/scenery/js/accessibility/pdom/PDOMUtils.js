...
const PDOMUtils = {
    ...
    insertElements(element, childrenToAdd, beforeThisElement = null) {
        assert && assert(element instanceof self.Element);
