...
export default class ParallelDOM extends PhetioObject {
    ...
    set accessibleParagraph(accessibleParagraph) { this.setAccessibleParagraph(accessibleParagraph); }
    get accessibleParagraph() { return this.getAccessibleParagraph(); }
    /**
    ...
    set accessibleHelpText(accessibleHelpText) { this.setAccessibleHelpText(accessibleHelpText); }
    get accessibleHelpText() { return this.getAccessibleHelpText(); }
    /**
    ...
    set accessibleParagraphContent(content) { this.setAccessibleParagraphContent(content); }
    /**
     * Returns the accessibleParagraph content for this Node.
     */
    get accessibleParagraphContent() { return this.getAccessibleParagraphContent(); }
    ...
    set accessibleHeading(label) { this.setAccessibleHeading(label); }
    ...
    get accessibleHeadingIncrement() { return this.getAccessibleHeadingIncrement(); }
    /**
    ...
    set accessibleHelpTextBehavior(accessibleHelpTextBehavior) { this.setAccessibleHelpTextBehavior(accessibleHelpTextBehavior); }
    get accessibleHelpTextBehavior() { return this.getAccessibleHelpTextBehavior(); }
    /**
     * Get the help text of the interactive element.
     */
    ...
    set accessibleParagraphBehavior(accessibleParagraphBehavior) { this.setAccessibleParagraphBehavior(accessibleParagraphBehavior); }
    get accessibleParagraphBehavior() { return this.getAccessibleParagraphBehavior(); }
    ...
    set accessibleRoleDescription(roleDescription) { this.setAccessibleRoleDescription(roleDescription); }
    get accessibleRoleDescription() { return this.getAccessibleRoleDescription(); }
    getAccessibleRoleDescription() { return unwrapProperty(this._accessibleRoleDescription); }
    /**
    ...
    setPDOMOrder(pdomOrder) {
        ...
        if (assert && pdomOrder) {
            pdomOrder.forEach((node, index) => {
                assert && assert(node === null || node instanceof ParallelDOM, `Elements of pdomOrder should be either a Node or null. Element at index ${index} is: ${node}`);
            });
    ...
    set pdomAttributes(attributes) { this.setPDOMAttributes(attributes); }
    /**
     ...
     */
    addAccessibleResponse(utterance) {
        ...
        for (let i = 0; i < connectedDisplays.length; i++) {
            ...
            const nodeDisplayed = this.getTrails().some(trail => trail.isVisible() && trail.isPDOMVisible());
     ...
     */
    addCategorizedResponse(alertable, alertBehavior) {
     ...
     * @param alertBehavior - Controls whether the response interrupts existing ones ('interrupt') or waits in the queue ('queue')
     */
    addAccessibleObjectResponse(alertable, alertBehavior = 'interrupt') {
     ...
     * @param alertBehavior - Controls whether the response interrupts existing ones ('interrupt') or waits in the queue ('queue')
     */
    addAccessibleContextResponse(alertable, alertBehavior = 'interrupt') {
        this.addCategorizedResponse(alertable, alertBehavior);
    }
    /**
     ...
     * @param alertBehavior - Controls whether the response interrupts existing ones ('interrupt') or waits in the queue ('queue')
     */
    addAccessibleHelpResponse(alertable, alertBehavior = 'interrupt') {
        this.addCategorizedResponse(alertable, alertBehavior);
    }
    /**
     ...
     */
    static BASIC_ACCESSIBLE_PARAGRAPH_BEHAVIOR(node, options, accessibleParagrah) {
    ...
    static forwardHelpText(node, otherNode) {
        ParallelDOM.useDefaultTagName(node);
        node.accessibleHelpTextBehavior = (node, options, accessibleHelpText, callbacksForOtherNodes) => {
            callbacksForOtherNodes.push(() => {
