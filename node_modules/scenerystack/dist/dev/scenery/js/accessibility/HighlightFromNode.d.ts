...
declare class HighlightFromNode extends HighlightPath {
    private readonly useLocalBounds;
    private readonly useGroupDilation;
    private readonly dilationCoefficient;
    private observedBoundsProperty;
    private boundsListener;
    constructor(node: Node | null, providedOptions?: HighlightFromNodeOptions);
    /**
     ...
     */
    setShapeFromNode(node: Node, trail?: Trail): void;
    /**
