...
class KeyStateTracker {
     ...
     */
    detachFromDocument() {
        assert && assert(this.attachedToDocument, 'KeyStateTracker is not attached to self.');
        assert && assert(this.documentKeyupListener, 'keyup listener was not created or attached to window');
        assert && assert(this.documentKeydownListener, 'keydown listener was not created or attached to self.');
        assert && assert(this.documentBlurListener, 'blur listener was not created or attached to self.');
