...
declare const ReadingBlockNode_base: typeof Node & import("../../../../../phet-core.js").Constructor<import("../../../accessibility/voicing/ReadingBlock.js").TReadingBlock<Node>>;
declare class ReadingBlockNode extends ReadingBlockNode_base {
    constructor(providedOptions?: ReadingBlockNodeOptions);
}
