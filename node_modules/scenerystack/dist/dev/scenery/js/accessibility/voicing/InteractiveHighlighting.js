...
const InteractiveHighlighting = (Type) => {
    ...
    const InteractiveHighlightingClass = DelayedMutate('InteractiveHighlightingClass', INTERACTIVE_HIGHLIGHTING_OPTIONS, class InteractiveHighlightingClass extends Type {
        constructor(...args) {
            ...
            this._isInteractiveHighlightActiveProperty = new TinyProperty(false);
        ...
        static get _mixesInteractiveHighlighting() { return true; }
        /**
        ...
        setInteractiveHighlight(interactiveHighlight) {
            if (this._interactiveHighlight !== interactiveHighlight) {
                ...
                if (this._interactiveHighlightLayerable) {
                    ...
                    assert && assert(typeof interactiveHighlight === 'object' && !!interactiveHighlight._isNode);
        ...
        setInteractiveHighlightLayerable(interactiveHighlightLayerable) {
            if (this._interactiveHighlightLayerable !== interactiveHighlightLayerable) {
                ...
                if (this._interactiveHighlight) {
                    assert && assert(typeof this._interactiveHighlight === 'object' && !!this._interactiveHighlight._isNode);
        ...
        set interactiveHighlightEnabled(enabled) { this.setInteractiveHighlightEnabled(enabled); }
        get interactiveHighlightEnabled() { return this.getInteractiveHighlightEnabled(); }
        /**
    ...
    assert && assert(InteractiveHighlightingClass.prototype._mutatorKeys.length ===
        _.uniq(InteractiveHighlightingClass.prototype._mutatorKeys).length, 'duplicate mutator keys in InteractiveHighlighting');
