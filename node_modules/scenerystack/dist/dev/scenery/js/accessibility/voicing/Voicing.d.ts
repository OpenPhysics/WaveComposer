...
declare const Voicing: {
    <SuperType extends Constructor<Node>>(Type: SuperType): SuperType & Constructor<TVoicing<InstanceType<SuperType>>>;
    VOICING_OPTION_KEYS: string[];
    alertUtterance(utterance: Utterance): void;
    registerUtteranceToVoicingNode(utterance: Utterance, voicingNode: TVoicing): void;
    unregisterUtteranceToVoicingNode(utterance: Utterance, voicingNode: TVoicingNode): void;
    registerUtteranceToNode(utterance: Utterance, node: Node): void;
    unregisterUtteranceToNode(utterance: Utterance, node: Node): void;
    BASIC_ACCESSIBLE_NAME_BEHAVIOR(node: Node, options: ParallelDOMOptions, accessibleName: PDOMValueType): ParallelDOMOptions;
    BASIC_HELP_TEXT_BEHAVIOR(node: Node, options: ParallelDOMOptions, accessibleHelpText: PDOMValueType): ParallelDOMOptions;
};
export type TVoicingNode = Node & TVoicing;
export declare function isVoicing(something: IntentionalAny): something is TVoicingNode;
