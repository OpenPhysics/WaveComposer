...
const Imageable = (type) => {
    return class ImageableMixin extends type {
        ...
        set imageProperty(property) { this.setImageProperty(property); }
        get imageProperty() { return this.getImageProperty(); }
        /**
        ...
        getMipmapLevel(matrix, additionalBias = 0) {
            ...
            const scale = Imageable.getApproximateMatrixScale(matrix) * (self.devicePixelRatio || 1);
...
Imageable.createFastMipmapFromCanvas = (baseCanvas) => {
    ...
    const baseImage = new self.Image();
