 ...
 */
import '../../../globals.js';
import LineStyles, { LineCap, LineJoin } from '../../../kite/js/util/LineStyles.js';
...
declare const PAINTABLE_OPTION_KEYS: string[];
...
declare const PAINTABLE_DRAWABLE_MARK_FLAGS: string[];
...
declare const Paintable: <SuperType extends Constructor<Node>>(k: SuperType) => SuperType & Constructor<TPaintable>;
