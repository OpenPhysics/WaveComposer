...
class Color {
    ...
    updateColor() {
        ...
        assert && assert(typeof this.red === 'number' &&
            ...
            typeof this.alpha === 'number', `Ensure color components are numeric: ${this.toString()}`);
        ...
        assert && assert(this.red >= 0 && this.red <= 255 &&
            ...
            this.alpha >= 0 && this.alpha <= 1, `Ensure color components are in the proper ranges: ${this.toString()}`);
