...
export declare function rasterizeNode(node: Node, providedOptions?: RasterizedOptions & {
    wrap?: true;
}): Node;
export declare function rasterizeNode(node: Node, providedOptions: RasterizedOptions & {
    wrap: false;
 ...
 */
export declare const toImageNodeAsynchronous: (node: Node, callback: (image: Node) => void, x?: number, y?: number, width?: number, height?: number) => void;
/**
 ...
 * @param [height] - The height of the Canvas output
 */
export declare const toCanvasNodeSynchronous: (node: Node, x?: number, y?: number, width?: number, height?: number) => Node;
/**
 ...
 * @param [height] - The height of the Canvas output
 */
export declare const toDataURLImageSynchronous: (node: Node, x?: number, y?: number, width?: number, height?: number) => Image;
/**
 ...
 * @param [height] - The height of the Canvas output
 */
export declare const toDataURLNodeSynchronous: (node: Node, x?: number, y?: number, width?: number, height?: number) => Node;
