...
export default class DisplayedTrailsProperty extends TinyProperty<Trail[]> {
    readonly node: Node;
    readonly listenedNodeSet: Set<Node>;
    private readonly _trailUpdateListener;
    private readonly display;
    private readonly followPDOMOrder;
    private readonly requireVisible;
    private readonly requirePDOMVisible;
    private readonly requireEnabled;
    private readonly requireInputEnabled;
    /**
     * We will contain Trails whose leaf node (lastNode) is this provided Node.
     */
    constructor(node: Node, providedOptions?: DisplayedTrailsPropertyOptions);
    private update;
