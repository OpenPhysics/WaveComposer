...
export default class Color {
    ...
    private _css?;
    private immutable?;
    readonly changeEmitter: TEmitter;
    /**
     ...
     */
    static toColor(colorSpec: TColor): Color;
    /**
     ...
     */
    static checkPaint(paint: TPaint): void;
    /**
     ...
     */
    static isDarkColor(color: Color | string, luminanceThreshold?: number): boolean;
    /**
