...
declare class AnimatedPanZoomSingleton {
    private _listener;
    initialize(targetNode: Node, options?: AnimatedPanZoomListenerOptions): void;
    dispose(): void;
    /**
     * Returns the AnimatedPanZoomListener.
     */
    get listener(): AnimatedPanZoomListener;
    /**
     * Returns true if the animatedPanZoomSingleton has been initialized.
     */
    get initialized(): boolean;
}
declare const animatedPanZoomSingleton: AnimatedPanZoomSingleton;
