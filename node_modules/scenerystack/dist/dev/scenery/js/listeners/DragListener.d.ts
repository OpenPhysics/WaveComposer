...
export default class DragListener extends PressListener implements TInputListener {
    ...
    private _allowTouchSnag;
    private _applyOffset;
    private _useParentOffset;
    private _trackAncestors;
    private _translateNode;
    private _transform;
    ...
    private _transformTrackerListener;
    private _lastInterruptedTouchLikePointer;
    private _dragAction;
     ...
     */
    click(event: SceneryEvent<MouseEvent>, callback?: () => void): boolean;
    /**
     ...
     */
    static createForwardingListener(down: (event: PressListenerEvent) => void, providedOptions?: CreateForwardingListenerOptions): TInputListener;
}
export {};
