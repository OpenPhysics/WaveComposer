...
export default class LevelSelectionButton extends RectangularPushButton {
    private readonly disposeLevelSelectionButton;
    /**
     * @param icon - appears on the button above the score display, scaled to fit
     * @param scoreProperty
     * @param providedOptions
     */
    constructor(icon: Node, scoreProperty: ReadOnlyProperty<number>, providedOptions?: LevelSelectionButtonOptions);
    /**
     ...
     */
    static createSizedImageNode(icon: Node, size: Dimension2): Node;
    dispose(): void;
}
export {};
