...
type SelfOptions = {
    ...
    xMargin?: number;
    yMargin?: number;
    levelTextOptions?: StrictOmit<TextOptions, 'tandem'>;
    challengeTextOptions?: StrictOmit<TextOptions, 'tandem'>;
    barFill?: TColor;
    barStroke?: TColor;
...
export default class FiniteStatusBar extends StatusBar {
    private readonly disposeFiniteStatusBar;
    /**
     ...
     */
    constructor(layoutBounds: Bounds2, visibleBoundsProperty: TReadOnlyProperty<Bounds2>, scoreProperty: ReadOnlyProperty<number>, providedOptions?: FiniteStatusBarOptions);
    dispose(): void;
}
export {};
