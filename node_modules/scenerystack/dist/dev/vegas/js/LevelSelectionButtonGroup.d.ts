...
export default class LevelSelectionButtonGroup extends Node {
    readonly buttons: LevelSelectionButton[];
    /**
     * @param items - descriptions of the LevelSelectionButtons, ordered by increasing level number
     * @param [providedOptions]
     */
    constructor(items: LevelSelectionButtonGroupItem[], providedOptions?: LevelSelectionButtonGroupOptions);
    /**
     ...
     */
    focusLevelSelectionButton(level: number): void;
}
export {};
