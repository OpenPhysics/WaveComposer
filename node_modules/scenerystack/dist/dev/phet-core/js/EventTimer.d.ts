...
export default class EventTimer {
    ...
    private period;
    private timeBeforeNextEvent;
    constructor(eventModel: {
        getPeriodBeforeNextEvent: () => number;
    }, eventCallback: (timeElapsed: number) => void);
    /**
...
export declare class ConstantEventModel {
    private readonly rate;
    constructor(rate: number);
    getPeriodBeforeNextEvent(): number;
}
export declare class UniformEventModel {
    private readonly rate;
    private readonly pseudoRandomNumberSource;
    constructor(rate: number, pseudoRandomNumberSource: () => number);
    getPeriodBeforeNextEvent(): number;
}
export declare class PoissonEventModel {
    private readonly rate;
    private readonly pseudoRandomNumberSource;
    constructor(rate: number, pseudoRandomNumberSource: () => number);
    getPeriodBeforeNextEvent(): number;
