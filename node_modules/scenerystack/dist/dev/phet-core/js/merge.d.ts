...
declare function merge<A, B, C>(a: A, b: B, c: C): A & B & C;
declare function merge<A, B, C, D>(a: A, b: B, c: C, d: D): A & B & C & D;
declare function merge<A, B, C, D, E>(a: A, b: B, c: C, d: D, e: E): A & B & C & D & E;
