...
declare class Enumeration<T extends EnumerationValue> implements TEnumeration<T> {
    readonly values: T[];
    readonly keys: string[];
    readonly Enumeration: Constructor<T> & Record<string, T>;
    readonly phetioDocumentation?: string;
    constructor(Enumeration: Constructor<T>, providedOptions?: EnumerationOptions<T>);
