...
function assertIsMergeable(object) {
    ...
    if (object !== null) {
        ...
        Object.keys(object).forEach(prop => {
            ...
            affirm(!ownPropertyDescriptor.hasOwnProperty('set'), 'cannot use merge with an object that has a setter');
            affirm(!ownPropertyDescriptor.hasOwnProperty('get'), 'cannot use merge with an object that has a getter');
        });
    }
}
