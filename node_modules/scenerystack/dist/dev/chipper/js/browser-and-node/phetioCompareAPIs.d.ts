...
import { FlattenedAPIPhetioElements, PhetioAPI } from '../../../tandem/js/phet-io-types.js';
 ...
 */
declare const phetioCompareAPIs: {
    (referenceAPI: PhetioAPI, proposedAPI: PhetioAPI, _: LoDashStatic, providedOptions?: PhetioCompareAPIsOptions): PhetioCompareAPIsResult;
    toStructuredTree: (api: {
        phetioElements: FlattenedAPIPhetioElements;
    }, _: LoDashStatic) => PhetioAPI;
};
