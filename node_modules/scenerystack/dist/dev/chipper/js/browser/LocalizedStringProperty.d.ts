...
declare class LocalizedStringProperty extends DynamicProperty<string, string, Locale> {
    readonly localizedString: LocalizedString;
    constructor(localizedString: LocalizedString, tandem: Tandem, metadata?: Record<string, unknown>);
