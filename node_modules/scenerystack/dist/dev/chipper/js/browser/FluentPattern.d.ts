...
export default class FluentPattern<T extends Record<string, unknown>> {
    private readonly bundleProperty;
    readonly key: string;
    readonly targetProperty: PhetioObject | undefined;
    readonly args: Record<string, IntentionalAny>[];
    /**
     *
     ...
     */
    constructor(bundleProperty: ReadOnlyProperty<FluentBundle>, key: string, targetProperty: PhetioObject | undefined, args: Record<string, IntentionalAny>[]);
     ...
     */
    createProperty(args: T): FluentPatternDerivedProperty;
    /**
 ...
 */
export declare class FluentPatternDerivedProperty extends DerivedStringProperty<string, IntentionalAny, IntentionalAny, IntentionalAny, IntentionalAny, IntentionalAny, IntentionalAny, IntentionalAny, IntentionalAny, IntentionalAny, IntentionalAny, IntentionalAny, IntentionalAny, IntentionalAny, IntentionalAny, IntentionalAny> {
    readonly targetProperty: PhetioObject | undefined;
    /**
     * @param dependencies
     * @param args
     ...
     *                       - this will be undefined in a built simulation when the corresponding string is unused.
     */
    constructor(dependencies: IntentionalAny, args: IntentionalAny, targetProperty: PhetioObject | undefined);
}
export {};
