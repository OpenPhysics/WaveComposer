...
declare class ContinuousPropertySoundClip extends SoundClip {
    private readonly fadeTime;
    private readonly delayBeforeStop;
    private readonly nonFadedOutputLevel;
    private remainingFadeTime;
    /**
     * @param property
     ...
     */
    constructor(property: TReadOnlyProperty<number>, range: Range, sound: WrappedAudioBuffer, providedOptions?: ContinuousPropertySoundClipOptions);
    /**
