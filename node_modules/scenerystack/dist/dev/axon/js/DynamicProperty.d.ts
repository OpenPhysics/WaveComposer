...
export default class DynamicProperty<ThisValueType, InnerValueType, OuterValueType> extends ReadOnlyProperty<ThisValueType> implements TProperty<ThisValueType> {
    ...
    private readonly valuePropertyProperty;
    private readonly propertyPropertyListener;
    private readonly propertyListener;
    /**
     * @param valuePropertyProperty - If the value is null, it is considered disconnected.
     * @param [providedOptions] - options
     */
    constructor(valuePropertyProperty: TNullableProperty<OuterValueType> | TReadOnlyProperty<OuterValueType>, providedOptions?: DynamicPropertyOptions<ThisValueType, InnerValueType, OuterValueType>);
    /**
     ...
     * @param innerProperty
     */
    private onPropertyPropertyChange;
    /**
     ...
     */
    set(value: ThisValueType): void;
    /**
     * Overridden to make public
     */
    get value(): ThisValueType;
    /**
     * Overridden to make public
