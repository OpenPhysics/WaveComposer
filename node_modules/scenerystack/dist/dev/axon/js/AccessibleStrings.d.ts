...
export type AccessibleValuePattern = FluentPattern<{
    value: FluentVariable;
}>;
...
export declare const DEFAULT_FORMATTED_NUMBER_VISUAL_OPTIONS: Required<NumberFormatOptions>;
export declare const DEFAULT_FORMATTED_NUMBER_ACCESSIBLE_OPTIONS: Required<NumberFormatOptions>;
