...
const createObservableArray = (providedOptions) => {
    ...
    if (options.tandem?.supplied) {
        ...
        if (Tandem.PHET_IO_ENABLED) {
            assert && assert(_.hasIn(self, 'phet.phetio.phetioEngine.phetioStateEngine'), 'PhET-iO Instrumented ObservableArrays must be created once phetioEngine has been constructed');
