...
class PropertyStateHandler {
    ...
    static validateInstrumentedProperty(property) {
        assert && Tandem.VALIDATION && assert(property.isPhetioInstrumented && property.isPhetioInstrumented(), `must be an instrumented Property: ${property}`);
    }
