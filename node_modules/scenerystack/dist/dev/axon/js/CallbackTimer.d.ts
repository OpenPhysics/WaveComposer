...
export default class CallbackTimer {
    ...
    private intervalID;
    private fired;
    constructor(options?: CallbackTimerOptions);
    isRunning(): boolean;
    start(): void;
    /**
     * Stops the timer.
     ...
     */
    stop(fire: boolean): void;
    addCallback(callback: CallbackTimerCallback): void;
    removeCallback(callback: CallbackTimerCallback): void;
    /**
