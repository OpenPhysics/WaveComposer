...
export default class DerivedProperty extends ReadOnlyProperty {
    constructor(dependencies, derivation, providedOptions) {
        ...
        dependencies.forEach(dependency => {
            ...
            if (dependency instanceof PhetioObject && dependency.hasTargetProperty()) {
                // @ts-expect-error
    ...
    static fromRecord(key, record, options) {
        ...
        const m = Object.values(record).filter(value => isTReadOnlyProperty(value));
     ...
     * @param options
     */
    static toFixedProperty(valueProperty, decimalPlaces, options) {
