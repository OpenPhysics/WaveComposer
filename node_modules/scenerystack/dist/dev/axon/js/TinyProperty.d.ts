...
export default class TinyProperty<T> extends TinyEmitter<TinyPropertyEmitterParameters<T>> implements TProperty<T> {
    _value: T;
    _valueComparisonStrategy?: ValueComparisonStrategy<T>;
    constructor(value: T, onBeforeNotify?: OptionsAlias<T>['onBeforeNotify'] | null, hasListenerOrderDependencies?: OptionsAlias<T>['hasListenerOrderDependencies'] | null, reentrantNotificationStrategy?: OptionsAlias<T>['reentrantNotificationStrategy'] | null, disableListenerLimit?: OptionsAlias<T>['disableListenerLimit'] | null);
    /**
     * Returns the value.
     *
     ...
     */
    linkAttribute<Attr extends string>(object: Record<Attr, T>, attributeName: Attr): (value: T) => void;
    /**
