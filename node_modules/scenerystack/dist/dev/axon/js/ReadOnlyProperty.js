...
import { unitToString, unitToStringOrNull } from './Unit.js';
...
class ReadOnlyProperty extends PhetioObject {
    ...
    constructor(value, providedOptions) {
        ...
        this.tinyProperty = new TinyProperty(value, null, options.hasListenerOrderDependencies, options.reentrantNotificationStrategy, options.disableListenerLimit);
    ...
    addPropertyDisposerAction(listener, options) {
