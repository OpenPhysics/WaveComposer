...
const VALID_INTEGER = { valueType: 'number', isValidValue: (v) => v % 1 === 0, validationMessage: 'Should be a valid integer' };
const VALID_NON_NAN = { isValidValue: (v) => !isNaN(v), validationMessage: 'Should not be NaN' };
