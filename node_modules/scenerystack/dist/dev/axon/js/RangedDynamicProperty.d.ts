...
export default class RangedDynamicProperty<InnerValueType, OuterValueType> extends DynamicProperty<number, InnerValueType, OuterValueType> implements TRangedProperty {
    ...
    private readonly disposeRangedDynamicProperty;
    constructor(valuePropertyProperty: TNullableProperty<OuterValueType> | TReadOnlyProperty<OuterValueType>, providedOptions?: RangedDynamicPropertyOptions<InnerValueType, OuterValueType>);
    get range(): Range;
    /**
