...
declare class PropertyStatePhase extends EnumerationValue {
    static readonly UNDEFER: PropertyStatePhase;
    static readonly NOTIFY: PropertyStatePhase;
    static readonly enumeration: Enumeration<PropertyStatePhase>;
}
