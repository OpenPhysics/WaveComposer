...
declare class VibrationTestInputListener {
    /**
     ...
     */
    constructor(eventRecorder: VibrationTestEventRecorder);
    eventRecorder: VibrationTestEventRecorder;
    elapsedTime: number;
    _pointerListener: {
        up: (event: any) => void;
        cancel: (evennt: any) => void;
        move: (event: any) => void;
    };
    pointer: any;
    /**
