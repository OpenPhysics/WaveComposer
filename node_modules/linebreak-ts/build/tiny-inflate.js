...
function tinf_inflate_block_data(d, lt, dt) {
    while (1) {
        ...
        if (sym < 256) {
            ...
            var length_1 = void 0, dist = void 0, offs_1 = void 0;
            var i = void 0;
            sym -= 257;
            /* possibly get more bits from length code */
            length_1 = tinf_read_bits(d, length_bits[sym], length_base[sym]);
            dist = tinf_decode_symbol(d, dt);
            /* possibly get more bits from distance code */
            offs_1 = d.destLen - tinf_read_bits(d, dist_bits[dist], dist_base[dist]);
            /* copy match */
            for (i = offs_1; i < offs_1 + length_1; ++i) {
